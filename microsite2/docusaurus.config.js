...
module.exports = {
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          path: '../docs',
          sidebarPath: '../microsite2/sidebars.json',
        },
        blog: {
          path: 'blog',
        },
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        '<p style="text-align:center"><a href="https://spotify.github.io/">Made with ❤️ at Spotify</a></p><p class="copy">Copyright © 2022 Backstage Project Authors. All rights reserved. The Linux Foundation has registered trademarks and uses trademarks. For a list of trademarks of The Linux Foundation, please see our Trademark Usage page: https://www.linuxfoundation.org/trademark-usage</p>',
      // logo: {
