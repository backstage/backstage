          ...
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                <a href="https://youtu.be/UZTVjv-AvZA?t=188">TELUS</a>. For
                more, join our{' '}
            ...
            <Block.Graphics>
              <Block.Graphic
                ...
                y={-12}
                width={120}
                src={useBaseUrl('img/demo-screen.png')}
              />
            </Block.Graphics>
          </Block.Container>
        </Block>
          ...
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                internal plugins, built by 60 different teams.) In this live
                demo recording, Stefan Ålund, product manager for Backstage,
                tells the origin story of Backstage and gives you a tour of how
          ...
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                migrations to fighting tech entropy, Backstage makes managing
                our tech health actually kind of pleasant.
              </Block.Paragraph>
          ...
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                any component) using Spring Boot. Where do you start? Search for
                a quick start guide online? Create an empty repo on GitHub? Copy
                and paste an old project? Nope. Just go to Backstage, and you’ll
                be up and running in two minutes — with a “Hello World” app, CI,
                and documentation all automatically set up and configured in a
                standardized way.
              </Block.Paragraph>
        ...
        <Block small className="bg-black-grey">
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            <Block.TextBox>
              ...
              <Block.Paragraph>
                All of Spotify’s services are automatically indexed in
                Backstage. So our engineers can stop playing detective — no more
                spamming Slack channels asking if anyone knows who owns a
                particular service and where you can find its API, only to
                discover that the owner went on sabbatical three months ago and
                you have to hunt them down on a mountain in Tibet where they’re
                on a 12-day silent meditation retreat. At Spotify, anyone can
                always find anyone else’s service, inspect its APIs, and contact
