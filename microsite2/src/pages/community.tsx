      ...
      <main className="MainContent">
        <Block small className="stripe-bottom bg-black-grey">
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            ...
            <Block.TextBox>
              <Block.Paragraph>
                What's the use of having fun if you can't share it? Exactly.
                Join the vibrant community around the Backstage project. Be it
                on GitHub, social media, Discord... You'll find a welcoming
          ...
          <Block.Container style={{ justifyContent: 'flex-start' }}>
            ...
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                discuss any relevant topic like developer effectiveness,
                developer experience, developer portals, etc. Have something to
                share, or a burning question? Add it to the{' '}
                <a href="https://github.com/backstage/community/issues">
                  issue
                </a>
                .
              </Block.Paragraph>
            ...
            <Block.TextBox>
              ...
              <Block.Paragraph>
                ...
                discussion with maintainers and contributors of Backstage. If
                you like Backstage, this is your favorite Zoom meeting of the
                month, guaranteed! Have something to share, or a burning
                question? Add it to the{' '}
                <a href="https://github.com/backstage/community/issues">
                  issue
                </a>
                .
