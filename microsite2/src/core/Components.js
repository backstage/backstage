...
export const Block = simpleComponent('section', 'Block', ['small', 'wrapped']);
...
export const BulletLine = simpleComponent('div', 'BulletLine');
...
export const ActionBlock = simpleComponent('section', 'ActionBlock');
...
export const Breakpoint = ({ narrow, wide }) => (
  <React.Fragment>
...
export const Banner = simpleComponent('div', 'Banner', ['hidden']);
