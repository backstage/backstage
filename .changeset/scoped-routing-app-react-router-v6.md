...
Added a new package that provides `ReactRouterV6PageRouter`, a page router that renders new frontend system pages with React Router v6. Render it inside the `loader` of the page or sub-page whose content should get a v6 context.
