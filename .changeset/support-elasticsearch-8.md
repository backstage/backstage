...
Upgraded the Elasticsearch client to version 8. Elasticsearch 8.x is now the confirmed supported version, [following the end of life of Elasticsearch 7.x](https://www.elastic.co/support/eol).
