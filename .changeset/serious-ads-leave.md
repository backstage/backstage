...
Adds the auth.providers.providerId.sessionDuration config for auth providers to allow users to configure the refresh-token and granted-scopes cookie lifespan.
