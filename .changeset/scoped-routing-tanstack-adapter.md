...
Use `createTanStackPageRouter` to bind a plugin-owned TanStack route tree. Place `TanStackPageContent` in that tree where the opaque page element should render; nested TanStack routes then work normally while sharing the app-owned browser history.
