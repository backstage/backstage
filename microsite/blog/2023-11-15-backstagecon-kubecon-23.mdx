...
The interest from the cloud-native community in Backstage did not waiver this year. Instead, the Backstage booth in the KubeCon Project Pavillion saw a nonstop flux of visitors asking more about the project. There were three talks featuring Backstage during KubeCon.
...
Backstage maintainers Ben and Patrick addressed a full-room during their talk “Simplifying Backstage - Breaking the Code Barrier” in which they explained Declarative Integrations, how it works and the expected migration path. Declarative Integrations will enable adopters to define the plugins they use—and even customize them—without dealing with Node or React. The mechanism relies on abstracting away the complexity behind a declaration of routes and configs defined in YAML. 

![KubeCon Attendees](assets/23-11-15/50-patrick-ben-full.jpg)
