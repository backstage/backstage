          ...
          [
            ...
            sidebarElementWithIndex(
              ...
              [
                ...
                {
                  type: 'category',
                  label: 'Connections (experimental)',
                  link: {
                    type: 'doc',
                    id: 'backend-system/core-services/connections',
                  },
                  items: [
                    'backend-system/core-services/connections/concepts',
                    'backend-system/core-services/connections/configuring-connections',
                    'backend-system/core-services/connections/consuming-connections',
                    {
                      type: 'category',
                      label: 'Built-in connection types',
                      link: {
                        type: 'doc',
                        id: 'backend-system/core-services/connections/built-in-connection-types',
                      },
                      items: [
                        'backend-system/core-services/connections/types/aws-connection',
                        'backend-system/core-services/connections/types/aws-codecommit',
                        'backend-system/core-services/connections/types/aws-s3',
                        'backend-system/core-services/connections/types/azure',
                        'backend-system/core-services/connections/types/azure-blob-storage',
                        'backend-system/core-services/connections/types/bitbucket-cloud',
                        'backend-system/core-services/connections/types/bitbucket-server',
                        'backend-system/core-services/connections/types/gerrit',
                        'backend-system/core-services/connections/types/gitea',
                        'backend-system/core-services/connections/types/github',
                        'backend-system/core-services/connections/types/gitlab',
                        'backend-system/core-services/connections/types/google-gcs',
                        'backend-system/core-services/connections/types/harness',
                      ],
                    },
                    'backend-system/core-services/connections/creating-a-connection-type',
                  ],
                },
