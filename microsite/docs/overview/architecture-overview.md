...
<img src={useBaseUrl('/img/cards.png')} alt="The architecture of a basic Backstage application" />
<img src={useBaseUrl('/img/assets/headline.png')} alt="The architecture of a basic Backstage application" />
