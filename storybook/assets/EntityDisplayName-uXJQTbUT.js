import{aN as k,r as y,aV as T,j as p}from"./iframe-DIcQvc_4.js";import{c as q}from"./useAnalytics-CkzkVu-R.js";import{r as A}from"./appWrappers-BlasAhwh.js";import{s as w,D as f}from"./ref-CtaBDC4y.js";import{B as b}from"./Box-D_uAdcR5.js";import{T as j}from"./Tooltip-DX18uned.js";import{m as x}from"./makeStyles-CSt6JC-p.js";const E=q({id:"plugin.catalog.entity-presentation"});var N=A();const o=k(N);function I(e,n){const{kind:t,namespace:r,name:s,title:i,description:a,displayName:h,type:m}=J(e),d=w({kind:t||"unknown",namespace:r||f,name:s||"unknown"}),l=D({kind:t,namespace:r,name:s,context:n}),g=[h,i,l].find(u=>u&&typeof u=="string"),v=[g!==d?d:void 0,m,a].filter(u=>u&&typeof u=="string").join(" | ");return{entityRef:d,primaryTitle:g,secondaryTitle:v||void 0,Icon:void 0}}const c=e=>!!e&&typeof e=="string";function J(e){if(typeof e=="string"){let n=e.indexOf(":");const t=e.indexOf("/");t!==-1&&t<n&&(n=-1);const r=n===-1?void 0:e.slice(0,n),s=t===-1?void 0:e.slice(n+1,t),i=e.slice(Math.max(n+1,t+1));return{kind:r,namespace:s,name:i}}if(typeof e=="object"&&e!==null){const n=[o(e,"kind")].find(c),t=[o(e,"metadata.namespace"),o(e,"namespace")].find(c),r=[o(e,"metadata.name"),o(e,"name")].find(c),s=[o(e,"metadata.title")].find(c),i=[o(e,"metadata.description")].find(c),a=[o(e,"spec.profile.displayName")].find(c),h=[o(e,"spec.type")].find(c);return{kind:n,namespace:t,name:r,title:s,description:i,displayName:a,type:h}}return{}}function D(e){const n=e.kind?.toLowerCase()||"unknown",t=e.namespace||f,r=e.name||"unknown",s=e.context?.defaultKind?.toLowerCase(),i=e.context?.defaultNamespace?.toLowerCase();let a=r;return(i&&t.toLowerCase()!==i||t!==f)&&(a=`${t}/${a}`),s&&n.toLowerCase()!==s&&(a=`${n}:${a}`),a}function L(e,n,t){const[r,s]=y.useState(e);return y.useEffect(()=>{s(e);const i=n?.subscribe({next:a=>{s(a)},complete:()=>{i?.unsubscribe()}});return()=>{i?.unsubscribe()}},t),r}function S(e,n){const r=T().get(E),s=[r,JSON.stringify(e),JSON.stringify(n||null)],i=y.useMemo(()=>{if(!r){const a=I(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return r.forEntity(typeof e=="string"||"metadata"in e?e:w(e),n)},s);return L(i.snapshot,i.update$,[i])}const P=x(e=>({root:{display:"inline-flex",alignItems:"center",textDecoration:"inherit"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),K=e=>{const{entityRef:n,hideIcon:t,disableTooltip:r,defaultKind:s,defaultNamespace:i}=e,a=P(),{primaryTitle:h,secondaryTitle:m,Icon:d}=S(n,{defaultKind:s,defaultNamespace:i});let l=p.jsx(p.Fragment,{children:h});return l=p.jsxs(b,{component:"span",className:a.root,children:[d&&!t?p.jsx(b,{component:"span",className:a.icon,children:p.jsx(d,{fontSize:"inherit"})}):null,l]}),m&&!r&&(l=p.jsx(j,{enterDelay:1500,title:m,children:l})),l};K.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
