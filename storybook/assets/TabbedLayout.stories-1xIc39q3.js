import{r as b,j as e,a_ as f,a$ as x,b0 as R,M as g,a7 as j,a8 as L}from"./iframe-t9H7a1GP.js";import{H as v}from"./Helmet-B8O4tuTd.js";import{L as E}from"./Link-B3MFkp5k.js";import{H as P}from"./HeaderTabs-BmODkneu.js";import{C as _}from"./Content-Bq_2o01e.js";import{a as w}from"./componentData-CLPVPrKa.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CuWwFMcz.js";import"./lodash-CR-8Qmjt.js";import"./useAnalytics-CPvjMD4k.js";import"./makeStyles-D3euK8x9.js";import"./useApp-BO5_SDAO.js";import"./Box-Ca_FhWzH.js";import"./styled-GR2b4kqg.js";import"./Tabs-CCLxNtAi.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-BQLGqP_I.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(_,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
