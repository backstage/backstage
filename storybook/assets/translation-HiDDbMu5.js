import{p as d,s as h}from"./ref-C0VTUPuL.js";import{j as r}from"./jsx-runtime-hv06LKfz.js";import{a as c,b as p}from"./ApiRef-ByCJBjX1.js";import{a as u}from"./ConfigApi-ij0WO1-Y.js";import{A as y}from"./useAnalytics-Q-nz63z2.js";import{c as f}from"./TranslationApi-CV0OlCW4.js";const A="parentOf",j="memberOf";function R(e,t,i){let a=e?.relations?.filter(n=>n.type===t).map(n=>d(n.targetRef))||[];return i?.kind&&(a=a.filter(n=>n.kind.toLocaleLowerCase("en-US")===i.kind.toLocaleLowerCase("en-US"))),a}const m=p("entity-context"),s=e=>{const{children:t,entity:i,loading:a,error:n,refresh:o}=e,l={entity:i,loading:a,error:n,refresh:o};return r.jsx(m.Provider,{value:u({1:l}),children:r.jsx(y,{attributes:{...i?{entityRef:h(i)}:void 0},children:t})})},g=e=>r.jsx(s,{entity:e.entity,loading:!e.entity,error:void 0,refresh:void 0,children:e.children});function E(){const e=c("entity-context");if(!e)throw new Error("Entity context is not available");const t=e.atVersion(1);if(!t)throw new Error("EntityContext v1 not available");if(!t.entity)throw new Error("useEntity hook is being called outside of an EntityLayout where the entity has not been loaded. If this is intentional, please use useAsyncEntity instead.");return{entity:t.entity}}s.__docgenInfo={description:"Provides a loaded entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"AsyncEntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
