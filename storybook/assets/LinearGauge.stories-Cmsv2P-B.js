import{e as M,r as b,_ as A,u as E,j as r,c as O}from"./iframe-CdLF-10Q.js";import{_ as j}from"./objectSpread2-uDwPAcuM.js";import{c as H}from"./index-BdTZ39qe.js";import{d as R,u as V,g as $}from"./Gauge-BIOW-jO6.js";import{T as z}from"./Tooltip-r72wdggD.js";import"./preload-helper-PPVm8Dsz.js";import"./makeStyles-DHrBvqm9.js";import"./Box-BEpYmdO6.js";import"./styled-DKVD7tgY.js";import"./Popper-g8OlZzUX.js";import"./Portal-6YsMjpwZ.js";var F=["className","percent","prefixCls","strokeColor","strokeLinecap","strokeWidth","style","trailColor","trailWidth","transition"],J=function(c){var e=j(j({},R),c),v=e.className,d=e.percent,n=e.prefixCls,l=e.strokeColor,o=e.strokeLinecap,u=e.strokeWidth,S=e.style,L=e.trailColor,P=e.trailWidth,_=e.transition,q=M(e,F);delete q.gapPosition;var B=Array.isArray(d)?d:[d],k=Array.isArray(l)?l:[l],T=V(),y=u/2,G=100-u/2,x="M ".concat(o==="round"?y:0,",").concat(y,`
         L `).concat(o==="round"?G:100,",").concat(y),N="0 0 100 ".concat(u),w=0;return b.createElement("svg",A({className:H("".concat(n,"-line"),v),viewBox:N,preserveAspectRatio:"none",style:S},q),b.createElement("path",{className:"".concat(n,"-line-trail"),d:x,strokeLinecap:o,stroke:L,strokeWidth:P||u,fillOpacity:"0"}),B.map(function(C,f){var m=1;switch(o){case"round":m=1-u/100;break;case"square":m=1-u/2/100;break;default:m=1;break}var W={strokeDasharray:"".concat(C*m,"px, 100px"),strokeDashoffset:"-".concat(w,"px"),transition:_||"stroke-dashoffset 0.3s ease 0s, stroke-dasharray .3s ease 0s, stroke 0.3s linear"},D=k[f]||k[k.length-1];return w+=C,b.createElement("path",{key:f,className:"".concat(n,"-line-path"),d:x,strokeLinecap:o,stroke:D,strokeWidth:u,fillOpacity:"0",ref:function(I){T[f]=I},style:W})}))};function g(h){const{value:c,getColor:e=$,width:v="thick"}=h,{palette:d}=E();if(isNaN(c))return null;let n=Math.round(c*100*100)/100;n>100&&(n=100);const l=v==="thick"?4:1,o=e({palette:d,value:n,inverse:!1,max:100});return r.jsx(z,{title:`${n}%`,children:r.jsx(O,{component:"span",children:r.jsx(J,{percent:n,strokeWidth:l,trailWidth:l,strokeColor:o})})})}g.__docgenInfo={description:"",methods:[],displayName:"LinearGauge",props:{value:{required:!0,tsType:{name:"number"},description:"Progress value between 0.0 - 1.0."},width:{required:!1,tsType:{name:"union",raw:"'thick' | 'thin'",elements:[{name:"literal",value:"'thick'"},{name:"literal",value:"'thin'"}]},description:""},getColor:{required:!1,tsType:{name:"signature",type:"function",raw:"(args: GaugePropsGetColorOptions) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
`,...s.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => <div style={containerStyle}>
    ...
    <LinearGauge getColor={() => '#f0f'} value={0.5} />
  </div>`,...s.parameters?.docs?.source}}};const oe=["Default","MediumProgress","LowProgress","StaticColor"];export{t as Default,i as LowProgress,a as MediumProgress,s as StaticColor,oe as __namedExportsOrder,se as default};
