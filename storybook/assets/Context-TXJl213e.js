import{r as o,am as a,j as c}from"./iframe-DZkam7Bj.js";import{p as y}from"./ref-C0VTUPuL.js";const s=e=>{const t=Object.keys(a),n=e%t.length;return a[t[n]][0]},u=e=>{try{return y(e?.entityRef??"")}catch{return}},d=e=>{const t=s(0),n=u(e);if(!n)return t;const r=["component","template","api","group","user","resource","system","domain","location"].indexOf(n.kind.toLocaleLowerCase("en-US"));return r===-1?t:s(r+1)},l=e=>(u(e)?.kind??"Other").toLocaleLowerCase("en-US"),m=o.createContext({getChipColor:d,getLabel:l}),p=({children:e,getChipColor:t=d,getLabel:n=l})=>{const i={getChipColor:t,getLabel:n};return c.jsx(m.Provider,{value:i,children:e})},v=()=>{const e=o.useContext(m);if(!e)throw new Error("useVisitDisplay must be used within a VisitDisplayProvider");return e};p.__docgenInfo={description:`Provider component for VisitDisplay customization
