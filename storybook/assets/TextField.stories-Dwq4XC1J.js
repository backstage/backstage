import{p as F,j as e}from"./iframe-DHcBEgBH.js";import{T as x}from"./TextField-satxnrqB.js";import{$ as h}from"./Form-CIsuGT2W.js";import{O as b,d as f}from"./index-DBQbpShW.js";import{F as y}from"./Flex-DWB2Qsjk.js";import{F as D}from"./FieldLabel-CXs4Y9mu.js";import"./preload-helper-PPVm8Dsz.js";import"./Input-ytPgA5My.js";import"./useObjectRef-BvIRJy6b.js";import"./clsx-B-dksMZM.js";import"./useFocusable-PYCxToJD.js";import"./useFormReset-Ds1IBNM6.js";import"./useControlledState-CeIx9NLz.js";import"./useField-BkRbkEjo.js";import"./useLabel-w-r1lcsQ.js";import"./useLabels-B0PJNwOY.js";import"./utils-CkMQMLOq.js";import"./Hidden-BetxpJ4E.js";import"./useFocusRing-DcpHIXiz.js";import"./TextField-pkUpBImO.js";import"./FieldError-BEf8sTZi.js";import"./Text-Drc9xvXT.js";import"./RSPContexts-DJuhINef.js";import"./Label-Cg_vx2EA.js";import"./useStyles--IRSF0A9.js";import"./FieldError-jMMC_xdm.js";import"./useBg-DbMB5pSK.js";const s=F.meta({title:"Backstage UI/TextField",component:x,argTypes:{isRequired:{control:"boolean"},icon:{control:"object"}}}),r=s.story({args:{name:"url",placeholder:"Enter a URL",style:{maxWidth:"300px"}}}),n=s.story({args:{...r.input.args},render:i=>e.jsxs(y,{direction:"row",gap:"4",style:{width:"100%",maxWidth:"600px"},children:[e.jsx(x,{...i,size:"small",icon:e.jsx(b,{})}),e.jsx(x,{...i,size:"medium",icon:e.jsx(b,{})})]})}),o=s.story({args:{...r.input.args,defaultValue:"https://example.com"}}),t=s.story({args:{...r.input.args,label:"Label"}}),p=s.story({args:{...t.input.args,description:"Description"}}),u=s.story({args:{...t.input.args,isRequired:!0}}),c=s.story({args:{...r.input.args,isDisabled:!0}}),a=s.story({args:{...r.input.args},render:i=>e.jsx(x,{...i,placeholder:"Enter a URL",size:"small",icon:e.jsx(f,{})})}),d=a.extend({args:{isDisabled:!0}}),l=s.story({args:{...t.input.args},render:i=>e.jsx(h,{validationErrors:{url:"Invalid URL"},children:e.jsx(x,{...i})})}),m=s.story({args:{...t.input.args,validate:i=>i==="admin"?"Nice try!":null}}),g=s.story({render:()=>e.jsxs(e.Fragment,{children:[e.jsx(D,{htmlFor:"custom-field",id:"custom-field-label",label:"Custom Field"}),e.jsx(x,{id:"custom-field","aria-labelledby":"custom-field-label",name:"custom-field",defaultValue:"Custom Field"})]})});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => (
  <TextField
    name="url"
...
`,...t.input.parameters?.docs?.source}}};u.input.parameters={...u.input.parameters,docs:{...u.input.parameters?.docs,source:{code:`const Required = () => <TextField isRequired />;
...
`,...g.input.parameters?.docs?.source}}};p.input.parameters={...p.input.parameters,docs:{...p.input.parameters?.docs,source:{code:`const WithDescription = () => <TextField description="Description" />;
