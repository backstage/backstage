import{p as F,j as e}from"./iframe-CXVefQjv.js";import{T as x}from"./TextField-BwzX52It.js";import{$ as h}from"./Form-DCR8Gpy0.js";import{O as b,d as f}from"./index-76V6r7eT.js";import{F as y}from"./Flex-DdyA-B7P.js";import{F as D}from"./FieldLabel-DSglsWvQ.js";import"./preload-helper-PPVm8Dsz.js";import"./Input-BUlD7Cyg.js";import"./useObjectRef-DlkbnCm4.js";import"./clsx-B-dksMZM.js";import"./useFocusable-Bkb8nD8I.js";import"./useFormReset-ClWexBcj.js";import"./useControlledState-BeQmKjOY.js";import"./useField-wHBudbIo.js";import"./useLabel-DmZtqopN.js";import"./useLabels-GdRYy31W.js";import"./utils-Llac4He1.js";import"./Hidden-C7xpnoH-.js";import"./useFocusRing-DZ6Qo_8Z.js";import"./TextField-R40hqy57.js";import"./FieldError-B-ZAo5Lh.js";import"./Text-Cc4ffqdV.js";import"./RSPContexts-D4PYZDPu.js";import"./Label-CbqlBDla.js";import"./useStyles-BaAIw9Cm.js";import"./FieldError-CQInxfVj.js";import"./useBg-Dl3w4s_M.js";const s=F.meta({title:"Backstage UI/TextField",component:x,argTypes:{isRequired:{control:"boolean"},icon:{control:"object"}}}),r=s.story({args:{name:"url",placeholder:"Enter a URL",style:{maxWidth:"300px"}}}),n=s.story({args:{...r.input.args},render:i=>e.jsxs(y,{direction:"row",gap:"4",style:{width:"100%",maxWidth:"600px"},children:[e.jsx(x,{...i,size:"small",icon:e.jsx(b,{})}),e.jsx(x,{...i,size:"medium",icon:e.jsx(b,{})})]})}),o=s.story({args:{...r.input.args,defaultValue:"https://example.com"}}),t=s.story({args:{...r.input.args,label:"Label"}}),p=s.story({args:{...t.input.args,description:"Description"}}),u=s.story({args:{...t.input.args,isRequired:!0}}),c=s.story({args:{...r.input.args,isDisabled:!0}}),a=s.story({args:{...r.input.args},render:i=>e.jsx(x,{...i,placeholder:"Enter a URL",size:"small",icon:e.jsx(f,{})})}),d=a.extend({args:{isDisabled:!0}}),l=s.story({args:{...t.input.args},render:i=>e.jsx(h,{validationErrors:{url:"Invalid URL"},children:e.jsx(x,{...i})})}),m=s.story({args:{...t.input.args,validate:i=>i==="admin"?"Nice try!":null}}),g=s.story({render:()=>e.jsxs(e.Fragment,{children:[e.jsx(D,{htmlFor:"custom-field",id:"custom-field-label",label:"Custom Field"}),e.jsx(x,{id:"custom-field","aria-labelledby":"custom-field-label",name:"custom-field",defaultValue:"Custom Field"})]})});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => (
  <TextField
    name="url"
...
`,...a.input.parameters?.docs?.source}}};l.input.parameters={...l.input.parameters,docs:{...l.input.parameters?.docs,source:{code:`const ShowError = () => (
...
`,...g.input.parameters?.docs?.source}}};d.input.parameters={...d.input.parameters,docs:{...d.input.parameters?.docs,source:{code:`const DisabledWithIcon = () => <TextField isDisabled />;
`,...d.input.parameters?.docs?.source}}};r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
    name: 'url',
    placeholder: 'Enter a URL',
    style: {
