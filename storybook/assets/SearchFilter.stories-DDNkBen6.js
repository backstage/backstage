import{j as a}from"./jsx-runtime-CvpxdxdE.js";import{s as fe,M as ve}from"./api-mJEpP5Oi.js";import{r as F}from"./index-DSHF18-l.js";import{l as ye}from"./lodash-D8aMxhkM.js";import{a as be}from"./useAsync-W0CErRou.js";import{u as he}from"./useDebounce-CkQMSXNU.js";import{u as _,S as we}from"./SearchContext-BYBNj33Q.js";import{A as ke}from"./Autocomplete-BxSk3EBT.js";import{T as Fe}from"./TextField-C6WzU4lz.js";import{C as qe}from"./Chip-B2uY1FLC.js";import{s as Ve}from"./translation-rjzQc8tL.js";import{m as Se}from"./makeStyles-BIagdtUJ.js";import{a as me,F as Ae}from"./FormLabel-CBoQ2n43.js";import{F as De}from"./FormControlLabel-h5b9L207.js";import{C as xe}from"./Checkbox-DE-aPtPs.js";import{u as je}from"./useTranslationRef-m705PC51.js";import{S as Te}from"./Select-DpbvXkFd.js";import{S as B}from"./Grid-BAh-wj5K.js";import{P as V}from"./Paper-CETy80Mm.js";import{T as Pe}from"./TestApiProvider-CaP8DdS9.js";import"./ApiRef-DDVPwL0h.js";import"./useMountedState-BK0Y35lN.js";import"./useAnalytics-BqSe3k6a.js";import"./ConfigApi-1QFqvuIK.js";import"./defaultTheme-cHLKSkOs.js";import"./clsx.m-CH7BE6MN.js";import"./Close-BdX1_mRD.js";import"./createSvgIcon-QzyO_PdA.js";import"./capitalize-CAo0_JGt.js";import"./withStyles-CiJb2SGb.js";import"./hoist-non-react-statics.cjs-DlMN-SZi.js";import"./unstable_useId-BAMTp7ON.js";import"./useControlled-i6Pam0ca.js";import"./ownerWindow-BCxlYCSn.js";import"./useIsFocusVisible-Sgmp0f7s.js";import"./index-DBvFAGNd.js";import"./IconButton-Bhqd37kB.js";import"./ButtonBase-obR2bX8B.js";import"./TransitionGroupContext-BUwkeBv7.js";import"./Popper-HxwStZ9O.js";import"./createChainedFunction-Da-WpsAN.js";import"./Portal-Dl07bpo2.js";import"./ListSubheader-ECyHfEwp.js";import"./InputLabel-jmTkYoW9.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-Dtv1idVa.js";import"./Select-gA0v3N1u.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-ChDSp8cY.js";import"./Popover-_uGOeCrk.js";import"./debounce-DtXjJkxj.js";import"./Modal-DeG-yW_3.js";import"./classCallCheck-MFKM5G8b.js";import"./Grow-BlcBT7m2.js";import"./utils-BuZ5BtGr.js";import"./List-bSmJWH8l.js";import"./ListContext-u-bsdFbB.js";import"./TranslationApi-NYdUF01F.js";import"./isMuiElement-fiJl_Gvd.js";import"./Typography-Bm-N-dvv.js";import"./SwitchBase-CXYh5e1-.js";import"./Cancel-BgHDRfxt.js";import"./typeof-jYoadTod.js";import"./createSvgIcon-5qk-fEpi.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-DLjDh1Pd.js";import"./typography-BJdsab0r.js";import"./MenuItem-DqwcyDOc.js";import"./ListItem-Ciy_Dmz7.js";import"./ApiProvider-B3DrBnW0.js";import"./index-B0bGgVUV.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function Ce(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const Ie=new Uint8Array(16);function Ee(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(Ie)}const Me=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:Me};function Ne(e,n,l){var t;if(z.randomUUID&&!n&&!e)return z.randomUUID();e=e||{};const r=e.random??((t=e.rng)==null?void 0:t.call(e))??Ee();if(r.length<16)throw new Error("Random bytes length must be >= 16");return r[6]=r[6]&15|64,r[8]=r[8]&63|128,Ce(r)}function q(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>q(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],r=250)=>{const t=F.useRef({}),i=F.useCallback(async o=>{var v;return((v=await(e==null?void 0:e(o)))==null?void 0:v.map(h=>q(h)))||[]},[e]),[b,p]=be(i,[n],{loading:!0});if(he(()=>{t.current[n]===void 0&&(t.current[n]=p(n).then(o=>(t.current[n]=o,o)))},r,[p,n]),l.length)return{loading:!1,value:l};const f=t.current[n];return Array.isArray(f)?{loading:!1,value:f}:b},O=(e,n)=>{const{setFilters:l}=_();F.useEffect(()=>{n&&[n].flat().length>0&&l(r=>({...r,[e]:n}))},[])},ce=e=>{const{className:n,defaultValue:l,name:r,values:t,valuesDebounceMs:i,label:b,filterSelectedOptions:p,limitTags:f,multiple:o}=e,[v,h]=F.useState("");O(r,l);const w=typeof t=="function"?t:void 0,S=typeof t=="function"||t==null?void 0:t.map(c=>q(c)),{value:A,loading:m}=L(w,v,S,i),{filters:d,setFilters:D}=_(),g=q(d[r]),x=F.useMemo(()=>g||(o?[]:null),[g,o]),j=(c,y)=>{D(W=>{const{[r]:U,...$}=W;return y?{...$,[r]:Array.isArray(y)?y.map(ge=>ge.value):y.value}:{...$}})},k=c=>a.jsx(Fe,{...c,name:"search",variant:"outlined",label:b,fullWidth:!0}),N=(c,y)=>c.map((W,U)=>a.jsx(qe,{label:W.label,color:"primary",...y({index:U})}));return a.jsx(ke,{filterSelectedOptions:p,limitTags:f,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${r}--select`,options:A||[],loading:m,value:x,onChange:j,onInputChange:(c,y)=>h(y),getOptionLabel:c=>c.label,renderInput:k,renderTags:N})};ce.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
