import{r as b,j as e,aX as f,aY as x,aZ as R,M as g,a4 as j,a5 as L}from"./iframe-BZbCHoUM.js";import{H as v}from"./Helmet-D0L0Z7cG.js";import{L as E}from"./Link-BTIv8AuK.js";import{H as P}from"./HeaderTabs-D_AqemPI.js";import{C as w}from"./Content-DD1olYm4.js";import{a as _}from"./componentData-BhhiEvWu.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CkvjDYOq.js";import"./lodash-ztOqvY5v.js";import"./useAnalytics-CRERthYg.js";import"./makeStyles-CqvbDVNY.js";import"./useApp-gzInJQTH.js";import"./Box-DY6-eBkT.js";import"./styled-DCK0eGG-.js";import"./Tabs-CXJL4E0y.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-J1YKPKG3.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
