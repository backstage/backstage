import{r as b,j as e,aX as f,aY as x,aZ as R,M as g,a4 as j,a5 as L}from"./iframe-B7ESvRaB.js";import{H as v}from"./Helmet-CkFMst7q.js";import{L as E}from"./Link-BVbc5K8M.js";import{H as P}from"./HeaderTabs-fpkk2_-E.js";import{C as w}from"./Content-JnwmzKOc.js";import{a as _}from"./componentData-CTm3m7bd.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DWyhtxdM.js";import"./lodash-Bt12QuHv.js";import"./useAnalytics-DL1ROu7Z.js";import"./makeStyles-D6c8jQg1.js";import"./useApp--u6yStsZ.js";import"./Box-BGVcxrSI.js";import"./styled-BYmoTReO.js";import"./Tabs-DIBFlzeO.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-PK_TzxE4.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
