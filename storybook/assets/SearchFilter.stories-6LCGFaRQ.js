import{r as k,j as a,m as X,k as Y,T as Z,a0 as q}from"./iframe-BpNetfkk.js";import{s as ee,M as ne}from"./api-BdOdcRRd.js";import{l as ae}from"./lodash-CwBbdt2Q.js";import{a as te}from"./useAsync-BEoRug7E.js";import{u as re}from"./useDebounce-D_raU2hF.js";import{u as _,S as se}from"./SearchContext-CGmv-zVd.js";import{A as le}from"./Autocomplete-IrRsxCZn.js";import{C as ie}from"./Chip-BkZK611R.js";import{T as ue}from"./TextField-CM9PjYSi.js";import{s as oe}from"./translation-DQWBFQd-.js";import{a as G,F as ce}from"./FormLabel-HI5ElYjJ.js";import{F as me}from"./FormControlLabel-DWAXrb7R.js";import{C as de}from"./Checkbox-CAwi0hQQ.js";import{S as pe}from"./Select-gWjQPNm4.js";import{S as B}from"./Grid-DGDU_W7d.js";import"./preload-helper-D9Z9MdNV.js";import"./useMountedState-ya7tp212.js";import"./useAnalytics-BKPjjI-y.js";import"./Popper-Bfi8Jp6K.js";import"./Portal-D3MaVJdo.js";import"./ListSubheader-CwtQj74I.js";import"./Select-Bk_6znan.js";import"./index-DnL3XN75.js";import"./Popover-C0hTF1EH.js";import"./Modal-CJXuzFvx.js";import"./List-CcdBBh0x.js";import"./ListContext-BkpiPoXc.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-p1mzlkeq.js";import"./InputLabel-CnhDo5aY.js";import"./SwitchBase-qYG6LXgU.js";import"./Cancel-DFUzz7YI.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-JPQ-K-XF.js";import"./styled-BVnjfZaP.js";import"./MenuItem-C2NdwYGU.js";import"./ListItem-BE6uqYrF.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ge(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ve=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ve)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ge(t)}function F(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>F(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=k.useRef({}),u=k.useCallback(async o=>(await e?.(o))?.map(b=>F(b))||[],[e]),[y,d]=te(u,[n],{loading:!0});if(re(()=>{r.current[n]===void 0&&(r.current[n]=d(n).then(o=>(r.current[n]=o,o)))},t,[d,n]),l.length)return{loading:!1,value:l};const v=r.current[n];return Array.isArray(v)?{loading:!1,value:v}:y},O=(e,n)=>{const{setFilters:l}=_();k.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:y,filterSelectedOptions:d,limitTags:v,multiple:o}=e,[b,V]=k.useState("");O(t,l);const h=typeof r=="function"?r:void 0,S=typeof r=="function"?void 0:r?.map(m=>F(m)),{value:A,loading:c}=L(h,b,S,u),{filters:p,setFilters:D}=_(),g=F(p[t]),x=k.useMemo(()=>g||(o?[]:null),[g,o]),j=(m,f)=>{D(W=>{const{[t]:U,...$}=W;return f?{...$,[t]:Array.isArray(f)?f.map(Q=>Q.value):f.value}:{...$}})},w=m=>a.jsx(ue,{...m,name:"search",variant:"outlined",label:y,fullWidth:!0}),N=(m,f)=>m.map((W,U)=>a.jsx(ie,{label:W.label,color:"primary",...f({index:U})}));return a.jsx(le,{filterSelectedOptions:d,limitTags:v,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:A||[],loading:c,value:x,onChange:j,onInputChange:(m,f)=>V(f),getOptionLabel:m=>m.label,renderInput:w,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
