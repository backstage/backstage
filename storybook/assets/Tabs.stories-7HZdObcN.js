...
})`,...b.input.parameters?.docs?.source}}};p.input.parameters={...p.input.parameters,docs:{...p.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
    children: ''
  },
...
})`,...R.input.parameters?.docs?.source}}};const Z=["Default","WithTabPanels","WithMockedURLTab2","WithMockedURLTab3","WithMockedURLNoMatch","ExactMatchingDefault","PrefixMatchingForNestedRoutes","PrefixMatchingDeepNesting","MixedMatchingStrategies","PrefixMatchingEdgeCases","PrefixMatchingWithSlash","RootPathMatching","HrefWithQueryParams","AutoSelectionOfTabs"];export{R as AutoSelectionOfTabs,d as Default,T as ExactMatchingDefault,v as HrefWithQueryParams,f as MixedMatchingStrategies,g as PrefixMatchingDeepNesting,u as PrefixMatchingEdgeCases,m as PrefixMatchingForNestedRoutes,j as PrefixMatchingWithSlash,y as RootPathMatching,x as WithMockedURLNoMatch,b as WithMockedURLTab2,p as WithMockedURLTab3,l as WithTabPanels,Z as __namedExportsOrder};
