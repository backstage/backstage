import{r as d,j as r,k as v,T as R}from"./iframe-Vo5gUnCl.js";import{s as _,M as k}from"./api-BpxwBz3U.js";import{s as N}from"./translation-CafHGIzb.js";import{u as $,S as j}from"./SearchContext-BnMDvh_6.js";import{T as q}from"./TablePagination-C3Vh0pha.js";import{S as b}from"./Grid-BEftOOde.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-Czox7iJy.js";import"./useAsync-DeuSsByy.js";import"./useMountedState-Bh-KE1Jd.js";import"./useAnalytics-DHo0n9fb.js";import"./KeyboardArrowRight-DyNS_sAC.js";import"./MenuItem-Bjzie91c.js";import"./ListItem-C_bA5RtL.js";import"./ListContext-CeAVa15U.js";import"./TableCell-Dutt7ZaU.js";import"./Select-CsujrQ2q.js";import"./index-B9sM2jn7.js";import"./Popover-S-Yp5OBg.js";import"./Modal-Ccymkcf6.js";import"./Portal-D4JBSn9P.js";import"./List-DaH1cfBf.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-CAmlKy5c.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v(N),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=$(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
