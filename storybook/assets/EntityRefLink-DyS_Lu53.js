import{r as a,j as i}from"./iframe-ByBrTvma.js";import{e as y,a as f}from"./routes-n5Hbx3KU.js";import{u as m}from"./useRouteRef-5-P7pYbC.js";import{E as g}from"./EntityDisplayName-BDca_OLj.js";import{L as b}from"./Link-1Uz9xKdo.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(g,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(b,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=m(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
