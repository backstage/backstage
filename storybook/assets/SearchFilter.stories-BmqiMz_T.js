import{r as w,j as n,S as J,P as F,a2 as K}from"./iframe-CwGYDpYH.js";import{s as Q,M as X}from"./api-MlTUZf_X.js";import{l as Y}from"./lodash-DVkgycFV.js";import{a as Z}from"./useAsync-BYRlsE8D.js";import{u as ee}from"./useDebounce-BZyNnU6q.js";import{u as N,S as ne}from"./SearchContext-DqrLN0i3.js";import{A as ae}from"./Autocomplete-BOCAfQid.js";import{C as te}from"./Chip-C7BRFe2B.js";import{T as re}from"./TextField-BpGTniRa.js";import{s as se}from"./translation-4GGpH6vT.js";import{m as le}from"./makeStyles-B-7ejBjc.js";import{a as U,F as ie}from"./FormLabel-DCZuBaR_.js";import{F as ue}from"./FormControlLabel-DtYi5qoP.js";import{C as oe}from"./Checkbox-BzUXY4lZ.js";import{S as ce}from"./Select-Dh99Nka8.js";import{S as $}from"./Grid-D9pxZO34.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnalytics-Bir4eJYF.js";import"./useMountedState-DGAu4OuG.js";import"./Popper-B-_f95Yk.js";import"./Portal-ChQ23K-b.js";import"./ListSubheader-CKd49j2M.js";import"./Select-K16B8imw.js";import"./index-B9sM2jn7.js";import"./Popover-BzcVWMMN.js";import"./Modal-CdGZYRSs.js";import"./List-D7ewfho0.js";import"./ListContext-B7RocSCf.js";import"./formControlState-DknsCqdz.js";import"./InputLabel-CAzwx5jT.js";import"./SwitchBase-BRn6SGzW.js";import"./Cancel-C8SnmPq3.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-DK8SMPjv.js";import"./styled-Bo4D4TjS.js";import"./MenuItem-ZrSdN3hC.js";import"./ListItem-a-yOdytX.js";function k(e){if(e!==void 0)return Array.isArray(e)?e.map(a=>k(a)):typeof e=="string"?{value:e,label:e}:e}const W=(e,a,s=[],r=250)=>{const t=w.useRef({}),i=w.useCallback(async u=>(await e?.(u))?.map(y=>k(y))||[],[e]),[g,m]=Z(i,[a],{loading:!0});if(ee(()=>{t.current[a]===void 0&&(t.current[a]=m(a).then(u=>(t.current[a]=u,u)))},r,[m,a]),s.length)return{loading:!1,value:s};const f=t.current[a];return Array.isArray(f)?{loading:!1,value:f}:g},R=(e,a)=>{const{setFilters:s}=N();w.useEffect(()=>{a&&[a].flat().length>0&&s(r=>({...r,[e]:a}))},[])},B=e=>{const{className:a,defaultValue:s,name:r,values:t,valuesDebounceMs:i,label:g,filterSelectedOptions:m,limitTags:f,multiple:u}=e,[y,q]=w.useState("");R(r,s);const b=typeof t=="function"?t:void 0,V=typeof t=="function"?void 0:t?.map(c=>k(c)),{value:S,loading:o}=W(b,y,V,i),{filters:d,setFilters:A}=N(),p=k(d[r]),j=w.useMemo(()=>p||(u?[]:null),[p,u]),D=(c,v)=>{A(_=>{const{[r]:L,...O}=_;return v?{...O,[r]:Array.isArray(v)?v.map(H=>H.value):v.value}:{...O}})},h=c=>n.jsx(re,{...c,name:"search",variant:"outlined",label:g,fullWidth:!0}),M=(c,v)=>c.map((_,L)=>n.jsx(te,{label:_.label,color:"primary",...v({index:L})}));return n.jsx(ae,{filterSelectedOptions:m,limitTags:f,multiple:u,className:a,id:`${u?"multi-":""}select-filter-${r}--select`,options:S||[],loading:o,value:j,onChange:D,onInputChange:(c,v)=>q(v),getOptionLabel:c=>c.label,renderInput:h,renderTags:M})};B.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
...
input value is provided as an input to allow values to be filtered. This
function is debounced and values cached.`},{key:"defaultValue",value:{name:"union",raw:"string[] | string | null",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"string"},{name:"null"}],required:!1}},{key:"valuesDebounceMs",value:{name:"number",required:!1},description:`Debounce time in milliseconds, used when values is an async callback.
Defaults to 250ms.`}]}},name:"props"}],return:{name:"ReactElement"}}},description:""},debug:{required:!1,tsType:{name:"boolean"},description:""}}};const Qe={title:"Plugins/Search/SearchFilter",component:l,decorators:[e=>n.jsx(K,{apis:[[Q,new X]],children:n.jsx(ne,{children:n.jsx($,{container:!0,direction:"row",children:n.jsx($,{item:!0,xs:4,children:n.jsx(e,{})})})})})],tags:["!manifest"]},x=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Checkbox,{name:"Search Checkbox Filter",values:["value1","value2"]})}),T=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Select,{label:"Search Select Filter",name:"select_filter",values:["value1","value2"]})}),P=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Select,{label:"Asynchronous Values",name:"async_values",values:async()=>(await(await fetch("https://swapi.dev/api/planets")).json()).results.map(s=>s.name)})}),C=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{name:"autocomplete",label:"Single-Select Autocomplete Filter",values:["value1","value2"]})}),I=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{multiple:!0,name:"autocomplete",label:"Multi-Select Autocomplete Filter",values:["value1","value2"]})}),E=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{multiple:!0,name:"starwarsPerson",label:"Starwars Character",values:async e=>e===""?[]:(await(await fetch(`https://swapi.dev/api/people?search=${encodeURIComponent(e)}`)).json()).results.map(r=>r.name)})});x.__docgenInfo={description:"",methods:[],displayName:"CheckBoxFilter"};T.__docgenInfo={description:"",methods:[],displayName:"SelectFilter"};P.__docgenInfo={description:"",methods:[],displayName:"AsyncSelectFilter"};C.__docgenInfo={description:"",methods:[],displayName:"Autocomplete"};I.__docgenInfo={description:"",methods:[],displayName:"MultiSelectAutocomplete"};E.__docgenInfo={description:"",methods:[],displayName:"AsyncMultiSelectAutocomplete"};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`() => {
  return <Paper style={{
    padding: 10
  }}>
