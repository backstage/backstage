import{j as o}from"./iframe-C97aGyUm.js";import{M as a}from"./MarkdownContent-CHjXC1sw.js";import"./preload-helper-PPVm8Dsz.js";import"./makeStyles-BH_X-duW.js";import"./CodeSnippet-BHzVYurR.js";import"./Box-Df-ATJWc.js";import"./styled-BJz5j31a.js";import"./CopyTextButton-B2KMIwjA.js";import"./useCopyToClipboard-DupPQQh1.js";import"./useMountedState-DKTKiVGI.js";import"./Tooltip-BGk1OQyx.js";import"./Popper-B9Uqg6K1.js";import"./Portal-CFNjbNqg.js";const v={title:"Data Display/MarkdownContent",component:a,tags:["!manifest"]},r=`# GFM
...
parte in quaerite generisque repugnat; de quod, creatos.`,e=()=>o.jsx(a,{content:s,dialect:"common-mark"}),n=()=>o.jsx(a,{content:r,dialect:"gfm"}),t=()=>o.jsx(a,{content:i,dialect:"gfm"});e.__docgenInfo={description:"",methods:[],displayName:"MarkdownContentCommonMark"};n.__docgenInfo={description:"",methods:[],displayName:"MarkdownContentGithubFlavoredCommonMark"};t.__docgenInfo={description:"",methods:[],displayName:"MarkdownContentGithubFlavoredWithHTML"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const MarkdownContentCommonMark = () => (
  <MarkdownContent content={markdown} dialect="common-mark" />
);
`,...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{code:`const MarkdownContentGithubFlavoredCommonMark = () => (
  <MarkdownContent content={markdownGithubFlavored} dialect="gfm" />
);
`,...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{code:`const MarkdownContentGithubFlavoredWithHTML = () => (
  <MarkdownContent content={markdownGithubFlavoredWithHTML} dialect="gfm" />
);
`,...t.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:'() => <MarkdownContent content={markdown} dialect="common-mark" />',...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:'() => <MarkdownContent content={markdownGithubFlavored} dialect="gfm" />',...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:'() => <MarkdownContent content={markdownGithubFlavoredWithHTML} dialect="gfm" />',...t.parameters?.docs?.source}}};const f=["MarkdownContentCommonMark","MarkdownContentGithubFlavoredCommonMark","MarkdownContentGithubFlavoredWithHTML"];export{e as MarkdownContentCommonMark,n as MarkdownContentGithubFlavoredCommonMark,t as MarkdownContentGithubFlavoredWithHTML,f as __namedExportsOrder,v as default};
