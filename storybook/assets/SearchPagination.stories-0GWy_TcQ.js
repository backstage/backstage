import{r as d,j as r,F as v,W as R}from"./iframe-DagLMla0.js";import{s as _,M as N}from"./api-Dqsku-pT.js";import{s as $}from"./translation-Dbf1dgbL.js";import{u as j,S as k}from"./SearchContext-CSI-LEOT.js";import{T as q}from"./TablePagination-BHKVjMgP.js";import{S as b}from"./Grid-FBCbfPk_.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-8eZMkpM5.js";import"./useAsync-cuavuARA.js";import"./useMountedState-CdgeShYt.js";import"./useAnalytics-DGkcsGrL.js";import"./KeyboardArrowRight-BxDfUuI9.js";import"./MenuItem-BC3YY-V4.js";import"./ListItem-EqTaubpw.js";import"./ListContext-Ci5pu3kB.js";import"./TableCell-EMJtY_Qt.js";import"./Select-kZWdAncG.js";import"./index-B9sM2jn7.js";import"./Popover-Cu6956KG.js";import"./Modal-CPcAs759.js";import"./Portal-D3sdGGII.js";import"./List-CIhN5mci.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-Zhlr4yHU.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
