import{r as b,j as e,aX as f,aY as x,aZ as R,M as g,a4 as j,a5 as L}from"./iframe-v7Qh39PS.js";import{H as v}from"./Helmet-C386tFCH.js";import{L as E}from"./Link-C_cLMUQT.js";import{H as P}from"./HeaderTabs-DGb4Xgog.js";import{C as w}from"./Content-B_1Y_dV6.js";import{a as _}from"./componentData-BdTSXjQo.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B0lXpw7A.js";import"./lodash-Djj2Rbh9.js";import"./useAnalytics-C6qawMj-.js";import"./makeStyles-DymchkiN.js";import"./useApp-BPx4QKeD.js";import"./Box-DXZBhROx.js";import"./styled-BwMArDgT.js";import"./Tabs-Z6-5NjA4.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-B627XF8P.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
