...
`,...p.input.parameters?.docs?.source}}};i.input.parameters={...i.input.parameters,docs:{...i.input.parameters?.docs,source:{code:`const WithLabel = () => <Select style={{ width: 300 }} label="Font Family" />;
...
`,...A.input.parameters?.docs?.source}}};n.input.parameters={...n.input.parameters,docs:{...n.input.parameters?.docs,source:{code:`const Preview = () => (
  <Select
    style={{ maxWidth: 260 }}
    label="Font Family"
    options={fontOptions}
