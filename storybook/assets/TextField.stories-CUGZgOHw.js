import{p as F,j as e}from"./iframe-BplO06yy.js";import{T as x}from"./TextField-BW2Ancdu.js";import{$ as h}from"./Form-D24LEvS1.js";import{O as b,d as f}from"./index-Bt40hWBe.js";import{F as y}from"./Flex-DtEel8x3.js";import{F as D}from"./FieldLabel-D-84T_-N.js";import"./preload-helper-PPVm8Dsz.js";import"./Input-BV8jFBY1.js";import"./useObjectRef-B7mDhX4O.js";import"./useFocusable-C9lIVari.js";import"./useFormReset-DxUe6z1c.js";import"./useControlledState-CfLiThbX.js";import"./useField-CCN3K9HO.js";import"./useLabel-C4CdtIJm.js";import"./useLabels-DzFtgpw9.js";import"./utils-B0YpRa1z.js";import"./Hidden-JxKi7FVV.js";import"./useFocusRing-yxqdftYt.js";import"./TextField-uitZeJy4.js";import"./FieldError-Zd85F1TD.js";import"./Text-BtVl-LMp.js";import"./RSPContexts-CqYemlPD.js";import"./Label-CkXKdi9n.js";import"./FieldError-dHB3OfB2.js";const s=F.meta({title:"Backstage UI/TextField",component:x,argTypes:{isRequired:{control:"boolean"},icon:{control:"object"}}}),r=s.story({args:{name:"url",placeholder:"Enter a URL",style:{maxWidth:"300px"}}}),n=s.story({args:{...r.input.args},render:i=>e.jsxs(y,{direction:"row",gap:"4",style:{width:"100%",maxWidth:"600px"},children:[e.jsx(x,{...i,size:"small",icon:e.jsx(b,{})}),e.jsx(x,{...i,size:"medium",icon:e.jsx(b,{})})]})}),o=s.story({args:{...r.input.args,defaultValue:"https://example.com"}}),t=s.story({args:{...r.input.args,label:"Label"}}),p=s.story({args:{...t.input.args,description:"Description"}}),u=s.story({args:{...t.input.args,isRequired:!0}}),c=s.story({args:{...r.input.args,isDisabled:!0}}),a=s.story({args:{...r.input.args},render:i=>e.jsx(x,{...i,placeholder:"Enter a URL",size:"small",icon:e.jsx(f,{})})}),d=a.extend({args:{isDisabled:!0}}),l=s.story({args:{...t.input.args},render:i=>e.jsx(h,{validationErrors:{url:"Invalid URL"},children:e.jsx(x,{...i})})}),m=s.story({args:{...t.input.args,validate:i=>i==="admin"?"Nice try!":null}}),g=s.story({render:()=>e.jsxs(e.Fragment,{children:[e.jsx(D,{htmlFor:"custom-field",id:"custom-field-label",label:"Custom Field"}),e.jsx(x,{id:"custom-field","aria-labelledby":"custom-field-label",name:"custom-field",defaultValue:"Custom Field"})]})});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => (
  <TextField
    name="url"
...
})`,...g.input.parameters?.docs?.source}}};const H=["Default","Sizes","DefaultValue","WithLabel","WithDescription","Required","Disabled","WithIcon","DisabledWithIcon","ShowError","Validation","CustomField"];export{g as CustomField,r as Default,o as DefaultValue,c as Disabled,d as DisabledWithIcon,u as Required,l as ShowError,n as Sizes,m as Validation,p as WithDescription,a as WithIcon,t as WithLabel,H as __namedExportsOrder};
