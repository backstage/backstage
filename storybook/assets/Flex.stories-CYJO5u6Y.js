import{p as f,j as e,B as w}from"./iframe-DhudO7cT.js";import{F as t}from"./Flex-B85o2pFV.js";import{T as D}from"./Text-CO34OvJZ.js";import"./preload-helper-PPVm8Dsz.js";import"./useStyles-u-Ot93UH.js";const a=f.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),r=({width:n="48px",height:y="48px"})=>{const j=(()=>{const b=`
