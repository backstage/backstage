import{p as h,s as c}from"./ref-C0VTUPuL.js";import{j as n,au as p,av as u,aw as y,Z as f}from"./iframe-CmjKepAK.js";import{A as m}from"./useAnalytics-C2hMq441.js";import{c as g}from"./index-eKWyzuf6.js";import{m as b}from"./makeStyles-rFkGMQln.js";import{C as w,c as v,b as T,a as k}from"./Card-CMtLCQsD.js";import{F as l}from"./Flex-XhQCKILq.js";import{T as q}from"./Text-BbNHwWNM.js";const P="parentOf",D="memberOf";function V(e,t,i){let r=e?.relations?.filter(a=>a.type===t).map(a=>h(a.targetRef))||[];return i?.kind&&(r=r.filter(a=>a.kind.toLocaleLowerCase("en-US")===i.kind.toLocaleLowerCase("en-US"))),r}const A=u("entity-context"),d=e=>{const{children:t,entity:i,loading:r,error:a,refresh:o}=e,s={entity:i,loading:r,error:a,refresh:o};return n.jsx(A.Provider,{value:y({1:s}),children:n.jsx(m,{attributes:{...i?{entityRef:c(i)}:void 0},children:t})})},j=e=>n.jsx(d,{entity:e.entity,loading:!e.entity,error:void 0,refresh:void 0,children:e.children});function K(){const e=p("entity-context");if(!e)throw new Error("Entity context is not available");const t=e.atVersion(1);if(!t)throw new Error("EntityContext v1 not available");if(!t.entity)throw new Error("useEntity hook is being called outside of an EntityLayout where the entity has not been loaded. If this is intentional, please use useAsyncEntity instead.");return{entity:t.entity}}d.__docgenInfo={description:"Provides a loaded entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"AsyncEntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
