import{r as b,j as e,aZ as f,a_ as x,a$ as R,M as g,a7 as j,a8 as L}from"./iframe-BOELprFv.js";import{H as v}from"./Helmet-CGZHUEKy.js";import{L as E}from"./Link-BwYnYGUx.js";import{H as P}from"./HeaderTabs-Ca04tsPE.js";import{C as _}from"./Content-B2ddSsct.js";import{a as w}from"./componentData-DXRZVCfF.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B4exrKOF.js";import"./lodash-DvkL6iKH.js";import"./useAnalytics-BJhOaRVB.js";import"./makeStyles-CSWS6G8b.js";import"./useApp-7Kwzc3rd.js";import"./Box-DfaVDnxz.js";import"./styled-B9TjYplk.js";import"./Tabs-BOPtSeYf.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-4j78cfaz.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(_,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
