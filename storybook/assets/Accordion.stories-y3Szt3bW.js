import{r as c,F as Q,a2 as E,j as e,a5 as X}from"./iframe-DFN6SAj3.js";import{b as F,$ as Y}from"./Button-CewZAUMg.js";import{$ as Z,a as R,e as K,g as ee,f as oe}from"./utils-Bfjqt0Ay.js";import{b as I,f as ne,c as re,$ as H}from"./useObjectRef-Dg08NMj-.js";import{a as G}from"./useFocusable-BqV40-mu.js";import{$ as q}from"./useControlledState-Brt6Ny7j.js";import{$ as te}from"./useEvent-DGXsBPji.js";import{a as z}from"./useFocusRing-BJ5ZSrxY.js";import{$ as ie}from"./Heading-CPlDsaSi.js";import{j as ae}from"./index-CWKYqCX3.js";import{c as A}from"./clsx-B-dksMZM.js";import{u as S}from"./useStyles-DaQj56o8.js";import{F as se}from"./Flex-Dc6Fn51M.js";import{B as v}from"./Box-dEEkGPvp.js";import{T as f}from"./Text-DZ5o8eVF.js";import"./preload-helper-PPVm8Dsz.js";import"./Label-DSJtZte4.js";import"./Hidden-B4o_BYU0.js";import"./useLabel-DH47co1_.js";import"./useLabels-8yrTN_aE.js";import"./context-DAG0vsnX.js";import"./useButton-4oKFdG4C.js";import"./usePress-vdIMkS3w.js";import"./RSPContexts-B9rhbHT1.js";import"./useSurface-CpQk2yDD.js";function de(s,o,r){let{isDisabled:n}=s,i=I(),d=I(),a=ne(),p=c.useRef(null),g=c.useCallback(()=>{p.current=requestAnimationFrame(()=>{r.current&&r.current.setAttribute("hidden","until-found")}),Q.flushSync(()=>{o.toggle()})},[r,o]);te(r,"beforematch",g);let m=c.useRef(null);return re(()=>{if(p.current&&cancelAnimationFrame(p.current),r.current&&!n&&!a){let t=r.current;m.current==null||typeof t.getAnimations!="function"?o.isExpanded?(t.removeAttribute("hidden"),t.style.setProperty("--disclosure-panel-width","auto"),t.style.setProperty("--disclosure-panel-height","auto")):(t.setAttribute("hidden","until-found"),t.style.setProperty("--disclosure-panel-width","0px"),t.style.setProperty("--disclosure-panel-height","0px")):o.isExpanded!==m.current&&(o.isExpanded?(t.removeAttribute("hidden"),t.style.setProperty("--disclosure-panel-width",t.scrollWidth+"px"),t.style.setProperty("--disclosure-panel-height",t.scrollHeight+"px"),Promise.all(t.getAnimations().map(C=>C.finished)).then(()=>{t.style.setProperty("--disclosure-panel-width","auto"),t.style.setProperty("--disclosure-panel-height","auto")}).catch(()=>{})):(t.style.setProperty("--disclosure-panel-width",t.scrollWidth+"px"),t.style.setProperty("--disclosure-panel-height",t.scrollHeight+"px"),window.getComputedStyle(t).height,t.style.setProperty("--disclosure-panel-width","0px"),t.style.setProperty("--disclosure-panel-height","0px"),Promise.all(t.getAnimations().map(C=>C.finished)).then(()=>t.setAttribute("hidden","until-found")).catch(()=>{}))),m.current=o.isExpanded}},[n,r,o.isExpanded,a]),c.useEffect(()=>()=>{p.current&&cancelAnimationFrame(p.current)},[]),{buttonProps:{id:i,"aria-expanded":o.isExpanded,"aria-controls":d,onPress:t=>{!n&&t.pointerType!=="keyboard"&&o.toggle()},isDisabled:n,onPressStart(t){t.pointerType==="keyboard"&&!n&&o.toggle()}},panelProps:{id:d,role:"group","aria-labelledby":i,"aria-hidden":!o.isExpanded,hidden:a||n?n||!o.isExpanded:void 0}}}function ce(s){let[o,r]=q(s.isExpanded,s.defaultExpanded||!1,s.onExpandedChange);const n=c.useCallback(()=>{r(!0)},[r]),i=c.useCallback(()=>{r(!1)},[r]),d=c.useCallback(()=>{r(!o)},[r,o]);return{isExpanded:o,setExpanded:r,expand:n,collapse:i,toggle:d}}function le(s){let{allowsMultipleExpanded:o=!1,isDisabled:r=!1}=s,[n,i]=q(c.useMemo(()=>s.expandedKeys?new Set(s.expandedKeys):void 0,[s.expandedKeys]),c.useMemo(()=>s.defaultExpandedKeys?new Set(s.defaultExpandedKeys):new Set,[s.defaultExpandedKeys]),s.onExpandedChange);return c.useEffect(()=>{if(!o&&n.size>1){let d=n.values().next().value;d!=null&&i(new Set([d]))}}),{allowsMultipleExpanded:o,isDisabled:r,expandedKeys:n,setExpandedKeys:i,toggleKey(d){let a;o?(a=new Set(n),a.has(d)?a.delete(d):a.add(d)):a=new Set(n.has(d)?[]:[d]),i(a)}}}const O=c.createContext(null),pe=c.forwardRef(function(o,r){let n=le(o),i=R({...o,defaultClassName:"react-aria-DisclosureGroup",values:{isDisabled:n.isDisabled,state:n}}),d=G(o,{global:!0});return E.createElement("div",{...d,...i,ref:r,"data-disabled":o.isDisabled||void 0},E.createElement(O.Provider,{value:n},i.children))}),ue=c.createContext(null),xe=c.createContext(null),k=c.createContext(null),fe=c.forwardRef(function(o,r){[o,r]=Z(o,r,ue);let n=c.useContext(O),{id:i,...d}=o,a=I();i||(i=a);let p=n?n.expandedKeys.has(i):o.isExpanded,g=ce({...o,isExpanded:p,onExpandedChange(L){var N;n&&n.toggleKey(i),(N=o.onExpandedChange)===null||N===void 0||N.call(o,L)}}),m=E.useRef(null),t=o.isDisabled||n?.isDisabled||!1,{buttonProps:C,panelProps:V}=de({...o,isExpanded:p,isDisabled:t},g,m),{isFocusVisible:M,focusProps:U}=z({within:!0}),W=R({...o,id:void 0,defaultClassName:"react-aria-Disclosure",values:{isExpanded:g.isExpanded,isDisabled:t,isFocusVisibleWithin:M,state:g}}),J=G(d,{global:!0});return E.createElement(K,{values:[[F,{slots:{[ee]:{},trigger:C}}],[k,{panelProps:V,panelRef:m}],[xe,g]]},E.createElement("div",{...H(J,W,U),ref:r,"data-expanded":g.isExpanded||void 0,"data-disabled":t||void 0,"data-focus-visible-within":M||void 0},W.children))}),ge=c.forwardRef(function(o,r){let{role:n="group"}=o,{panelProps:i,panelRef:d}=c.useContext(k),{isFocusVisible:a,focusProps:p}=z({within:!0}),g=R({...o,defaultClassName:"react-aria-DisclosurePanel",values:{isFocusVisibleWithin:a}}),m=G(o,{global:!0});return E.createElement("div",{...H(m,g,i,p),ref:oe(r,d),role:n,"data-focus-visible-within":a||void 0},E.createElement(K,{values:[[F,null]]},o.children))}),B={classNames:{root:"bui-Accordion",trigger:"bui-AccordionTrigger",triggerButton:"bui-AccordionTriggerButton",triggerTitle:"bui-AccordionTriggerTitle",triggerSubtitle:"bui-AccordionTriggerSubtitle",triggerIcon:"bui-AccordionTriggerIcon",panel:"bui-AccordionPanel",group:"bui-AccordionGroup"}},h={"bui-Accordion":"_bui-Accordion_1vd3l_20","bui-AccordionTrigger":"_bui-AccordionTrigger_1vd3l_27","bui-AccordionTriggerButton":"_bui-AccordionTriggerButton_1vd3l_35","bui-AccordionTriggerTitle":"_bui-AccordionTriggerTitle_1vd3l_58","bui-AccordionTriggerSubtitle":"_bui-AccordionTriggerSubtitle_1vd3l_64","bui-AccordionTriggerIcon":"_bui-AccordionTriggerIcon_1vd3l_70","bui-AccordionPanel":"_bui-AccordionPanel_1vd3l_81","bui-AccordionGroup":"_bui-AccordionGroup_1vd3l_87"},l=c.forwardRef(({className:s,...o},r)=>{const{classNames:n,cleanedProps:i}=S(B,o);return e.jsx(fe,{ref:r,className:A(n.root,h[n.root],s),...i})});l.displayName="Accordion";const u=c.forwardRef(({className:s,title:o,subtitle:r,children:n,...i},d)=>{const{classNames:a,cleanedProps:p}=S(B,i);return e.jsx(ie,{ref:d,className:A(a.trigger,h[a.trigger],s),...p,children:e.jsxs(Y,{slot:"trigger",className:A(a.triggerButton,h[a.triggerButton]),children:[n||e.jsxs(se,{gap:"2",align:"center",children:[e.jsx("span",{className:A(a.triggerTitle,h[a.triggerTitle]),children:o}),r&&e.jsx("span",{className:A(a.triggerSubtitle,h[a.triggerSubtitle]),children:r})]}),e.jsx(ae,{className:A(a.triggerIcon,h[a.triggerIcon]),size:16})]})})});u.displayName="AccordionTrigger";const x=c.forwardRef(({className:s,...o},r)=>{const{classNames:n,cleanedProps:i}=S(B,o);return e.jsx(ge,{ref:r,className:A(n.panel,h[n.panel],s),...i})});x.displayName="AccordionPanel";const _=c.forwardRef(({className:s,allowsMultiple:o=!1,...r},n)=>{const{classNames:i,cleanedProps:d}=S(B,r);return e.jsx(pe,{ref:n,allowsMultipleExpanded:o,className:A(i.group,h[i.group],s),...d})});_.displayName="AccordionGroup";l.__docgenInfo={description:"@public",methods:[],displayName:"Accordion",props:{className:{required:!1,tsType:{name:"string"},description:""}},composes:["RADisclosureProps"]};u.__docgenInfo={description:"@public",methods:[],displayName:"AccordionTrigger",props:{className:{required:!1,tsType:{name:"string"},description:""},title:{required:!1,tsType:{name:"string"},description:""},subtitle:{required:!1,tsType:{name:"string"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}},composes:["RAHeadingProps"]};x.__docgenInfo={description:"@public",methods:[],displayName:"AccordionPanel",props:{className:{required:!1,tsType:{name:"string"},description:""}},composes:["RADisclosurePanelProps"]};_.__docgenInfo={description:"@public",methods:[],displayName:"AccordionGroup",props:{className:{required:!1,tsType:{name:"string"},description:""},allowsMultiple:{required:!1,tsType:{name:"boolean"},description:`Whether multiple accordions can be expanded at the same time.
...
})`,...j.input.parameters?.docs?.source}}};const He=["Default","WithSubtitle","CustomTrigger","DefaultExpanded","GroupSingleOpen","GroupMultipleOpen"];export{P as CustomTrigger,b as Default,y as DefaultExpanded,j as GroupMultipleOpen,$ as GroupSingleOpen,T as WithSubtitle,He as __namedExportsOrder};
