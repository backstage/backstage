import{r as a,j as i}from"./iframe-BOELprFv.js";import{e as y,a as f}from"./routes-BwcdR7A2.js";import{L as m}from"./Link-BwYnYGUx.js";import{u as g}from"./useRouteRef-CcqJk9jr.js";import{E as b}from"./EntityDisplayName-crLTQLOS.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(b,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(m,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=g(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
