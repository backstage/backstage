import{p as d,s as h}from"./ref-8pKZtiZi.js";import{j as s}from"./jsx-runtime-Cw0GR0a5.js";import{b as c,a as p}from"./ApiRef-CqkoWjZn.js";import{a as u}from"./ConfigApi-D1qiBdfc.js";import{A as y}from"./useAnalytics-DVyBXs_0.js";import{c as f}from"./TranslationApi-DhmNHZQM.js";const A="parentOf",j="memberOf";function R(e,n,t){var r;let a=((r=e==null?void 0:e.relations)==null?void 0:r.filter(i=>i.type===n).map(i=>d(i.targetRef)))||[];return t!=null&&t.kind&&(a=a.filter(i=>i.kind.toLocaleLowerCase("en-US")===t.kind.toLocaleLowerCase("en-US"))),a}const m=c("entity-context"),o=e=>{const{children:n,entity:t,loading:a,error:r,refresh:i}=e,l={entity:t,loading:a,error:r,refresh:i};return s.jsx(m.Provider,{value:u({1:l}),children:s.jsx(y,{attributes:{...t?{entityRef:h(t)}:void 0},children:n})})},g=e=>s.jsx(o,{entity:e.entity,loading:!e.entity,error:void 0,refresh:void 0,children:e.children});function E(){const e=p("entity-context");if(!e)throw new Error("Entity context is not available");const n=e.atVersion(1);if(!n)throw new Error("EntityContext v1 not available");if(!n.entity)throw new Error("useEntity hook is being called outside of an EntityLayout where the entity has not been loaded. If this is intentional, please use useAsyncEntity instead.");return{entity:n.entity}}o.__docgenInfo={description:"Provides a loaded entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"AsyncEntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
