import{r as S,j as n,p as R}from"./iframe-BDvXWqMv.js";import{$ as f}from"./Link-B2KMDgN4.js";import{d as b,u as j}from"./defineComponent-Bpodmr1G.js";import{I as w}from"./InternalLinkProvider-Dchkbx_O.js";import{T as a,r as p}from"./index-fA99AeGQ.js";import{M as T}from"./index-CuoyrUh2.js";import{F as d}from"./Flex-CpR46IYb.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-Bj39tkUh.js";import"./useObjectRef-D66VWE61.js";import"./clsx-B-dksMZM.js";import"./useFocusable-BRVpMXiP.js";import"./useLink-BAmYtluh.js";import"./usePress-BBcyGIHE.js";import"./useFocusRing-D9ttEsqC.js";import"./useStyles-DQyb5-cO.js";import"./useSurface-D4MhZzti.js";const F={"bui-ButtonLink":"_bui-ButtonLink_y6gl0_20","bui-ButtonLinkContent":"_bui-ButtonLinkContent_y6gl0_168"},C=b()({styles:F,classNames:{root:"bui-ButtonLink",content:"bui-ButtonLinkContent"},surface:"leaf",propDefs:{size:{dataAttribute:!0,default:"small"},variant:{dataAttribute:!0,default:"primary"},iconStart:{},iconEnd:{},onSurface:{},children:{},className:{},style:{}}}),e=S.forwardRef((t,L)=>{const{ownProps:g,restProps:B,dataAttributes:x}=j(C,t),{classes:k,iconStart:y,iconEnd:v,children:h}=g;return n.jsx(w,{href:B.href,children:n.jsx(f,{className:k.root,ref:L,...x,...B,children:n.jsxs("span",{className:k.content,children:[y,h,v]})})})});e.displayName="ButtonLink";e.__docgenInfo={description:"@public",methods:[],displayName:"ButtonLink",props:{onSurface:{required:!1,tsType:{name:"union",raw:"T | Partial<Record<Breakpoint, T>>",elements:[{name:"union",raw:`| '0'
| '1'
| '2'
| '3'
| 'danger'
...
| 'warning'
| 'success'
| 'auto'`,elements:[{name:"literal",value:"'0'"},{name:"literal",value:"'1'"},{name:"literal",value:"'2'"},{name:"literal",value:"'3'"},{name:"literal",value:"'danger'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'success'"},{name:"literal",value:"'auto'"}]}],raw:"Record<Breakpoint, T>"}],raw:"Partial<Record<Breakpoint, T>>"}]},description:""},size:{required:!1,tsType:{name:"union",raw:"T | Partial<Record<Breakpoint, T>>",elements:[{name:"union",raw:"'small' | 'medium'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"}]},{name:"Partial",elements:[{name:"Record",elements:[{name:"union",raw:"'initial' | 'xs' | 'sm' | 'md' | 'lg' | 'xl'",elements:[{name:"literal",value:"'initial'"},{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"}]},{name:"union",raw:"'small' | 'medium'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"}]}],raw:"Record<Breakpoint, T>"}],raw:"Partial<Record<Breakpoint, T>>"}]},description:""},variant:{required:!1,tsType:{name:"union",raw:"T | Partial<Record<Breakpoint, T>>",elements:[{name:"union",raw:"'primary' | 'secondary' | 'tertiary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"}]},{name:"Partial",elements:[{name:"Record",elements:[{name:"union",raw:"'initial' | 'xs' | 'sm' | 'md' | 'lg' | 'xl'",elements:[{name:"literal",value:"'initial'"},{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"}]},{name:"union",raw:"'primary' | 'secondary' | 'tertiary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"}]}],raw:"Record<Breakpoint, T>"}],raw:"Partial<Record<Breakpoint, T>>"}]},description:""},iconStart:{required:!1,tsType:{name:"ReactElement"},description:""},iconEnd:{required:!1,tsType:{name:"ReactElement"},description:""},children:{required:!1,tsType:{name:"ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""}},composes:["Omit"]};const m=R.meta({title:"Backstage UI/ButtonLink",component:e,decorators:[t=>n.jsx(T,{children:n.jsx(t,{})})],argTypes:{size:{control:"select",options:["small","medium"]},variant:{control:"select",options:["primary","secondary"]}}}),r=m.story({args:{children:"Button"}}),i=m.story({render:()=>n.jsxs(d,{align:"center",children:[n.jsx(e,{iconStart:n.jsx(a,{}),variant:"primary",href:"https://ui.backstage.io",target:"_blank",children:"Button"}),n.jsx(e,{iconStart:n.jsx(a,{}),variant:"secondary",href:"https://ui.backstage.io",target:"_blank",children:"Button"}),n.jsx(e,{iconStart:n.jsx(a,{}),variant:"tertiary",href:"https://ui.backstage.io",target:"_blank",children:"Button"})]})}),o=m.story({args:{children:"Button"},render:()=>n.jsxs(d,{align:"center",children:[n.jsx(e,{size:"small",iconStart:n.jsx(a,{}),children:"Small"}),n.jsx(e,{size:"medium",iconStart:n.jsx(a,{}),children:"Medium"})]})}),s=m.story({args:{children:"Button"},render:t=>n.jsxs(d,{align:"center",children:[n.jsx(e,{...t,iconStart:n.jsx(a,{})}),n.jsx(e,{...t,iconEnd:n.jsx(p,{})}),n.jsx(e,{...t,iconStart:n.jsx(a,{}),iconEnd:n.jsx(p,{})})]})}),l=m.story({args:{children:"Button"},render:t=>n.jsxs(d,{direction:"column",gap:"4",style:{width:"300px"},children:[n.jsx(e,{...t,iconStart:n.jsx(a,{})}),n.jsx(e,{...t,iconEnd:n.jsx(p,{})}),n.jsx(e,{...t,iconStart:n.jsx(a,{}),iconEnd:n.jsx(p,{})})]})}),u=m.story({render:()=>n.jsxs(d,{direction:"row",gap:"4",children:[n.jsx(e,{variant:"primary",isDisabled:!0,children:"Primary"}),n.jsx(e,{variant:"secondary",isDisabled:!0,children:"Secondary"}),n.jsx(e,{variant:"tertiary",isDisabled:!0,children:"Tertiary"})]})}),c=m.story({args:{children:"Button",variant:{initial:"primary",sm:"secondary"},size:{xs:"small",sm:"medium"}}});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => <ButtonLink>Button</ButtonLink>;
`,...r.input.parameters?.docs?.source}}};i.input.parameters={...i.input.parameters,docs:{...i.input.parameters?.docs,source:{code:`const Variants = () => (
  <Flex align="center">
    <ButtonLink
...
`,...i.input.parameters?.docs?.source}}};o.input.parameters={...o.input.parameters,docs:{...o.input.parameters?.docs,source:{code:`const Sizes = () => (
  <Flex align="center">
...
})`,...c.input.parameters?.docs?.source}}};const J=["Default","Variants","Sizes","WithIcons","FullWidth","Disabled","Responsive"];export{r as Default,u as Disabled,l as FullWidth,c as Responsive,o as Sizes,i as Variants,s as WithIcons,J as __namedExportsOrder};
