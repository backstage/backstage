import{r as j,j as a,m as X,F as Y,W as Z,P}from"./iframe-gtROSIwU.js";import{s as ee,M as ne}from"./api-_5ugvYUm.js";import{l as ae}from"./lodash-BVz7JNon.js";import{a as te}from"./useAsync-hSbEIIiT.js";import{u as re}from"./useDebounce-B2FdXvTG.js";import{u as _,S as se}from"./SearchContext-C0ZgRz3i.js";import{A as le}from"./Autocomplete-5HdjJYgB.js";import{C as ie}from"./Chip-BoM1fEJT.js";import{T as ue}from"./TextField-BW7xijOF.js";import{s as oe}from"./translation-CWCNaR7u.js";import{a as G,F as ce}from"./FormLabel-D5IhyyIv.js";import{F as me}from"./FormControlLabel-DgxhN-Ge.js";import{C as pe}from"./Checkbox-JTtLJ8x-.js";import{S as de}from"./Select-CLxjCPm-.js";import{S as B}from"./Grid-Dk9zonhM.js";import"./preload-helper-PPVm8Dsz.js";import"./useMountedState-D4qBcejv.js";import"./useAnalytics-CleNnKnR.js";import"./Popper-DSlAm5T6.js";import"./Portal-DfJk_0nC.js";import"./ListSubheader-BhdLtgs_.js";import"./Select-CLgD42SM.js";import"./index-B9sM2jn7.js";import"./Popover-C_iP5aYt.js";import"./Modal-ybKC94PT.js";import"./List-4z_Kf1-d.js";import"./ListContext-DPykjs2z.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-CmvdfJNM.js";import"./InputLabel-CSNsM7jZ.js";import"./SwitchBase-BUQXY-F2.js";import"./Cancel-Bm3Q3TBm.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-DVyEyde4.js";import"./styled-Bs_QlAid.js";import"./MenuItem-FPFAt3cA.js";import"./ListItem-CchOfbIa.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ve(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ge=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ge)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ve(t)}function x(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>x(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=j.useRef({}),u=j.useCallback(async o=>(await e?.(o))?.map(S=>x(S))||[],[e]),[q,p]=te(u,[n],{loading:!0});if(re(()=>{r.current[n]===void 0&&(r.current[n]=p(n).then(o=>(r.current[n]=o,o)))},t,[p,n]),l.length)return{loading:!1,value:l};const F=r.current[n];return Array.isArray(F)?{loading:!1,value:F}:q},O=(e,n)=>{const{setFilters:l}=_();j.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:q,filterSelectedOptions:p,limitTags:F,multiple:o}=e,[S,D]=j.useState("");O(t,l);const V=typeof r=="function"?r:void 0,T=typeof r=="function"?void 0:r?.map(m=>x(m)),{value:C,loading:c}=L(V,S,T,u),{filters:d,setFilters:I}=_(),v=x(d[t]),E=j.useMemo(()=>v||(o?[]:null),[v,o]),M=(m,k)=>{I(W=>{const{[t]:U,...$}=W;return k?{...$,[t]:Array.isArray(k)?k.map(Q=>Q.value):k.value}:{...$}})},A=m=>a.jsx(ue,{...m,name:"search",variant:"outlined",label:q,fullWidth:!0}),N=(m,k)=>m.map((W,U)=>a.jsx(ie,{label:W.label,color:"primary",...k({index:U})}));return a.jsx(le,{filterSelectedOptions:p,limitTags:F,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:C||[],loading:c,value:E,onChange:M,onInputChange:(m,k)=>D(k),getOptionLabel:m=>m.label,renderInput:A,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
