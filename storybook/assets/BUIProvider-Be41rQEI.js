import{r as i,c as u,j as t,b as o,u as c,d as p}from"./iframe-COehFrpL.js";import{a as m}from"./openLink-Df95N0dK.js";import{u as l}from"./useResolvedHref-B_8OEdp3.js";function d(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(g,{children:r}):r}function g({children:n}){const e=p();return t.jsx(m,{navigate:e,useHref:l,children:n})}d.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
