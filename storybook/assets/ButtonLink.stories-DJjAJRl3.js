import{r as R,R as w,aw as T,au as P,j as e,p as E,M as D}from"./iframe-B7ESvRaB.js";import{$ as C,a as F,b as _}from"./utils-Cr8yviUJ.js";import{$ as z}from"./useLink-C4zSeWp7.js";import{a as N}from"./useGlobalListeners-DQLyYZ9f.js";import{b as A}from"./useObjectRef-Dd7TU9CZ.js";import{a as q,b as I}from"./useHover-ByBQ7Oss.js";import{g as M}from"./getNodeText-C-fdRcD6.js";import{T as r,r as L}from"./index-DbP8Hxod.js";import{F as l}from"./Flex-Cmpf98Na.js";import{B as W}from"./BUIProvider-sIkzvwhM.js";import"./preload-helper-PPVm8Dsz.js";import"./openLink-BFNE09ao.js";import"./usePress-HRSvR9KN.js";import"./textSelection-XuXSjEvl.js";const O=R.createContext(null),V=R.forwardRef(function(a,o){[a,o]=C(a,o,O);let i=a.href&&!a.isDisabled?"a":"span",{linkProps:S,isPressed:c}=z({...a,elementType:i},o),d=F[i],{hoverProps:j,isHovered:u}=q(a),{focusProps:m,isFocused:p,isFocusVisible:x}=I(),f=_({...a,defaultClassName:"react-aria-Link",values:{isCurrent:!!a["aria-current"],isDisabled:a.isDisabled||!1,isPressed:c,isHovered:u,isFocused:p,isFocusVisible:x}}),$=N(a,{global:!0});return delete $.onClick,w.createElement(d,{ref:o,slot:a.slot||void 0,...A($,f,S,j,m),"data-focused":p||void 0,"data-hovered":u||void 0,"data-pressed":c||void 0,"data-focus-visible":x||void 0,"data-current":!!a["aria-current"]||void 0,"data-disabled":a.isDisabled||void 0},f.children)}),U={"bui-ButtonLink":"_bui-ButtonLink_ek4wo_20","bui-ButtonLinkContent":"_bui-ButtonLinkContent_ek4wo_168"},H=T()({styles:U,classNames:{root:"bui-ButtonLink",content:"bui-ButtonLinkContent"},bg:"consumer",analytics:!0,propDefs:{noTrack:{},size:{dataAttribute:!0,default:"small"},variant:{dataAttribute:!0,default:"primary"},iconStart:{},iconEnd:{},children:{},className:{}}}),t=R.forwardRef((n,a)=>{const{ownProps:o,restProps:i,dataAttributes:S,analytics:c}=P(H,n),{classes:d,iconStart:j,iconEnd:u,children:m}=o,p=x=>{i.onPress?.(x);const f=i["aria-label"]??M(m)??String(i.href??"");c.captureEvent("click",f,{attributes:{to:String(i.href??"")}})};return e.jsx(V,{className:d.root,ref:a,...S,...i,onPress:p,children:e.jsxs("span",{className:d.content,children:[j,m,u]})})});t.displayName="ButtonLink";t.__docgenInfo={description:`A button-styled anchor element for navigation, supporting optional start and end icon slots and analytics event tracking.
...
})`,...b.input.parameters?.docs?.source}}};const oe=["Default","Variants","Sizes","WithIcons","FullWidth","Disabled","Responsive"];export{y as Default,B as Disabled,v as FullWidth,b as Responsive,k as Sizes,g as Variants,h as WithIcons,oe as __namedExportsOrder};
