...
`,...x.input.parameters?.docs?.source}}};g.input.parameters={...g.input.parameters,docs:{...g.input.parameters?.docs,source:{code:`const LoadingVariants = () => (
  <Flex direction="column" gap="4">
    <Text>Primary</Text>
...
`,...v.input.parameters?.docs?.source}}};B.input.parameters={...B.input.parameters,docs:{...B.input.parameters?.docs,source:{code:`const Loading = () => {
...
})`,...v.input.parameters?.docs?.source}}};const U=["Default","Variants","Destructive","Sizes","WithIcons","FullWidth","Disabled","Responsive","Loading","LoadingVariants","AutoBg"];export{v as AutoBg,s as Default,l as Destructive,m as Disabled,p as FullWidth,B as Loading,g as LoadingVariants,x as Responsive,d as Sizes,u as Variants,c as WithIcons,U as __namedExportsOrder};
