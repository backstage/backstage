import{bs as k,c8 as y,cB as T,bQ as p}from"./iframe-JPiukB_R.js";import{c as q}from"./useAnalytics-D8KrhC1p.js";import{b as A}from"./appWrappers-CIJES5cn.js";import{s as w,D as f}from"./ref-CtaBDC4y.js";import{B as b}from"./Box-B2a9eHDH.js";import{T as j}from"./Tooltip-BtSzS_xo.js";import{m as x}from"./makeStyles-CRHqG-EO.js";const E=q({id:"plugin.catalog.entity-presentation"});var N=A();const o=k(N);function I(e,n){const{kind:t,namespace:s,name:r,title:i,description:a,displayName:h,type:m}=J(e),d=w({kind:t||"unknown",namespace:s||f,name:r||"unknown"}),l=D({kind:t,namespace:s,name:r,context:n}),g=[h,i,l].find(u=>u&&typeof u=="string"),v=[g!==d?d:void 0,m,a].filter(u=>u&&typeof u=="string").join(" | ");return{entityRef:d,primaryTitle:g,secondaryTitle:v||void 0,Icon:void 0}}const c=e=>!!e&&typeof e=="string";function J(e){if(typeof e=="string"){let n=e.indexOf(":");const t=e.indexOf("/");t!==-1&&t<n&&(n=-1);const s=n===-1?void 0:e.slice(0,n),r=t===-1?void 0:e.slice(n+1,t),i=e.slice(Math.max(n+1,t+1));return{kind:s,namespace:r,name:i}}if(typeof e=="object"&&e!==null){const n=[o(e,"kind")].find(c),t=[o(e,"metadata.namespace"),o(e,"namespace")].find(c),s=[o(e,"metadata.name"),o(e,"name")].find(c),r=[o(e,"metadata.title")].find(c),i=[o(e,"metadata.description")].find(c),a=[o(e,"spec.profile.displayName")].find(c),h=[o(e,"spec.type")].find(c);return{kind:n,namespace:t,name:s,title:r,description:i,displayName:a,type:h}}return{}}function D(e){const n=e.kind?.toLowerCase()||"unknown",t=e.namespace||f,s=e.name||"unknown",r=e.context?.defaultKind?.toLowerCase(),i=e.context?.defaultNamespace?.toLowerCase();let a=s;return(i&&t.toLowerCase()!==i||t!==f)&&(a=`${t}/${a}`),r&&n.toLowerCase()!==r&&(a=`${n}:${a}`),a}function L(e,n,t){const[s,r]=y.useState(e);return y.useEffect(()=>{r(e);const i=n?.subscribe({next:a=>{r(a)},complete:()=>{i?.unsubscribe()}});return()=>{i?.unsubscribe()}},t),s}function S(e,n){const s=T().get(E),r=[s,JSON.stringify(e),JSON.stringify(n||null)],i=y.useMemo(()=>{if(!s){const a=I(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return s.forEntity(typeof e=="string"||"metadata"in e?e:w(e),n)},r);return L(i.snapshot,i.update$,[i])}const P=x(e=>({root:{display:"inline-flex",alignItems:"center",textDecoration:"inherit"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),K=e=>{const{entityRef:n,hideIcon:t,disableTooltip:s,defaultKind:r,defaultNamespace:i}=e,a=P(),{primaryTitle:h,secondaryTitle:m,Icon:d}=S(n,{defaultKind:r,defaultNamespace:i});let l=p.jsx(p.Fragment,{children:h});return l=p.jsxs(b,{component:"span",className:a.root,children:[d&&!t?p.jsx(b,{component:"span",className:a.icon,children:p.jsx(d,{fontSize:"inherit"})}):null,l]}),m&&!s&&(l=p.jsx(j,{enterDelay:1500,title:m,children:l})),l};K.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
