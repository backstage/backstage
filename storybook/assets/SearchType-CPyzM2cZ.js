import{r as p,aK as M,aL as F,aM as J,aN as P,Y as z,M as W,J as T,j as r,e as X}from"./iframe-DEPu6gb6.js";import{E as O}from"./ExpandMore-f018RETT.js";import{u as B}from"./useAsync-CXqm1YlW.js";import{s as q}from"./translation-Dz_SqZI_.js";import{m as j}from"./makeStyles-DmiRwbC-.js";import{u as A}from"./SearchContext-C_VLWS4z.js";import{s as H}from"./api-B8NpRCgE.js";import{B as U}from"./Box-CRmT1Uep.js";import{A as $,a as K,b as Y}from"./AccordionDetails-nYq3MGOf.js";import{L as G}from"./List-6W-tA5Er.js";import{D as Q}from"./Divider-Ce0hzK3j.js";import{L as Z}from"./ListItem-Bp_YBU-O.js";import{L as ee}from"./ListItemIcon-C1zFb_hB.js";import{L as k}from"./ListItemText-3-mp0clE.js";import{T as re,a as ae}from"./Tabs-Drj02WKW.js";import{a as se}from"./FormLabel-D6UJOp3T.js";import{I as ne}from"./InputLabel-IUsVuxd9.js";import{S as te}from"./Select-vBtV_Tvu.js";import{M as ie}from"./MenuItem-Cr_5oxMb.js";import{C as oe}from"./Checkbox-TUTDokqR.js";import{C as le}from"./Chip-BrHrYCVI.js";var ce=function(e){p.useEffect(e,[])},h={},I;function ue(){if(I)return h;I=1;var e=M(),n=F();Object.defineProperty(h,"__esModule",{value:!0}),h.default=void 0;var t=n(J()),u=e(P()),l=(0,u.default)(t.createElement("path",{d:"M9.93 13.5h4.14L12 7.98zM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-4.05 16.5l-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09z"}),"FontDownload");return h.default=l,h}var pe=ue();const me=z(pe),de=j(e=>({icon:{color:e.palette.text.primary},list:{width:"100%"},listItemIcon:{width:"24px",height:"24px"},accordion:{backgroundColor:e.palette.background.paper},accordionSummary:{minHeight:"auto","&.Mui-expanded":{minHeight:"auto"}},accordionSummaryContent:{margin:e.spacing(2,0),"&.Mui-expanded":{margin:e.spacing(2,0)}},accordionDetails:{padding:e.spacing(0,0,1)}})),E=e=>{const n=de(),{filters:t,setPageCursor:u,setTypes:l,term:c,types:i}=A(),m=W(H),[y,f]=p.useState(!0),{defaultValue:s,name:o,showCounts:w,types:N}=e,{t:v}=T(q),g=p.useRef(null),D=()=>f(a=>!a),L=a=>()=>{l(a!==""?[a]:[]),u(void 0)};p.useEffect(()=>{s&&l([s])},[]);const b=[{value:"",name:v("searchType.accordion.allTitle"),icon:r.jsx(me,{})},...N],V=i[0]||"",{value:C}=B(async()=>{if(!w)return{};g.current&&g.current.abort();const a=new AbortController;g.current=a;const _=await Promise.all(b.map(d=>d.value).map(async d=>{const{numberOfResults:x}=await m.query({term:c,types:d?[d]:[],filters:i.includes(d)||!i.length&&!d?t:{},pageLimit:0},{signal:a.signal});return[d,x!==void 0?v("searchType.accordion.numberOfResults",{number:x>=1e4?">10000":`${x}`}):" -- "]}));return Object.fromEntries(_)},[t,w,c,i]);return p.useEffect(()=>()=>{g.current&&g.current.abort()},[]),r.jsxs(U,{children:[r.jsx(X,{variant:"body2",component:"h2",children:o}),r.jsxs($,{className:n.accordion,expanded:y,onChange:D,children:[r.jsx(K,{classes:{root:n.accordionSummary,content:n.accordionSummaryContent},expandIcon:r.jsx(O,{className:n.icon}),IconButtonProps:{size:"small"},children:y?v("searchType.accordion.collapse"):b.filter(a=>a.value===V)[0].name}),r.jsx(Y,{classes:{root:n.accordionDetails},children:r.jsx(G,{className:n.list,component:"nav","aria-label":"filter by type",disablePadding:!0,dense:!0,children:b.map(a=>r.jsxs(p.Fragment,{children:[r.jsx(Q,{}),r.jsxs(Z,{selected:i[0]===a.value||i.length===0&&a.value==="",onClick:L(a.value),button:!0,children:[r.jsx(ee,{children:p.cloneElement(a.icon,{className:n.listItemIcon})}),r.jsx(k,{primary:a.name,secondary:C&&C[a.value]})]})]},a.value))})})]})]})};E.__docgenInfo={description:"",methods:[],displayName:"SearchTypeAccordion",props:{name:{required:!0,tsType:{name:"string"},description:""},types:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  value: string;
  name: string;
  icon: JSX.Element;
