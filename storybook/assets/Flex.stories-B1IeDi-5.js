import{p as w,j as e,B as D}from"./iframe-CmF8XmXW.js";import{F as t}from"./Flex-CM3T29UH.js";import{T as y}from"./Text-G8ZCzX5g.js";import"./preload-helper-PPVm8Dsz.js";const a=w.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}},args:{children:null}}),r=({width:n="48px",height:j="48px"})=>{const b=(()=>{const f=`
