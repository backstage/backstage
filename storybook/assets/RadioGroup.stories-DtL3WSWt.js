import{r as p,R as D,aw as H,au as U,j as r,p as re}from"./iframe-BemVm3iW.js";import{$ as K,c as ie,d as se,b as J,a as Q,f as oe,e as de}from"./utils-67UUfq9j.js";import{$ as le}from"./FieldError-Cm8-SYqK.js";import{c as te,b as ne,a as ue}from"./useFormValidation-B11nhLHh.js";import{$ as ce}from"./Label-CfLV2GEV.js";import{$ as pe,c as be,a as fe}from"./FocusScope-BZlQ-oae.js";import{a as me}from"./Text-D4cNg7sI.js";import{$ as ve,a as _,o as Re,e as $e}from"./useGlobalListeners-DjNZsfXO.js";import{b as S,d as he,$ as xe,a as ge}from"./useObjectRef-DNY1z9xy.js";import{$ as ye}from"./useFormReset-Bj_FEjdF.js";import{$ as z}from"./usePress-CoePygci.js";import{$ as qe}from"./useField-B3R_LXuf.js";import{$ as Pe,b as De,a as Se}from"./useHover-qzmeHD-I.js";import{$ as je}from"./I18nProvider-KlzMPuIO.js";import{$ as Ce}from"./useControlledState-65WJWsue.js";import{a as Ge}from"./VisuallyHidden-C5KQiBDM.js";import{F as Ve}from"./FieldLabel-4B3aYjfT.js";import{F as Be}from"./FieldError-B1_hyNvG.js";import"./preload-helper-PPVm8Dsz.js";import"./Hidden-PdwGn6CK.js";import"./openLink-DsdV9ckj.js";import"./textSelection-ctslQtv7.js";import"./useLabel-BKeoaEj8.js";import"./useLabels-Cns4Y3S6.js";const X=new WeakMap;function Ie(e,a,o){let{value:d,children:b,"aria-label":i,"aria-labelledby":R,onPressStart:l,onPressEnd:f,onPressChange:t,onPress:n,onPressUp:u,onClick:$}=e;const c=e.isDisabled||a.isDisabled;let P=a.selectedValue===d,G=C=>{C.stopPropagation(),a.setSelectedValue(d)},{pressProps:V,isPressed:B}=z({onPressStart:l,onPressEnd:f,onPressChange:t,onPress:n,onPressUp:u,onClick:$,isDisabled:c}),{pressProps:I,isPressed:j}=z({onPressStart:l,onPressEnd:f,onPressChange:t,onPressUp:u,onClick:$,isDisabled:c,onPress(C){n?.(C),a.setSelectedValue(d),o.current?.focus()}}),{focusableProps:A}=ve(S(e,{onFocus:()=>a.setLastFocusedValue(d)}),o),g=S(V,A),y=_(e,{labelable:!0}),h=-1;a.selectedValue!=null?a.selectedValue===d&&(h=0):(a.lastFocusedValue===d||a.lastFocusedValue==null)&&(h=0),c&&(h=void 0);let{name:x,form:w,descriptionId:ee,errorMessageId:ae,validationBehavior:W}=X.get(a);return ye(o,a.defaultSelectedValue,a.setSelectedValue),te({validationBehavior:W},a,o),{labelProps:S(I,p.useMemo(()=>({onClick:C=>C.preventDefault(),onMouseDown:C=>C.preventDefault()}),[])),inputProps:S(y,{...g,type:"radio",name:x,form:w,tabIndex:h,disabled:c,required:a.isRequired&&W==="native",checked:P,value:d,onChange:G,"aria-describedby":[e["aria-describedby"],a.isInvalid?ae:null,ee].filter(Boolean).join(" ")||void 0}),isDisabled:c,isSelected:P,isPressed:B||j}}function we(e,a){let{name:o,form:d,isReadOnly:b,isRequired:i,isDisabled:R,orientation:l="vertical",validationBehavior:f="aria"}=e,{direction:t}=je(),{isInvalid:n,validationErrors:u,validationDetails:$}=a.displayValidation,{labelProps:c,fieldProps:P,descriptionProps:G,errorMessageProps:V}=qe({...e,labelElementType:"span",isInvalid:a.isInvalid,errorMessage:e.errorMessage||u}),B=_(e,{labelable:!0}),{focusWithinProps:I}=Pe({onBlurWithin(g){e.onBlur?.(g),a.selectedValue||a.setLastFocusedValue(null)},onFocusWithin:e.onFocus,onFocusWithinChange:e.onFocusChange}),j=g=>{let y;switch(g.key){case"ArrowRight":t==="rtl"&&l!=="vertical"?y="prev":y="next";break;case"ArrowLeft":t==="rtl"&&l!=="vertical"?y="next":y="prev";break;case"ArrowDown":y="next";break;case"ArrowUp":y="prev";break;default:return}g.preventDefault();let h=pe(g.currentTarget,{from:$e(g),accept:w=>w instanceof Re(w).HTMLInputElement&&w.type==="radio"}),x;y==="next"?(x=h.nextNode(),x||(h.currentNode=g.currentTarget,x=h.firstChild())):(x=h.previousNode(),x||(h.currentNode=g.currentTarget,x=h.lastChild())),x&&(x.focus(),a.setSelectedValue(x.value))},A=he(o);return X.set(a,{name:A,form:d,descriptionId:G.id,errorMessageId:V.id,validationBehavior:f}),{radioGroupProps:S(B,{role:"radiogroup",onKeyDown:j,"aria-invalid":a.isInvalid||void 0,"aria-errormessage":e["aria-errormessage"],"aria-readonly":b||void 0,"aria-required":i||void 0,"aria-disabled":R||void 0,"aria-orientation":l,...P,...I}),labelProps:c,descriptionProps:G,errorMessageProps:V,isInvalid:n,validationErrors:u,validationDetails:$}}let Fe=Math.round(Math.random()*1e10),Le=0;function Ne(e){let a=p.useMemo(()=>e.name||`radio-group-${Fe}-${++Le}`,[e.name]),[o,d]=Ce(e.value,e.defaultValue??null,e.onChange),[b]=p.useState(o),[i,R]=p.useState(null),l=ne({...e,value:o}),f=n=>{!e.isReadOnly&&!e.isDisabled&&(d(n),l.commitValidation())},t=l.displayValidation.isInvalid;return{...l,name:a,selectedValue:o,defaultSelectedValue:e.value!==void 0?b:e.defaultValue??null,setSelectedValue:f,lastFocusedValue:i,setLastFocusedValue:R,isDisabled:e.isDisabled||!1,isReadOnly:e.isReadOnly||!1,isRequired:e.isRequired||!1,validationState:e.validationState||(t?"invalid":null),isInvalid:t}}const Oe=p.createContext(null),Ee=p.createContext(null),Y=p.createContext(null),Me=p.forwardRef(function(a,o){[a,o]=K(a,o,Oe);let{validationBehavior:d}=ie(ue)||{},b=a.validationBehavior??d??"native",i=Ne({...a,validationBehavior:b}),[R,l]=se(!a["aria-label"]&&!a["aria-labelledby"]),{radioGroupProps:f,labelProps:t,descriptionProps:n,errorMessageProps:u,...$}=we({...a,label:l,validationBehavior:b},i),c=J({...a,values:{orientation:a.orientation||"vertical",isDisabled:i.isDisabled,isReadOnly:i.isReadOnly,isRequired:i.isRequired,isInvalid:i.isInvalid,state:i},defaultClassName:"react-aria-RadioGroup"}),P=_(a,{global:!0});return D.createElement(Q.div,{...S(P,c,f),ref:o,slot:a.slot||void 0,"data-orientation":a.orientation||"vertical","data-invalid":i.isInvalid||void 0,"data-disabled":i.isDisabled||void 0,"data-readonly":i.isReadOnly||void 0,"data-required":i.isRequired||void 0},D.createElement(oe,{values:[[Y,i],[ce,{...t,ref:R,elementType:"span"}],[me,{slots:{description:n,errorMessage:u}}],[le,$]]},D.createElement(be,null,c.children)))}),ke=p.forwardRef(function(a,o){let{inputRef:d=null,...b}=a;[a,o]=K(b,o,Ee);let i=D.useContext(Y),R=xe(p.useMemo(()=>ge(d,a.inputRef!==void 0?a.inputRef:null),[d,a.inputRef])),{labelProps:l,inputProps:f,isSelected:t,isDisabled:n,isPressed:u}=Ie({...de(a),children:typeof a.children=="function"?!0:a.children},i,R),{isFocused:$,isFocusVisible:c,focusProps:P}=De(),G=n||i.isReadOnly,{hoverProps:V,isHovered:B}=Se({...a,isDisabled:G}),I=J({...a,defaultClassName:"react-aria-Radio",values:{isSelected:t,isPressed:u,isHovered:B,isFocused:$,isFocusVisible:c,isDisabled:n,isReadOnly:i.isReadOnly,isInvalid:i.isInvalid,isRequired:i.isRequired}}),j=_(a,{global:!0});return delete j.id,delete j.onClick,D.createElement(Q.label,{...S(j,l,V,I),ref:o,"data-selected":t||void 0,"data-pressed":u||void 0,"data-hovered":B||void 0,"data-focused":$||void 0,"data-focus-visible":c||void 0,"data-disabled":n||void 0,"data-readonly":i.isReadOnly||void 0,"data-invalid":i.isInvalid||void 0,"data-required":i.isRequired||void 0},D.createElement(Ge,{elementType:"span"},D.createElement("input",{...S(f,P),ref:R})),D.createElement(fe.Provider,{value:{isSelected:t}},I.children))}),Z={"bui-RadioGroup":"_bui-RadioGroup_1tanw_20","bui-RadioGroupContent":"_bui-RadioGroupContent_1tanw_26","bui-Radio":"_bui-Radio_1tanw_20"},Te=H()({styles:Z,classNames:{root:"bui-RadioGroup",content:"bui-RadioGroupContent"},propDefs:{children:{},className:{},label:{},secondaryLabel:{},description:{},isRequired:{}}}),_e=H()({styles:Z,classNames:{root:"bui-Radio"},propDefs:{className:{}}}),v=p.forwardRef((e,a)=>{const{ownProps:o,restProps:d}=U(Te,e),{classes:b,label:i,secondaryLabel:R,description:l,isRequired:f,children:t}=o,n=d["aria-label"],u=d["aria-labelledby"];p.useEffect(()=>{!i&&!n&&!u&&console.warn("RadioGroup requires either a visible label, aria-label, or aria-labelledby for accessibility")},[i,n,u]);const $=R||(f?"Required":null);return r.jsxs(Me,{className:b.root,...d,ref:a,children:[r.jsx(Ve,{label:i,secondaryLabel:$,description:l,descriptionSlot:"description"}),r.jsx("div",{className:b.content,children:t}),r.jsx(Be,{})]})});v.displayName="RadioGroup";const s=p.forwardRef((e,a)=>{const{ownProps:o,restProps:d}=U(_e,e);return r.jsx(ke,{className:o.classes.root,...d,ref:a})});s.displayName="Radio";v.__docgenInfo={description:`A group of radio buttons for selecting a single option from a set, with an integrated label, description, and error display.
