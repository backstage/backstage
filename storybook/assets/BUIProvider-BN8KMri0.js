import{r as i,c as u,j as t,b as o,u as c,d as p,e as m}from"./iframe-ePBrCY0J.js";import{a as l}from"./openLink-DeVepgBP.js";function d(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(g,{children:r}):r}function g({children:n}){const e=p();return t.jsx(l,{navigate:e,useHref:m,children:n})}d.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
