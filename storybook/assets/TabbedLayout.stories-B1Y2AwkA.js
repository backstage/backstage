import{r as b,j as e,b3 as f,b4 as x,b5 as R,M as g,a8 as j,a9 as L}from"./iframe-DIcQvc_4.js";import{H as v}from"./Helmet-jGhRI2xB.js";import{L as E}from"./Link-CNvpICkX.js";import{H as P}from"./HeaderTabs-Dw6h0jVr.js";import{C as w}from"./Content-BEu8a6ib.js";import{a as _}from"./componentData-C49Tx7W9.js";import"./preload-helper-PPVm8Dsz.js";import"./index--onu0eIM.js";import"./lodash-D5XEdOes.js";import"./useAnalytics-CkzkVu-R.js";import"./makeStyles-CSt6JC-p.js";import"./useApp-CpeMA22u.js";import"./Box-D_uAdcR5.js";import"./styled-CMENgzGI.js";import"./Tabs-7DO8Rp8g.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-a4j4LH4Y.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
