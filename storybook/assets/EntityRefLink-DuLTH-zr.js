import{ca as a,bR as i}from"./iframe-COykYx45.js";import{a as y,e as f}from"./routes-Dao7eh4t.js";import{L as m}from"./Link-Bm3AlTT9.js";import{u as g}from"./useRouteRef-CO8HfKAe.js";import{E as b}from"./EntityDisplayName-CZPDa2IJ.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...c}=e,p=v(),u=l??o??i.jsx(b,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(m,{...c,ref:t,to:p(e.entityRef),children:u})});function v(){const e=g(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
