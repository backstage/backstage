import{j as a}from"./jsx-runtime-Cw0GR0a5.js";import{s as fe,M as ve}from"./api-B335RvSG.js";import{r as F}from"./index-CTjT7uj6.js";import{l as ye}from"./lodash-CoGan1YB.js";import{a as be}from"./useAsync-CXA3qup_.js";import{u as he}from"./useDebounce-4fqASXX_.js";import{u as _,S as we}from"./SearchContext-NUeqQOQ4.js";import{A as ke}from"./Autocomplete-DCsSpEWK.js";import{T as Fe}from"./TextField-CPh6eYOH.js";import{C as qe}from"./Chip-Dtfvbyrk.js";import{s as Ve}from"./translation-CE915EFO.js";import{m as Se}from"./makeStyles-Dm18XSEu.js";import{a as me,F as Ae}from"./FormLabel-BrNHbqEV.js";import{F as De}from"./FormControlLabel-Dv6_-nyd.js";import{C as xe}from"./Checkbox-BCrnskmI.js";import{u as je}from"./useTranslationRef-Bfx90Ud1.js";import{S as Te}from"./Select-BkwTD7xe.js";import{S as B}from"./Grid-Ddd13ysM.js";import{P as V}from"./Paper-qJ_yTBwO.js";import{T as Pe}from"./TestApiProvider-4wn3im9M.js";import"./ApiRef-CqkoWjZn.js";import"./useMountedState-DkESzBh4.js";import"./useAnalytics-DVyBXs_0.js";import"./ConfigApi-D1qiBdfc.js";import"./defaultTheme-DXWIybXe.js";import"./clsx.m-CH7BE6MN.js";import"./Close-D08CbUTF.js";import"./createSvgIcon-BJFLD5ph.js";import"./capitalize-DIeCfh_E.js";import"./withStyles-DXZDjQMO.js";import"./hoist-non-react-statics.cjs-DzIEFHQI.js";import"./unstable_useId-B3Hiq1YI.js";import"./useControlled-B47E2WMp.js";import"./ownerWindow-C3iVrxHF.js";import"./useIsFocusVisible-BQk2_Vhe.js";import"./index-DwHHXP4W.js";import"./IconButton-BSH9TP2p.js";import"./ButtonBase-Uu46Oxts.js";import"./TransitionGroupContext-BtzQ-Cv7.js";import"./Popper-BDWXeP68.js";import"./createChainedFunction-Da-WpsAN.js";import"./Portal-BcgI5KAA.js";import"./ListSubheader-CXPZCpnh.js";import"./InputLabel-D7VnpKNN.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-F4cJWIkJ.js";import"./Select-si4QpcLc.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-DSe7I3Kh.js";import"./Popover-9SzFdI24.js";import"./debounce-DtXjJkxj.js";import"./Modal-CpdTxbhX.js";import"./classCallCheck-BNzALLS0.js";import"./Grow-Dg8gmH27.js";import"./utils-Dyc_dOmK.js";import"./List-CwINgjy8.js";import"./ListContext-DydK1sOh.js";import"./TranslationApi-DhmNHZQM.js";import"./isMuiElement-B_4ddUuK.js";import"./Typography-cLPqD11X.js";import"./SwitchBase-DH3shUNx.js";import"./Cancel-CSg1qY6B.js";import"./interopRequireDefault-Y9pwbXtE.js";import"./createSvgIcon-qSoWoVHl.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-ByXAoPiX.js";import"./typography-DWsaOnmo.js";import"./MenuItem-2T-GM7HH.js";import"./ListItem-BgOZ8hnS.js";import"./ApiProvider-DlKBPm-W.js";import"./index-BRV0Se7Z.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function Ce(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const Ie=new Uint8Array(16);function Ee(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(Ie)}const Me=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:Me};function Ne(e,n,l){var t;if(z.randomUUID&&!n&&!e)return z.randomUUID();e=e||{};const r=e.random??((t=e.rng)==null?void 0:t.call(e))??Ee();if(r.length<16)throw new Error("Random bytes length must be >= 16");return r[6]=r[6]&15|64,r[8]=r[8]&63|128,Ce(r)}function q(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>q(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],r=250)=>{const t=F.useRef({}),i=F.useCallback(async o=>{var v;return((v=await(e==null?void 0:e(o)))==null?void 0:v.map(h=>q(h)))||[]},[e]),[b,p]=be(i,[n],{loading:!0});if(he(()=>{t.current[n]===void 0&&(t.current[n]=p(n).then(o=>(t.current[n]=o,o)))},r,[p,n]),l.length)return{loading:!1,value:l};const f=t.current[n];return Array.isArray(f)?{loading:!1,value:f}:b},O=(e,n)=>{const{setFilters:l}=_();F.useEffect(()=>{n&&[n].flat().length>0&&l(r=>({...r,[e]:n}))},[])},ce=e=>{const{className:n,defaultValue:l,name:r,values:t,valuesDebounceMs:i,label:b,filterSelectedOptions:p,limitTags:f,multiple:o}=e,[v,h]=F.useState("");O(r,l);const w=typeof t=="function"?t:void 0,S=typeof t=="function"||t==null?void 0:t.map(c=>q(c)),{value:A,loading:m}=L(w,v,S,i),{filters:d,setFilters:D}=_(),g=q(d[r]),x=F.useMemo(()=>g||(o?[]:null),[g,o]),j=(c,y)=>{D(W=>{const{[r]:U,...$}=W;return y?{...$,[r]:Array.isArray(y)?y.map(ge=>ge.value):y.value}:{...$}})},k=c=>a.jsx(Fe,{...c,name:"search",variant:"outlined",label:b,fullWidth:!0}),N=(c,y)=>c.map((W,U)=>a.jsx(qe,{label:W.label,color:"primary",...y({index:U})}));return a.jsx(ke,{filterSelectedOptions:p,limitTags:f,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${r}--select`,options:A||[],loading:m,value:x,onChange:j,onInputChange:(c,y)=>h(y),getOptionLabel:c=>c.label,renderInput:k,renderTags:N})};ce.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
