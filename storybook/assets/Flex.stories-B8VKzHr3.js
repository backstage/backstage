import{p as f,j as e}from"./iframe-BBTbmRF3.js";import{F as t}from"./Flex-Dvn5PWY5.js";import{B as w}from"./Box-CUq8QMq0.js";import{T as D}from"./Text-8YHdAaE0.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./useStyles-DkiinFPC.js";import"./useBg-BKE7wWOd.js";import"./defineComponent-DoPKM1jS.js";const a=f.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),r=({width:n="48px",height:y="48px"})=>{const j=(()=>{const b=`
...
`,...B.input.parameters?.docs?.source}}};x.input.parameters={...x.input.parameters,docs:{...x.input.parameters?.docs,source:{code:`const AlignEndInColumn = () => (
