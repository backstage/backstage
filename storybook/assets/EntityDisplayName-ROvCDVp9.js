import{ca as d,cE as y,bR as s}from"./iframe-DogXi1kP.js";import{c as m}from"./useAnalytics-DWMKXBU9.js";import{d as f}from"./defaultEntityPresentation-D9flqknL.js";import{s as g}from"./ref-C0VTUPuL.js";import{B as h}from"./Box-CJxb0nPe.js";import{T as b}from"./Tooltip-D0UbP4zj.js";import{m as w}from"./makeStyles-Bkm64Dpi.js";const v=m({id:"plugin.catalog.entity-presentation"});function k(e,n,l){const[i,r]=d.useState(e);return d.useEffect(()=>{r(e);const t=n?.subscribe({next:a=>{r(a)},complete:()=>{t?.unsubscribe()}});return()=>{t?.unsubscribe()}},l),i}function T(e,n){const i=y().get(v),r=[i,JSON.stringify(e),JSON.stringify(n||null)],t=d.useMemo(()=>{if(!i){const a=f(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return i.forEntity(typeof e=="string"||"metadata"in e?e:g(e),n)},r);return k(t.snapshot,t.update$,[t])}const q=w(e=>({root:{display:"inline-flex",alignItems:"center",textDecoration:"inherit"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),A=e=>{const{entityRef:n,hideIcon:l,disableTooltip:i,defaultKind:r,defaultNamespace:t}=e,a=q(),{primaryTitle:u,secondaryTitle:p,Icon:c}=T(n,{defaultKind:r,defaultNamespace:t});let o=s.jsx(s.Fragment,{children:u});return o=s.jsxs(h,{component:"span",className:a.root,children:[c&&!l?s.jsx(h,{component:"span",className:a.icon,children:s.jsx(c,{fontSize:"inherit"})}):null,o]}),p&&!i&&(o=s.jsx(b,{enterDelay:1500,title:p,children:o})),o};A.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  namespace: string;
  name: string;
}`,signature:{properties:[{key:"kind",value:{name:"string",required:!0}},{key:"namespace",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},{name:"string"}]},description:""},hideIcon:{required:!1,tsType:{name:"boolean"},description:""},disableTooltip:{required:!1,tsType:{name:"boolean"},description:""},defaultKind:{required:!1,tsType:{name:"string"},description:""},defaultNamespace:{required:!1,tsType:{name:"string"},description:""}}};export{A as E};
