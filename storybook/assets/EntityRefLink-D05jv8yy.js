import{ca as a,bR as i}from"./iframe-DEB_XKCy.js";import{a as y,e as f}from"./routes-DBgS4a4T.js";import{L as m}from"./Link-BIYNobCf.js";import{u as g}from"./useRouteRef-NhK-xxXj.js";import{E as b}from"./EntityDisplayName-Bl4kpSq9.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...c}=e,p=v(),u=l??o??i.jsx(b,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(m,{...c,ref:t,to:p(e.entityRef),children:u})});function v(){const e=g(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
