import{aI as I,r as P,aJ as Y,j as e,p as z,B as T}from"./iframe-r9k78NKI.js";import{a as L}from"./Button-DMv3emQN.js";import{f as O,j as U,y as V,R as E,s as $,T as R}from"./index-D67tspQZ.js";import{F as t}from"./Flex-DOBT50-L.js";import{B as y}from"./Button-8etGVmMC.js";import{T as r}from"./Text-BJFJJBBb.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-1mF-mBBW.js";import"./useObjectRef-D_gkq7Ew.js";import"./Label-Cy1E8g1_.js";import"./Hidden-mX6k30Yo.js";import"./useFocusable-C1vNZMdU.js";import"./useLabel-BgVranTK.js";import"./useLabels-BP6YpHP4.js";import"./context-J0ELobpY.js";import"./useButton-CxoWNHfS.js";import"./usePress-_C_kwqnI.js";import"./useFocusRing-BYB5Rr_l.js";import"./useStyles-C_XuVXRZ.js";const J={"bui-Alert":"_bui-Alert_jhpr2_20","bui-AlertIcon":"_bui-AlertIcon_jhpr2_57","bui-AlertContentWrapper":"_bui-AlertContentWrapper_jhpr2_74","bui-AlertContent":"_bui-AlertContent_jhpr2_74","bui-AlertTitle":"_bui-AlertTitle_jhpr2_94","bui-AlertDescription":"_bui-AlertDescription_jhpr2_99","bui-AlertSpinner":"_bui-AlertSpinner_jhpr2_104","bui-spin":"_bui-spin_jhpr2_1","bui-AlertActions":"_bui-AlertActions_jhpr2_114"},G=I()({styles:J,classNames:{root:"bui-Alert",contentWrapper:"bui-AlertContentWrapper",content:"bui-AlertContent",title:"bui-AlertTitle",description:"bui-AlertDescription",icon:"bui-AlertIcon",spinner:"bui-AlertSpinner",actions:"bui-AlertActions"},propDefs:{status:{dataAttribute:!0,default:"info"},loading:{dataAttribute:!0},icon:{},customActions:{},title:{},description:{},className:{},style:{}},utilityProps:["m","mb","ml","mr","mt","mx","my"]}),n=P.forwardRef((A,k)=>{const{ownProps:D,restProps:q,dataAttributes:W,utilityStyle:C}=Y(G,A),{classes:l,status:S,icon:w,loading:_,customActions:j,title:F,description:b,style:N}=D,B=(()=>{if(w===!1)return null;if(P.isValidElement(w))return w;if(w===!0)switch(S){case"success":return e.jsx($,{"aria-hidden":"true"});case"warning":return e.jsx(E,{"aria-hidden":"true"});case"danger":return e.jsx(V,{"aria-hidden":"true"});default:return e.jsx(U,{"aria-hidden":"true"})}return null})();return e.jsxs("div",{className:l.root,ref:k,style:{...N,...C},...W,...q,"data-has-description":b?"true":"false",children:[e.jsxs("div",{className:l.contentWrapper,children:[_?e.jsx("div",{className:l.icon,children:e.jsx(L,{"aria-label":"Loading",isIndeterminate:!0,className:l.spinner,children:e.jsx(O,{"aria-hidden":"true"})})}):B&&e.jsx("div",{className:l.icon,children:B}),e.jsxs("div",{className:l.content,children:[F&&e.jsx("div",{className:l.title,children:F}),b&&e.jsx("div",{className:l.description,children:b})]})]}),j&&e.jsx("div",{className:l.actions,children:j})]})});n.displayName="Alert";n.__docgenInfo={description:`A component for displaying alert messages with different status levels.
...
`,...m.input.parameters?.docs?.source}}};i.input.parameters={...i.input.parameters,docs:{...i.input.parameters?.docs,source:{code:`const WithActions = () => (
  <Flex direction="column" gap="4">
    <Alert
      status="info"
      icon={true}
...
`,...i.input.parameters?.docs?.source}}};d.input.parameters={...d.input.parameters,docs:{...d.input.parameters?.docs,source:{code:`const WithActionsAndDescriptions = () => (
...
})`,...i.input.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`WithActions.extend({
  args: {
...
})`,...f.input.parameters?.docs?.source}}};const ve=["Default","StatusVariants","WithDescription","WithoutIcons","CustomIcon","WithActions","WithActionsAndDescriptions","LoadingVariants","LoadingWithDescription","LongContent","OnDifferentBackgrounds","Responsive","WithUtilityProps"];export{m as CustomIcon,s as Default,p as LoadingVariants,v as LoadingWithDescription,g as LongContent,h as OnDifferentBackgrounds,x as Responsive,o as StatusVariants,i as WithActions,d as WithActionsAndDescriptions,u as WithDescription,f as WithUtilityProps,c as WithoutIcons,ve as __namedExportsOrder};
