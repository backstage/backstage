import{r as p,aQ as F,aR as M,aS as P,aT as z,aE as J,V as O,S as T,j as r,O as W}from"./iframe-DWvOg1Nr.js";import{E as X}from"./ExpandMore-DPLbvTgi.js";import{u as B}from"./useAsync-WwgC0jUx.js";import{s as q}from"./translation-Bo3vZ6kI.js";import{u as j}from"./SearchContext-BltdEP87.js";import{s as H}from"./api-C_OdQe4o.js";import{B as U}from"./Box-zyqdCy3P.js";import{A as $,a as Q,b as G}from"./AccordionDetails-IDw-tlej.js";import{L as K}from"./List-BFA7b6ty.js";import{D as Y}from"./Divider-l_Tw4Y2t.js";import{L as Z}from"./ListItem-CYRCHcIm.js";import{L as ee}from"./ListItemIcon-ClLCrJv6.js";import{L as k}from"./ListItemText-B4brgRyM.js";import{m as S}from"./makeStyles-CHGG-m_x.js";import{T as re,a as ae}from"./Tabs-BH8YMBca.js";import{a as se}from"./FormLabel-NmTkFu44.js";import{I as ne}from"./InputLabel-CZqMVil_.js";import{S as te}from"./Select-czkWpdW5.js";import{M as ie}from"./MenuItem-Chca2jLO.js";import{C as oe}from"./Checkbox-B_TtUlRL.js";import{C as le}from"./Chip-CS5kTr-p.js";var ce=function(e){p.useEffect(e,[])},h={},I;function ue(){if(I)return h;I=1;var e=F(),n=M();Object.defineProperty(h,"__esModule",{value:!0}),h.default=void 0;var t=n(P()),u=e(z()),l=(0,u.default)(t.createElement("path",{d:"M9.93 13.5h4.14L12 7.98zM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-4.05 16.5l-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09z"}),"FontDownload");return h.default=l,h}var pe=ue();const me=J(pe),de=S(e=>({icon:{color:e.palette.text.primary},list:{width:"100%"},listItemIcon:{width:"24px",height:"24px"},accordion:{backgroundColor:e.palette.background.paper},accordionSummary:{minHeight:"auto","&.Mui-expanded":{minHeight:"auto"}},accordionSummaryContent:{margin:e.spacing(2,0),"&.Mui-expanded":{margin:e.spacing(2,0)}},accordionDetails:{padding:e.spacing(0,0,1)}})),E=e=>{const n=de(),{filters:t,setPageCursor:u,setTypes:l,term:c,types:i}=j(),m=O(H),[y,f]=p.useState(!0),{defaultValue:s,name:o,showCounts:w,types:N}=e,{t:v}=T(q),g=p.useRef(null),V=()=>f(a=>!a),D=a=>()=>{l(a!==""?[a]:[]),u(void 0)};p.useEffect(()=>{s&&l([s])},[]);const b=[{value:"",name:v("searchType.accordion.allTitle"),icon:r.jsx(me,{})},...N],_=i[0]||"",{value:C}=B(async()=>{if(!w)return{};g.current&&g.current.abort();const a=new AbortController;g.current=a;const L=await Promise.all(b.map(d=>d.value).map(async d=>{const{numberOfResults:x}=await m.query({term:c,types:d?[d]:[],filters:i.includes(d)||!i.length&&!d?t:{},pageLimit:0},{signal:a.signal});return[d,x!==void 0?v("searchType.accordion.numberOfResults",{number:x>=1e4?">10000":`${x}`}):" -- "]}));return Object.fromEntries(L)},[t,w,c,i]);return p.useEffect(()=>()=>{g.current&&g.current.abort()},[]),r.jsxs(U,{children:[r.jsx(W,{variant:"body2",component:"h2",children:o}),r.jsxs($,{className:n.accordion,expanded:y,onChange:V,children:[r.jsx(Q,{classes:{root:n.accordionSummary,content:n.accordionSummaryContent},expandIcon:r.jsx(X,{className:n.icon}),IconButtonProps:{size:"small"},children:y?v("searchType.accordion.collapse"):b.filter(a=>a.value===_)[0].name}),r.jsx(G,{classes:{root:n.accordionDetails},children:r.jsx(K,{className:n.list,component:"nav","aria-label":"filter by type",disablePadding:!0,dense:!0,children:b.map(a=>r.jsxs(p.Fragment,{children:[r.jsx(Y,{}),r.jsxs(Z,{selected:i[0]===a.value||i.length===0&&a.value==="",onClick:D(a.value),button:!0,children:[r.jsx(ee,{children:p.cloneElement(a.icon,{className:n.listItemIcon})}),r.jsx(k,{primary:a.name,secondary:C&&C[a.value]})]})]},a.value))})})]})]})};E.__docgenInfo={description:"",methods:[],displayName:"SearchTypeAccordion",props:{name:{required:!0,tsType:{name:"string"},description:""},types:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  value: string;
  name: string;
  icon: JSX.Element;
