import{p as S,j as e}from"./iframe-CZ56O-V9.js";import{F as t}from"./Flex-JgdQnoJ1.js";import{B as w}from"./Box-nCcQPkMh.js";import{T as y}from"./Text-DEO82EhZ.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./useStyles-D7IUwEzw.js";import"./useSurface-BSCeWj_h.js";import"./defineComponent-9AbASoY5.js";const a=S.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),n=({width:r="48px",height:D="48px"})=>{const B=(()=>{const j=`
...
`,...f.input.parameters?.docs?.source}}};F.input.parameters={...F.input.parameters,docs:{...F.input.parameters?.docs,source:{code:`const SurfacesAutoIncrement = () => (
