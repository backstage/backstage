import{j as p}from"./jsx-runtime-hv06LKfz.js";import{r as u}from"./index-D8-PC79C.js";import{a as m}from"./ConfigApi-ij0WO1-Y.js";import{b as h,c as v,g,u as R}from"./ApiRef-ByCJBjX1.js";const d=h("analytics-context"),l=()=>{const n=u.useContext(d);if(n===void 0)return{routeRef:"unknown",pluginId:"root",extension:"App"};const e=n.atVersion(1);if(e===void 0)throw new Error("No context found for version 1.");return e},x=n=>{const{attributes:e,children:r}=n,a={...l(),...e},s=m({1:a});return p.jsx(d.Provider,{value:s,children:r})};x.__docgenInfo={description:`Provides components in the child react tree an Analytics Context, ensuring
