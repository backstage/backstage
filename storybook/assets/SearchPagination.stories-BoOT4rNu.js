import{r as d,j as r,k as v,T as R}from"./iframe-CIdfBUNc.js";import{s as _,M as k}from"./api-DPo6etgd.js";import{s as N}from"./translation-DnjA1iFI.js";import{u as $,S as j}from"./SearchContext-Chra9qDZ.js";import{T as q}from"./TablePagination-Bf0xwYXE.js";import{S as b}from"./Grid-CNMGd53o.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-Y_-RFQgK.js";import"./useAsync-Cop8mLj-.js";import"./useMountedState-CxwBQu50.js";import"./useAnalytics-DK0dZYSI.js";import"./KeyboardArrowRight-gCL-vrdp.js";import"./MenuItem-C8xqJzBa.js";import"./ListItem-Dfr179My.js";import"./ListContext-BIMkaxMd.js";import"./TableCell-4-Kf4WGZ.js";import"./Select-CQPO1yO8.js";import"./index-B9sM2jn7.js";import"./Popover--nM83zpc.js";import"./Modal-BoVNQ_gf.js";import"./Portal-CzMBs-js.js";import"./List-CWTfe060.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-DK88pbWk.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v(N),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=$(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
