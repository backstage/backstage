import{p as f,j as e,B as w}from"./iframe-ByRYLFwj.js";import{F as t}from"./Flex-Ckka2nqT.js";import{T as D}from"./Text-BR0hq-Yr.js";import"./preload-helper-PPVm8Dsz.js";import"./useStyles-Tuoxuth-.js";const a=f.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),r=({width:n="48px",height:y="48px"})=>{const j=(()=>{const b=`
