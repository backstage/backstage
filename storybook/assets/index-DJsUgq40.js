import{ca as m,bR as s}from"./iframe-Bm5ba6Eo.js";import{H as d}from"./HeaderLabel-CfrllZOg.js";import"./preload-helper-PPVm8Dsz.js";import"./Grid-2YxRqddS.js";import"./Link-BddbTmYm.js";import"./index-ob8zNRki.js";import"./lodash-KBhUdAYx.js";import"./useAnalytics-BQdStjBt.js";import"./makeStyles-BxPw9vCe.js";import"./useApp-kMVg8txh.js";const g={hour:"2-digit",minute:"2-digit"};function c(l,o){const t=new Date,i=window.navigator.language,n=[];if(!l)return n;for(const r of l){let e=r.label;const a={timeZone:r.timeZone,...o??g};try{new Date().toLocaleString(i,a)}catch{console.warn(`The timezone ${a.timeZone} is invalid. Defaulting to GMT`),a.timeZone="GMT",e="GMT"}const u=t.toLocaleTimeString(i,a),p=t.toLocaleTimeString(i,{timeZone:a.timeZone,hour:"2-digit",minute:"2-digit",hour12:!1});n.push({label:e,value:u,dateTime:p})}return n}const f=l=>{const{clockConfigs:o,customTimeFormat:t}=l,i=[],[n,r]=m.useState(i);return m.useEffect(()=>{r(c(o,t));const e=setInterval(()=>{r(c(o,t))},1e3);return()=>{clearInterval(e)}},[o,t]),n.length!==0?s.jsx(s.Fragment,{children:n.map(e=>s.jsx(d,{label:e.label,value:s.jsx("time",{dateTime:e.dateTime,children:e.value})},e.label))}):null};f.__docgenInfo={description:`A component to display a configurable list of clocks for various time zones.
