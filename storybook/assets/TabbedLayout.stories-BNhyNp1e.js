import{r as b,j as e,a_ as f,a$ as x,b0 as R,M as g,a7 as j,a8 as L}from"./iframe-C0T-wj8W.js";import{H as v}from"./Helmet-Cp1SClP7.js";import{L as E}from"./Link-Dh9Tk7z5.js";import{H as P}from"./HeaderTabs-BDn8-YzA.js";import{C as _}from"./Content-DYx7IRFR.js";import{a as w}from"./componentData-Wenc7sxq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DiT9MzNM.js";import"./lodash-ByAGuY73.js";import"./useAnalytics-C8hlcdRX.js";import"./makeStyles-DViRTVia.js";import"./useApp-CHDrtVuY.js";import"./Box-zHlL_yoj.js";import"./styled-DP6UPB8s.js";import"./Tabs-B49tu5P7.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-DdzN3myO.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(_,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
