import{r as p,aN as P,aO as F,aP as M,aQ as z,aD as J,Q as O,L as T,j as r,g as W}from"./iframe-v7Qh39PS.js";import{E as X}from"./ExpandMore-CojGXmQl.js";import{u as B}from"./useAsync-Cr1-y7Ak.js";import{s as q}from"./translation-U0dfjs-Y.js";import{u as j}from"./SearchContext-BvHzKSA1.js";import{s as H}from"./api-C0B7vJ0F.js";import{B as U}from"./Box-DXZBhROx.js";import{A as $,a as Q,b as G}from"./AccordionDetails-BRINvrzF.js";import{L as K}from"./List-xof-D_2B.js";import{D as Y}from"./Divider-Bo3do-UZ.js";import{L as Z}from"./ListItem-Dah0XUNP.js";import{L as ee}from"./ListItemIcon-DmrGwb-x.js";import{L as k}from"./ListItemText-wNXBjsZ9.js";import{m as A}from"./makeStyles-DymchkiN.js";import{T as re,a as ae}from"./Tabs-Z6-5NjA4.js";import{a as se}from"./FormLabel-yFRpNzCW.js";import{I as ne}from"./InputLabel-BEOmw5bT.js";import{S as te}from"./Select-OXF1hz-e.js";import{M as ie}from"./MenuItem-CAh12VsF.js";import{C as oe}from"./Checkbox-Spm6kD6_.js";import{C as le}from"./Chip-DYsJS2ci.js";var ce=function(e){p.useEffect(e,[])},h={},I;function ue(){if(I)return h;I=1;var e=P(),n=F();Object.defineProperty(h,"__esModule",{value:!0}),h.default=void 0;var t=n(M()),u=e(z()),l=(0,u.default)(t.createElement("path",{d:"M9.93 13.5h4.14L12 7.98zM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-4.05 16.5l-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09z"}),"FontDownload");return h.default=l,h}var pe=ue();const me=J(pe),de=A(e=>({icon:{color:e.palette.text.primary},list:{width:"100%"},listItemIcon:{width:"24px",height:"24px"},accordion:{backgroundColor:e.palette.background.paper},accordionSummary:{minHeight:"auto","&.Mui-expanded":{minHeight:"auto"}},accordionSummaryContent:{margin:e.spacing(2,0),"&.Mui-expanded":{margin:e.spacing(2,0)}},accordionDetails:{padding:e.spacing(0,0,1)}})),E=e=>{const n=de(),{filters:t,setPageCursor:u,setTypes:l,term:c,types:i}=j(),m=O(H),[y,f]=p.useState(!0),{defaultValue:s,name:o,showCounts:w,types:N}=e,{t:v}=T(q),g=p.useRef(null),D=()=>f(a=>!a),L=a=>()=>{l(a!==""?[a]:[]),u(void 0)};p.useEffect(()=>{s&&l([s])},[]);const b=[{value:"",name:v("searchType.accordion.allTitle"),icon:r.jsx(me,{})},...N],V=i[0]||"",{value:C}=B(async()=>{if(!w)return{};g.current&&g.current.abort();const a=new AbortController;g.current=a;const _=await Promise.all(b.map(d=>d.value).map(async d=>{const{numberOfResults:x}=await m.query({term:c,types:d?[d]:[],filters:i.includes(d)||!i.length&&!d?t:{},pageLimit:0},{signal:a.signal});return[d,x!==void 0?v("searchType.accordion.numberOfResults",{number:x>=1e4?">10000":`${x}`}):" -- "]}));return Object.fromEntries(_)},[t,w,c,i]);return p.useEffect(()=>()=>{g.current&&g.current.abort()},[]),r.jsxs(U,{children:[r.jsx(W,{variant:"body2",component:"h2",children:o}),r.jsxs($,{className:n.accordion,expanded:y,onChange:D,children:[r.jsx(Q,{classes:{root:n.accordionSummary,content:n.accordionSummaryContent},expandIcon:r.jsx(X,{className:n.icon}),IconButtonProps:{size:"small"},children:y?v("searchType.accordion.collapse"):b.filter(a=>a.value===V)[0].name}),r.jsx(G,{classes:{root:n.accordionDetails},children:r.jsx(K,{className:n.list,component:"nav","aria-label":"filter by type",disablePadding:!0,dense:!0,children:b.map(a=>r.jsxs(p.Fragment,{children:[r.jsx(Y,{}),r.jsxs(Z,{selected:i[0]===a.value||i.length===0&&a.value==="",onClick:L(a.value),button:!0,children:[r.jsx(ee,{children:p.cloneElement(a.icon,{className:n.listItemIcon})}),r.jsx(k,{primary:a.name,secondary:C&&C[a.value]})]})]},a.value))})})]})]})};E.__docgenInfo={description:"",methods:[],displayName:"SearchTypeAccordion",props:{name:{required:!0,tsType:{name:"string"},description:""},types:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  value: string;
  name: string;
  icon: JSX.Element;
