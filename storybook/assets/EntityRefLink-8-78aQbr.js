import{r as a,j as i}from"./iframe-C-coJuUP.js";import{e as y,a as f}from"./routes-CP3_grjx.js";import{u as m}from"./useRouteRef-CNiCqjpw.js";import{E as g}from"./EntityDisplayName-CL3drhwF.js";import{L as b}from"./Link-BAqVydJ4.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(g,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(b,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=m(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
