...
`,...h.input.parameters?.docs?.source}}};v.input.parameters={...v.input.parameters,docs:{...v.input.parameters?.docs,source:{code:`const WithTextTruncate = () => (
...
`,...v.input.parameters?.docs?.source}}};F.input.parameters={...F.input.parameters,docs:{...F.input.parameters?.docs,source:{code:`const Backgrounds = () => (
...
`,...F.input.parameters?.docs?.source}}};B.input.parameters={...B.input.parameters,docs:{...B.input.parameters?.docs,source:{code:`const BgNeutral = () => (
...
})`,...B.input.parameters?.docs?.source}}};const C=["Default","ColumnDirection","RowDirection","AlignStartInColumn","AlignStartInRow","AlignCenterInColumn","AlignCenterInRow","AlignEndInColumn","AlignEndInRow","ResponsiveAlign","ResponsiveGap","LargeGap","WithTextTruncate","Backgrounds","BgNeutral"];export{l as AlignCenterInColumn,x as AlignCenterInRow,u as AlignEndInColumn,d as AlignEndInRow,c as AlignStartInColumn,p as AlignStartInRow,F as Backgrounds,B as BgNeutral,o as ColumnDirection,s as Default,h as LargeGap,g as ResponsiveAlign,m as ResponsiveGap,i as RowDirection,v as WithTextTruncate,C as __namedExportsOrder};
