import{ca as b,bR as e,cS as f,cU as x,bX as R,w as g,X as j,W as L}from"./iframe-Bfeun6FV.js";import{H as v}from"./Helmet-DHFJ6bGn.js";import{L as E}from"./Link-Ck5B18Ox.js";import{H as w}from"./HeaderTabs-t3uHRyNG.js";import{C as P}from"./Content-BsR53Uxk.js";import{a as S}from"./componentData-CeN5KGeH.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bj4M52Zv.js";import"./lodash-BgRn0AvU.js";import"./useAnalytics-BM8yTVVe.js";import"./makeStyles-C7fNhz2-.js";import"./useApp-CxJ04SgY.js";import"./Box-VVBVNoPf.js";import"./styled-tsuVmXB5.js";import"./Tabs-Bct_Wlod.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-Djqflu0_.js";function _(t){const a=f(),s=t.map(({path:r,children:m})=>({caseSensitive:!1,path:`${r}/*`,element:m})).sort((r,m)=>m.path.replace(/\/\*$/,"").localeCompare(r.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let n=a["*"]??"";n.startsWith("/")||(n=`/${n}`);const[i]=R(s,n)??[],p=i?t.findIndex(r=>`${r.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=_(a),n=b.useMemo(()=>a.map(i=>{const{path:p,title:r,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:r,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(w,{tabs:n,selectedIndex:o}),e.jsxs(P,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
