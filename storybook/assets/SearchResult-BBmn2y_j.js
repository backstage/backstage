import{r as l,j as s,F as R,J as f}from"./iframe-CXVefQjv.js";import{u as x}from"./useAsync-RkiDaN6_.js";import{l as y}from"./lodash-DZtYjLW6.js";import{s as g}from"./api-lSfc9dkh.js";import{H as E}from"./DefaultResultListItem-Cyw-sCen.js";import{a as k}from"./Plugin-DANSs6yR.js";import{L as I}from"./ListItem-CB67RL_O.js";import{L}from"./List-S9fButJF.js";import{u as C}from"./useElementFilter-KPSAI9EK.js";import{g as j}from"./componentData-CjALqQ4I.js";import{u as q,A}from"./useAnalytics-Bx4_U39Z.js";import{s as T}from"./translation-D2g4ex6U.js";import{u as w}from"./SearchContext-sbUMKdwl.js";import{E as _}from"./EmptyState-Dh56jIwZ.js";import{P as N}from"./Progress-DiPsxWjh.js";import{R as P}from"./ResponseErrorPanel-BnmmaTTP.js";const m="search.results.list.items.extensions.v1",b=(n,t)=>{for(const e of n)if(!(!l.isValidElement(e)||!j(e,m)?.(t)))return l.cloneElement(e,{rank:t.rank,highlight:t.highlight,result:t.document,...e.props});return null},p=n=>{const{rank:t,result:e,noTrack:r,children:a,alignItems:o="flex-start",...u}=n,i=q(),c=l.useCallback(()=>{r||e&&i.captureEvent("discover",e.title,{attributes:{to:e.location},value:t})},[t,e,r,i]);return s.jsx(I,{divider:!0,alignItems:o,onClickCapture:c,...u,children:a})},te=n=>{const{name:t,component:e,predicate:r=()=>!0}=n;return k({name:t,component:{lazy:()=>e().then(a=>(o=>s.jsx(p,{rank:o.rank,result:o.result,noTrack:o.noTrack,children:l.createElement(a,o)})))},data:{[m]:r}})},D=n=>{const t=C(n,e=>e.selectByComponentData({key:m}).getElements(),[n]);return l.useCallback((e,r)=>{const a=b(t,e);return s.jsx(l.Fragment,{children:a??s.jsx(p,{rank:e.rank,result:e.document,children:s.jsx(E,{rank:e.rank,highlight:e.highlight,result:e.document})})},r)},[t])},h=n=>{const{results:t,children:e,...r}=n,a=D(e);return s.jsx(L,{...r,children:t.map(a)})};p.__docgenInfo={description:`@internal
