...
@internal`,methods:[],displayName:"DatePickerCalendar"};const n=_.forwardRef((r,a)=>{const{ownProps:i,restProps:s,dataAttributes:o}=P(te,r),{classes:B,label:g,description:L,secondaryLabel:W}=i,j=s["aria-label"],v=s["aria-labelledby"];_.useEffect(()=>{!g&&!j&&!v&&console.warn("DatePicker requires either a visible label, aria-label, or aria-labelledby for accessibility")},[g,j,v]);const z=W||(s.isRequired?"Required":null);return e.jsxs(A,{className:B.root,...o,...s,ref:a,children:[e.jsx(K,{label:g,secondaryLabel:z,description:L,descriptionSlot:"description"}),e.jsx(w,{dataSize:o["data-size"]}),e.jsx(Q,{}),e.jsx(X,{hideArrow:!0,children:e.jsx(S,{})})]})});n.displayName="DatePicker";n.__docgenInfo={description:`A date picker that combines a date field and a calendar popover, allowing
