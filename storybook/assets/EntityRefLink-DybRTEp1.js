import{r as a,j as i}from"./iframe-DsSIhbnH.js";import{e as y,a as f}from"./routes-eg_BSCqT.js";import{u as m}from"./useRouteRef-0S-UT0UD.js";import{E as g}from"./EntityDisplayName-B4PkmTxG.js";import{L as b}from"./Link-eFTMg8Ng.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...p}=e,c=v(),u=l??o??i.jsx(g,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(b,{...p,ref:t,to:c(e.entityRef),children:u})});function v(){const e=m(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
