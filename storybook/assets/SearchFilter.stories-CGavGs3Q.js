import{r as j,j as a,J as Q,Z as X,P}from"./iframe-ByRYLFwj.js";import{s as Y,M as ee}from"./api-DGSwQaMr.js";import{l as ne}from"./lodash-CEZ35LHP.js";import{a as ae}from"./useAsync-BjbxvGBi.js";import{u as te}from"./useDebounce-CmT05tqH.js";import{u as _,S as re}from"./SearchContext-Cju87um5.js";import{A as se}from"./Autocomplete-CODiAOo1.js";import{C as le}from"./Chip-Dv3uOSNA.js";import{T as ie}from"./TextField-BIqLUFsX.js";import{s as ue}from"./translation-Ck355kxs.js";import{m as oe}from"./makeStyles-CUs-1deS.js";import{a as G,F as ce}from"./FormLabel-Bt4QMASw.js";import{F as me}from"./FormControlLabel-DwFbR4GA.js";import{C as pe}from"./Checkbox-oKImd3gz.js";import{S as de}from"./Select-CUj3K79s.js";import{S as B}from"./Grid-BWBQHPmq.js";import"./preload-helper-PPVm8Dsz.js";import"./useMountedState-0bFYrJyB.js";import"./useAnalytics-vZwzvm-y.js";import"./Popper-BHEEGTZh.js";import"./Portal-BZPqZUv7.js";import"./ListSubheader-CmV0wcLs.js";import"./Select-BJ4nCTvu.js";import"./index-B9sM2jn7.js";import"./Popover-DlGIOhka.js";import"./Modal-CBQ1InMz.js";import"./List-D9mAo6Wj.js";import"./ListContext-Dqofe_r2.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-BkI8melA.js";import"./InputLabel-oFTgcpXS.js";import"./SwitchBase-CH87uAvf.js";import"./Cancel-DhTUCzvo.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-D8ylNFTF.js";import"./styled-ASiGQwJu.js";import"./MenuItem-DblLrG1L.js";import"./ListItem-CRQYiEBH.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ve(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let W;const ge=new Uint8Array(16);function fe(){if(!W){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");W=crypto.getRandomValues.bind(crypto)}return W(ge)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ve(t)}function x(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>x(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=j.useRef({}),u=j.useCallback(async o=>(await e?.(o))?.map(S=>x(S))||[],[e]),[q,p]=ae(u,[n],{loading:!0});if(te(()=>{r.current[n]===void 0&&(r.current[n]=p(n).then(o=>(r.current[n]=o,o)))},t,[p,n]),l.length)return{loading:!1,value:l};const F=r.current[n];return Array.isArray(F)?{loading:!1,value:F}:q},O=(e,n)=>{const{setFilters:l}=_();j.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:q,filterSelectedOptions:p,limitTags:F,multiple:o}=e,[S,D]=j.useState("");O(t,l);const V=typeof r=="function"?r:void 0,T=typeof r=="function"?void 0:r?.map(m=>x(m)),{value:C,loading:c}=L(V,S,T,u),{filters:d,setFilters:I}=_(),v=x(d[t]),E=j.useMemo(()=>v||(o?[]:null),[v,o]),M=(m,k)=>{I(R=>{const{[t]:U,...$}=R;return k?{...$,[t]:Array.isArray(k)?k.map(K=>K.value):k.value}:{...$}})},A=m=>a.jsx(ie,{...m,name:"search",variant:"outlined",label:q,fullWidth:!0}),N=(m,k)=>m.map((R,U)=>a.jsx(le,{label:R.label,color:"primary",...k({index:U})}));return a.jsx(se,{filterSelectedOptions:p,limitTags:F,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:C||[],loading:c,value:E,onChange:M,onInputChange:(m,k)=>D(k),getOptionLabel:m=>m.label,renderInput:A,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
...
Defaults to 250ms.`},filterSelectedOptions:{required:!1,tsType:{name:"boolean"},description:""},limitTags:{required:!1,tsType:{name:"number"},description:""},multiple:{required:!1,tsType:{name:"boolean"},description:""}}};const he=oe({label:{textTransform:"capitalize"},checkboxWrapper:{display:"flex",alignItems:"center",width:"100%"},textWrapper:{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}),J=e=>{const{className:n,defaultValue:l,label:t,name:r,values:u=[],valuesDebounceMs:q}=e,p=he(),{filters:F,setFilters:o}=_();O(r,l);const S=typeof u=="function"?u:void 0,D=typeof u=="function"?void 0:u.map(c=>x(c)),{value:V=[],loading:T}=L(S,"",D,q),C=c=>{const{target:{value:d,checked:I}}=c;o(v=>{const{[r]:E,...M}=v,A=(E||[]).filter(m=>m!==d),N=I?[...A,d]:A;return N.length?{...M,[r]:N}:M})};return a.jsxs(G,{className:n,disabled:T,fullWidth:!0,"data-testid":"search-checkboxfilter-next",children:[!!t&&a.jsx(ce,{className:p.label,children:t}),V.map(({value:c,label:d})=>a.jsx(me,{classes:{root:p.checkboxWrapper,label:p.textWrapper},label:d,control:a.jsx(pe,{color:"primary",inputProps:{"aria-labelledby":d},value:c,name:d,onChange:C,checked:(F[r]??[]).includes(c)})},c))]})},Z=e=>{const{className:n,defaultValue:l,label:t,name:r,values:u,valuesDebounceMs:q}=e,{t:p}=Q(ue);O(r,l);const F=typeof u=="function"?u:void 0,o=typeof u=="function"?void 0:u?.map(v=>x(v)),{value:S=[],loading:D}=L(F,"",o,q),V=j.useRef(be()),T={value:V.current,label:p("searchFilter.allOptionTitle")},{filters:C,setFilters:c}=_(),d=v=>{c(E=>{const{[r]:M,...A}=E;return v!==V.current?{...A,[r]:v}:A})},I=[T,...S];return a.jsx(G,{disabled:D,className:n,variant:"filled",fullWidth:!0,"data-testid":"search-selectfilter-next",children:a.jsx(de,{label:t??ne.capitalize(r),selected:C[r]||V.current,onChange:d,items:I})})},i=e=>{const{component:n,...l}=e;return a.jsx(n,{...l})};i.Checkbox=e=>a.jsx(i,{...e,component:J});i.Select=e=>a.jsx(i,{...e,component:Z});i.Autocomplete=e=>a.jsx(i,{...e,component:H});J.__docgenInfo={description:"@public",methods:[],displayName:"CheckboxFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
of values to be used in the filter. In the autocomplete filter, the last
input value is provided as an input to allow values to be filtered. This
function is debounced and values cached.`},defaultValue:{required:!1,tsType:{name:"union",raw:"string[] | string | null",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"string"},{name:"null"}]},description:""},valuesDebounceMs:{required:!1,tsType:{name:"number"},description:`Debounce time in milliseconds, used when values is an async callback.
Defaults to 250ms.`}}};Z.__docgenInfo={description:"@public",methods:[],displayName:"SelectFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
of values to be used in the filter. In the autocomplete filter, the last
input value is provided as an input to allow values to be filtered. This
function is debounced and values cached.`},defaultValue:{required:!1,tsType:{name:"union",raw:"string[] | string | null",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"string"},{name:"null"}]},description:""},valuesDebounceMs:{required:!1,tsType:{name:"number"},description:`Debounce time in milliseconds, used when values is an async callback.
...
input value is provided as an input to allow values to be filtered. This
function is debounced and values cached.`},{key:"defaultValue",value:{name:"union",raw:"string[] | string | null",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"string"},{name:"null"}],required:!1}},{key:"valuesDebounceMs",value:{name:"number",required:!1},description:`Debounce time in milliseconds, used when values is an async callback.
Defaults to 250ms.`}]}},name:"props"}],return:{name:"ReactElement"}}},description:""},debug:{required:!1,tsType:{name:"boolean"},description:""}}};const sn={title:"Plugins/Search/SearchFilter",component:i,decorators:[e=>a.jsx(X,{apis:[[Y,new ee]],children:a.jsx(re,{children:a.jsx(B,{container:!0,direction:"row",children:a.jsx(B,{item:!0,xs:4,children:a.jsx(e,{})})})})})],tags:["!manifest"]},g=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Checkbox,{name:"Search Checkbox Filter",values:["value1","value2"]})}),f=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Select,{label:"Search Select Filter",name:"select_filter",values:["value1","value2"]})}),y=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Select,{label:"Asynchronous Values",name:"async_values",values:async()=>(await(await fetch("https://swapi.dev/api/planets")).json()).results.map(l=>l.name)})}),b=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Autocomplete,{name:"autocomplete",label:"Single-Select Autocomplete Filter",values:["value1","value2"]})}),h=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Autocomplete,{multiple:!0,name:"autocomplete",label:"Multi-Select Autocomplete Filter",values:["value1","value2"]})}),w=()=>a.jsx(P,{style:{padding:10},children:a.jsx(i.Autocomplete,{multiple:!0,name:"starwarsPerson",label:"Starwars Character",values:async e=>e===""?[]:(await(await fetch(`https://swapi.dev/api/people?search=${encodeURIComponent(e)}`)).json()).results.map(t=>t.name)})});g.__docgenInfo={description:"",methods:[],displayName:"CheckBoxFilter"};f.__docgenInfo={description:"",methods:[],displayName:"SelectFilter"};y.__docgenInfo={description:"",methods:[],displayName:"AsyncSelectFilter"};b.__docgenInfo={description:"",methods:[],displayName:"Autocomplete"};h.__docgenInfo={description:"",methods:[],displayName:"MultiSelectAutocomplete"};w.__docgenInfo={description:"",methods:[],displayName:"AsyncMultiSelectAutocomplete"};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{code:`const CheckBoxFilter = () => {
  return (
