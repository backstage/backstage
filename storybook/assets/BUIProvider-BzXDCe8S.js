import{r as i,c as u,j as t,b as o,u as c,d as p,e as m}from"./iframe-DgHKkkyr.js";import{a as l}from"./openLink-iVgFRcvl.js";function b(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(d,{children:r}):r}function d({children:n}){const e=p();return t.jsx(l,{navigate:e,useHref:m,children:n})}b.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
