import{ap as M,ca as f,ak as A,cV as E,bR as r,aa as O}from"./iframe-t54gLFa0.js";import{_ as j}from"./objectSpread2-D5rBZ329.js";import{c as R}from"./index-DX7uUS-A.js";import{d as V,u as H,g as $}from"./Gauge-DzaB7Lbc.js";import{T as z}from"./Tooltip-CbljDWBy.js";import"./preload-helper-PPVm8Dsz.js";import"./Box-CMT-4mK8.js";import"./styled-CbrhIpjk.js";import"./makeStyles-DQwCtVrG.js";import"./Popper-C582Ee7M.js";import"./Portal-Bh1zuHZS.js";var F=["className","percent","prefixCls","strokeColor","strokeLinecap","strokeWidth","style","trailColor","trailWidth","transition"],J=function(c){var e=j(j({},V),c),k=e.className,o=e.percent,n=e.prefixCls,i=e.strokeColor,t=e.strokeLinecap,a=e.strokeWidth,S=e.style,P=e.trailColor,B=e.trailWidth,L=e.transition,q=M(e,F);delete q.gapPosition;var T=Array.isArray(o)?o:[o],v=Array.isArray(i)?i:[i],_=H(),y=a/2,N=100-a/2,x="M ".concat(t==="round"?y:0,",").concat(y,`
         L `).concat(t==="round"?N:100,",").concat(y),W="0 0 100 ".concat(a),w=0;return f.createElement("svg",A({className:R("".concat(n,"-line"),k),viewBox:W,preserveAspectRatio:"none",style:S},q),f.createElement("path",{className:"".concat(n,"-line-trail"),d:x,strokeLinecap:t,stroke:P,strokeWidth:B||a,fillOpacity:"0"}),T.map(function(C,b){var m=1;switch(t){case"round":m=1-a/100;break;case"square":m=1-a/2/100;break;default:m=1;break}var G={strokeDasharray:"".concat(C*m,"px, 100px"),strokeDashoffset:"-".concat(w,"px"),transition:L||"stroke-dashoffset 0.3s ease 0s, stroke-dasharray .3s ease 0s, stroke 0.3s linear"},D=v[b]||v[v.length-1];return w+=C,f.createElement("path",{key:b,className:"".concat(n,"-line-path"),d:x,strokeLinecap:t,stroke:D,strokeWidth:a,fillOpacity:"0",ref:function(I){_[b]=I},style:G})}))};function s(h){const{value:c,getColor:e=$,width:k="thick"}=h,{palette:o}=E();if(isNaN(c))return null;let n=Math.round(c*100*100)/100;n>100&&(n=100);const i=k==="thick"?4:1,t=e({palette:o,value:n,inverse:!1,max:100});return r.jsx(z,{title:`${n}%`,children:r.jsx(O,{component:"span",children:r.jsx(J,{percent:n,strokeWidth:i,trailWidth:i,strokeColor:t})})})}s.__docgenInfo={description:"",methods:[],displayName:"LinearGauge",props:{value:{required:!0,tsType:{name:"number"},description:"Progress value between 0.0 - 1.0."},width:{required:!1,tsType:{name:"union",raw:"'thick' | 'thin'",elements:[{name:"literal",value:"'thick'"},{name:"literal",value:"'thin'"}]},description:""},getColor:{required:!1,tsType:{name:"signature",type:"function",raw:"(args: GaugePropsGetColorOptions) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  background?: string;
}`,signature:{properties:[{key:"background",value:{name:"string",required:!1}}]},required:!1}}]}}],required:!0}},{key:"value",value:{name:"number",required:!0}},{key:"inverse",value:{name:"boolean",required:!1}},{key:"max",value:{name:"number",required:!1}}]}},name:"args"}],return:{name:"string"}}},description:""}}};const p={width:300},se={title:"Data Display/LinearGauge",component:s,tags:["!manifest"]},u=()=>r.jsx("div",{style:p,children:r.jsx(s,{value:.8})}),l=()=>r.jsx("div",{style:p,children:r.jsx(s,{value:.5})}),g=()=>r.jsx("div",{style:p,children:r.jsx(s,{value:.2})}),d=()=>r.jsx("div",{style:p,children:r.jsx(s,{getColor:()=>"#f0f",value:.5})});u.__docgenInfo={description:"",methods:[],displayName:"Default"};l.__docgenInfo={description:"",methods:[],displayName:"MediumProgress"};g.__docgenInfo={description:"",methods:[],displayName:"LowProgress"};d.__docgenInfo={description:"",methods:[],displayName:"StaticColor"};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`() => <div style={containerStyle}>
  ...
  </div>`,...d.parameters?.docs?.source}}};const oe=["Default","MediumProgress","LowProgress","StaticColor"];export{u as Default,g as LowProgress,l as MediumProgress,d as StaticColor,oe as __namedExportsOrder,se as default};
