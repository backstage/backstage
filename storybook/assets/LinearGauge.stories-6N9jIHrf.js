import{ao as M,c8 as f,aj as A,cT as E,bQ as r,a9 as O}from"./iframe-DXdR4xPj.js";import{_ as j}from"./objectSpread2-ClKp2zJX.js";import{c as H}from"./index-CvcAu-rV.js";import{d as R,u as V,g as $}from"./Gauge-BS1o1DT8.js";import{T as Q}from"./Tooltip-BlL23rdh.js";import"./preload-helper-PPVm8Dsz.js";import"./Box-BJkHSLqZ.js";import"./styled-CiGmUP6u.js";import"./makeStyles-BSWJde_H.js";import"./Popper-CuTbSqkg.js";import"./Portal-BrV34s_5.js";var z=["className","percent","prefixCls","strokeColor","strokeLinecap","strokeWidth","style","trailColor","trailWidth","transition"],F=function(c){var e=j(j({},R),c),k=e.className,o=e.percent,n=e.prefixCls,i=e.strokeColor,t=e.strokeLinecap,a=e.strokeWidth,S=e.style,P=e.trailColor,T=e.trailWidth,B=e.transition,q=M(e,z);delete q.gapPosition;var L=Array.isArray(o)?o:[o],v=Array.isArray(i)?i:[i],_=V(),y=a/2,N=100-a/2,x="M ".concat(t==="round"?y:0,",").concat(y,`
         L `).concat(t==="round"?N:100,",").concat(y),W="0 0 100 ".concat(a),w=0;return f.createElement("svg",A({className:H("".concat(n,"-line"),k),viewBox:W,preserveAspectRatio:"none",style:S},q),f.createElement("path",{className:"".concat(n,"-line-trail"),d:x,strokeLinecap:t,stroke:P,strokeWidth:T||a,fillOpacity:"0"}),L.map(function(C,b){var m=1;switch(t){case"round":m=1-a/100;break;case"square":m=1-a/2/100;break;default:m=1;break}var G={strokeDasharray:"".concat(C*m,"px, 100px"),strokeDashoffset:"-".concat(w,"px"),transition:B||"stroke-dashoffset 0.3s ease 0s, stroke-dasharray .3s ease 0s, stroke 0.3s linear"},D=v[b]||v[v.length-1];return w+=C,f.createElement("path",{key:b,className:"".concat(n,"-line-path"),d:x,strokeLinecap:t,stroke:D,strokeWidth:a,fillOpacity:"0",ref:function(I){_[b]=I},style:G})}))};function s(h){const{value:c,getColor:e=$,width:k="thick"}=h,{palette:o}=E();if(isNaN(c))return null;let n=Math.round(c*100*100)/100;n>100&&(n=100);const i=k==="thick"?4:1,t=e({palette:o,value:n,inverse:!1,max:100});return r.jsx(Q,{title:`${n}%`,children:r.jsx(O,{component:"span",children:r.jsx(F,{percent:n,strokeWidth:i,trailWidth:i,strokeColor:t})})})}s.__docgenInfo={description:"",methods:[],displayName:"LinearGauge",props:{value:{required:!0,tsType:{name:"number"},description:"Progress value between 0.0 - 1.0."},width:{required:!1,tsType:{name:"union",raw:"'thick' | 'thin'",elements:[{name:"literal",value:"'thick'"},{name:"literal",value:"'thin'"}]},description:""},getColor:{required:!1,tsType:{name:"signature",type:"function",raw:"(args: GaugePropsGetColorOptions) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
