import{j as e}from"./jsx-runtime-hv06LKfz.js";import{r as b}from"./index-D8-PC79C.js";import{H as f}from"./Helmet-DZToxFkW.js";import{L as x}from"./Link-Dz1KAoW-.js";import{H as R}from"./HeaderTabs-BzsphEcu.js";import{C as j}from"./Content-BnBwe0hJ.js";import{e as g,f as L,m as v,M as E,R as P,a as w}from"./index-B7KODvs-.js";import{a as _}from"./componentData-DvKcogcx.js";import"./index-BKN9BsH4.js";import"./index-DlxYA1zJ.js";import"./lodash-D1GzKnrP.js";import"./index-DXvUqTe6.js";import"./index-BITTEREo.js";import"./typeof-ZI2KZN5z.js";import"./createSvgIcon-DoLugWkO.js";import"./capitalize-CaJ9t4LC.js";import"./defaultTheme-HGKtGPzz.js";import"./withStyles-B13qPX67.js";import"./hoist-non-react-statics.cjs-DtcWCWp5.js";import"./createChainedFunction-Da-WpsAN.js";import"./createSvgIcon-CPc4HhrD.js";import"./debounce-DtXjJkxj.js";import"./isMuiElement-DKhW5xVU.js";import"./ownerWindow-CjzjL4wv.js";import"./useIsFocusVisible-BFy7UoKA.js";import"./useControlled-CliGfT3L.js";import"./unstable_useId-DQJte0g1.js";import"./makeStyles-_0rcpTC-.js";import"./Typography-DGbghBbX.js";import"./useApp-BOX1l_wP.js";import"./ApiRef-ByCJBjX1.js";import"./useAnalytics-Q-nz63z2.js";import"./ConfigApi-ij0WO1-Y.js";import"./Box-DggyAouF.js";import"./typography-CPNtfiQW.js";import"./Tabs-2e0RaBWo.js";import"./ButtonBase-BzQRPjNc.js";import"./TransitionGroupContext-CcnbR2YJ.js";import"./index-DnL3XN75.js";import"./useTheme-Cllnm7xZ.js";import"./KeyboardArrowRight-CDcZj0Ct.js";function k(t){const o=g(),s=t.map(({path:n,children:d})=>({caseSensitive:!1,path:`${n}/*`,element:d})).sort((n,d)=>d.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),u=L(s)??t[0]?.children;let a=o["*"]??"";a.startsWith("/")||(a=`/${a}`);const[i]=v(s,a)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:u,route:t[p]??t[0]}}function y(t){const{routes:o}=t,{index:r,route:s,element:u}=k(o),a=b.useMemo(()=>o.map(i=>{const{path:p,title:n,tabProps:d}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:x,to:l,...d}}}),[o]);return e.jsxs(e.Fragment,{children:[e.jsx(R,{tabs:a,selectedIndex:r}),e.jsxs(j,{children:[e.jsx(f,{title:s?.title}),u]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
