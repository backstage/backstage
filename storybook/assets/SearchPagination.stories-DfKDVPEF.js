import{r as d,j as r,F as v,W as R}from"./iframe-ByBrTvma.js";import{s as _,M as N}from"./api-UBCebQ5l.js";import{s as $}from"./translation-DJxPYsGq.js";import{u as j,S as k}from"./SearchContext-xgph2lm8.js";import{T as q}from"./TablePagination-qrePQfPR.js";import{S as b}from"./Grid-CVJ59jxc.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-C3FwuLPO.js";import"./useAsync-Coek-nsh.js";import"./useMountedState-ClRjsrJA.js";import"./useAnalytics-BFlIYKys.js";import"./KeyboardArrowRight-DeYWZjFB.js";import"./MenuItem-C3sEJ41p.js";import"./ListItem-DP4h3WVe.js";import"./ListContext-BWIL9NnA.js";import"./TableCell-C1_L5ICF.js";import"./Select-t9g7PN1b.js";import"./index-B9sM2jn7.js";import"./Popover-PY7eTZ56.js";import"./Modal-CuM9MEfQ.js";import"./Portal-UHK3xnYf.js";import"./List-COw7E98o.js";import"./formControlState-BgLzN1_W.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
...
@public`,methods:[],displayName:"SearchPagination"};const ne={title:"Plugins/Search/SearchPagination",component:u,decorators:[e=>r.jsx(R,{apis:[[_,new N]],children:r.jsx(k,{children:r.jsx(b,{container:!0,direction:"row",children:r.jsx(b,{item:!0,xs:12,children:r.jsx(e,{})})})})})],tags:["!manifest"]},t=()=>r.jsx(u,{}),a=()=>r.jsx(u,{limitLabel:"Rows per page:"}),o=()=>r.jsx(u,{limitText:({from:e,to:s})=>`${e}-${s} of more than ${s}`}),n=()=>r.jsx(u,{limitOptions:[5,10,20]});t.__docgenInfo={description:"",methods:[],displayName:"Default"};a.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitLabel"};o.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitText"};n.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitOptions"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{code:`const Default = () => {
...
`,...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  ...
  return <SearchPagination limitOptions={[5, 10, 20]} />;
}`,...n.parameters?.docs?.source}}};const se=["Default","CustomPageLimitLabel","CustomPageLimitText","CustomPageLimitOptions"];export{a as CustomPageLimitLabel,n as CustomPageLimitOptions,o as CustomPageLimitText,t as Default,se as __namedExportsOrder,ne as default};
