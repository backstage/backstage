import{p as w,j as e,B as D}from"./iframe-C7l5P2_I.js";import{F as t}from"./Flex-CIwB5FXf.js";import{T as y}from"./Text-Dz3C4wne.js";import"./preload-helper-PPVm8Dsz.js";const a=w.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}},args:{children:null}}),r=({width:n="48px",height:j="48px"})=>{const b=(()=>{const f=`
