...
`,...F.input.parameters?.docs?.source}}};o.input.parameters={...o.input.parameters,docs:{...o.input.parameters?.docs,source:{code:`const WithLongNames = () => (
  <Select
    style={{ maxWidth: 400 }}
...
`,...o.input.parameters?.docs?.source}}};C.input.parameters={...C.input.parameters,docs:{...C.input.parameters?.docs,source:{code:`const WithLongNamesAndPadding = () => <Select style={{ width: 300 }} />;
...
})`,...F.input.parameters?.docs?.source}}};o.input.parameters={...o.input.parameters,docs:{...o.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
    label: 'Document Template',
    options: [{
      value: 'annual-report-2024',
...
})`,...A.input.parameters?.docs?.source}}};const we=["Default","Searchable","MultipleSelection","SearchableMultiple","Preview","WithLabel","WithFullWidth","WithLabelAndDescription","WithIcon","Sizes","Required","Disabled","DisabledOption","NoOptions","WithValue","WithDefaultValue","WithManyOptions","WithError","WithLongNames","WithLongNamesAndPadding","WithAccessibilityProps"];export{r as Default,y as Disabled,S as DisabledOption,c as MultipleSelection,f as NoOptions,n as Preview,h as Required,l as Searchable,p as SearchableMultiple,g as Sizes,A as WithAccessibilityProps,v as WithDefaultValue,F as WithError,u as WithFullWidth,m as WithIcon,i as WithLabel,d as WithLabelAndDescription,o as WithLongNames,C as WithLongNamesAndPadding,P as WithManyOptions,b as WithValue,we as __namedExportsOrder};
