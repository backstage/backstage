import{p,j as e}from"./iframe-Bfb6es7h.js";import{A as r}from"./Avatar-CAh9UDtf.js";import{F as s}from"./Flex-DHaeApjT.js";import{T as c}from"./Text-GGZB_8fk.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./useStyles-CpB2eiax.js";import"./useSurface-CSjLNTJM.js";const l=p.meta({title:"Backstage UI/Avatar",component:r}),n=l.story({args:{src:"https://avatars.githubusercontent.com/u/1540635?v=4",name:"Charles de Dreuille"}}),t=l.story({args:{...n.input.args,src:"https://avatars.githubusercontent.com/u/15406AAAAAAAAA"}}),i=l.story({args:{...n.input.args},render:a=>e.jsxs(s,{direction:"column",gap:"6",children:[e.jsxs(s,{children:[e.jsx(r,{...a,size:"x-small"}),e.jsx(r,{...a,size:"small"}),e.jsx(r,{...a,size:"medium"}),e.jsx(r,{...a,size:"large"}),e.jsx(r,{...a,size:"x-large"})]}),e.jsxs(s,{children:[e.jsx(r,{...a,size:"x-small",src:""}),e.jsx(r,{...a,size:"small",src:""}),e.jsx(r,{...a,size:"medium",src:""}),e.jsx(r,{...a,size:"large",src:""}),e.jsx(r,{...a,size:"x-large",src:""})]})]})}),o=l.story({args:{...n.input.args},render:a=>e.jsxs(s,{direction:"column",gap:"4",children:[e.jsxs(s,{direction:"column",gap:"1",children:[e.jsx(c,{variant:"title-x-small",children:"Informative (default)"}),e.jsxs(c,{variant:"body-medium",children:['Use when avatar appears alone. Announced as "',a.name,'" to screen readers:']}),e.jsx(s,{gap:"2",align:"center",children:e.jsx(r,{...a,purpose:"informative"})})]}),e.jsxs(s,{direction:"column",gap:"1",children:[e.jsx(c,{variant:"title-x-small",children:"Decoration"}),e.jsx(c,{variant:"body-medium",children:"Use when name appears adjacent to avatar. Hidden from screen readers to avoid redundancy:"}),e.jsxs(s,{gap:"2",align:"center",children:[e.jsx(r,{...a,purpose:"decoration"}),e.jsx(c,{children:a.name})]})]})]})});n.input.parameters={...n.input.parameters,docs:{...n.input.parameters?.docs,source:{code:`const Default = () => (
  <Avatar
