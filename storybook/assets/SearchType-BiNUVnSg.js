import{r as p,aF as F,aG as J,aH as M,aI as P,V as z,J as W,F as T,j as r,c as X}from"./iframe-Bakz1Oty.js";import{E as H}from"./ExpandMore-Br5OM40x.js";import{u as O}from"./useAsync-mZK1n-rv.js";import{s as q}from"./translation-3YvzsgkK.js";import{m as j}from"./makeStyles-3_kuKRiN.js";import{u as A}from"./SearchContext-ZyqUKz7h.js";import{s as B}from"./api-CCTktZIe.js";import{B as U}from"./Box-BnRbKBR1.js";import{A as $,a as G,b as K}from"./AccordionDetails-C_Yniy8T.js";import{L as Q}from"./List-B_gy8x3o.js";import{D as Y}from"./Divider-7y2QWIg8.js";import{L as Z}from"./ListItem-CDsyXI4L.js";import{L as ee}from"./ListItemIcon-CWyjocyZ.js";import{L as k}from"./ListItemText-G1PMliPa.js";import{T as re,a as ae}from"./Tabs-BLAVSiJ6.js";import{a as se}from"./FormLabel-WJcegaCB.js";import{I as ne}from"./InputLabel-Dkloidq5.js";import{S as te}from"./Select-BYPaq-r0.js";import{M as ie}from"./MenuItem-CWxx6An5.js";import{C as oe}from"./Checkbox-CmIWBWtU.js";import{C as le}from"./Chip-BaH2q5SC.js";var ce=function(e){p.useEffect(e,[])},h={},C;function ue(){if(C)return h;C=1;var e=F(),n=J();Object.defineProperty(h,"__esModule",{value:!0}),h.default=void 0;var t=n(M()),u=e(P()),l=(0,u.default)(t.createElement("path",{d:"M9.93 13.5h4.14L12 7.98zM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-4.05 16.5l-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09z"}),"FontDownload");return h.default=l,h}var pe=ue();const me=z(pe),de=j(e=>({icon:{color:e.palette.text.primary},list:{width:"100%"},listItemIcon:{width:"24px",height:"24px"},accordion:{backgroundColor:e.palette.background.paper},accordionSummary:{minHeight:"auto","&.Mui-expanded":{minHeight:"auto"}},accordionSummaryContent:{margin:e.spacing(2,0),"&.Mui-expanded":{margin:e.spacing(2,0)}},accordionDetails:{padding:e.spacing(0,0,1)}})),E=e=>{const n=de(),{filters:t,setPageCursor:u,setTypes:l,term:c,types:i}=A(),m=W(B),[y,f]=p.useState(!0),{defaultValue:s,name:o,showCounts:w,types:N}=e,{t:v}=T(q),g=p.useRef(null),V=()=>f(a=>!a),D=a=>()=>{l(a!==""?[a]:[]),u(void 0)};p.useEffect(()=>{s&&l([s])},[]);const b=[{value:"",name:v("searchType.accordion.allTitle"),icon:r.jsx(me,{})},...N],_=i[0]||"",{value:I}=O(async()=>{if(!w)return{};g.current&&g.current.abort();const a=new AbortController;g.current=a;const L=await Promise.all(b.map(d=>d.value).map(async d=>{const{numberOfResults:x}=await m.query({term:c,types:d?[d]:[],filters:i.includes(d)||!i.length&&!d?t:{},pageLimit:0},{signal:a.signal});return[d,x!==void 0?v("searchType.accordion.numberOfResults",{number:x>=1e4?">10000":`${x}`}):" -- "]}));return Object.fromEntries(L)},[t,w,c,i]);return p.useEffect(()=>()=>{g.current&&g.current.abort()},[]),r.jsxs(U,{children:[r.jsx(X,{variant:"body2",component:"h2",children:o}),r.jsxs($,{className:n.accordion,expanded:y,onChange:V,children:[r.jsx(G,{classes:{root:n.accordionSummary,content:n.accordionSummaryContent},expandIcon:r.jsx(H,{className:n.icon}),IconButtonProps:{size:"small"},children:y?v("searchType.accordion.collapse"):b.filter(a=>a.value===_)[0].name}),r.jsx(K,{classes:{root:n.accordionDetails},children:r.jsx(Q,{className:n.list,component:"nav","aria-label":"filter by type",disablePadding:!0,dense:!0,children:b.map(a=>r.jsxs(p.Fragment,{children:[r.jsx(Y,{}),r.jsxs(Z,{selected:i[0]===a.value||i.length===0&&a.value==="",onClick:D(a.value),button:!0,children:[r.jsx(ee,{children:p.cloneElement(a.icon,{className:n.listItemIcon})}),r.jsx(k,{primary:a.name,secondary:I&&I[a.value]})]})]},a.value))})})]})]})};E.__docgenInfo={description:"",methods:[],displayName:"SearchTypeAccordion",props:{name:{required:!0,tsType:{name:"string"},description:""},types:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  value: string;
  name: string;
  icon: JSX.Element;
