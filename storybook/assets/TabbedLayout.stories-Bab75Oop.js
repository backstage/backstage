import{c8 as b,bQ as e,cP as f,cR as x,bV as R,w as g,W as j,V as L}from"./iframe-DgMUslzK.js";import{H as v}from"./Helmet-BVszWply.js";import{L as E}from"./Link-COy2ek7E.js";import{H as P}from"./HeaderTabs-BKsUePEz.js";import{C as w}from"./Content-BhgeecPP.js";import{a as _}from"./componentData-Nl-aHIr2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CvMNCDS_.js";import"./lodash-C5szjeEy.js";import"./useAnalytics-BFdM291c.js";import"./makeStyles-Df7PmhVI.js";import"./useApp-KaRpWMSR.js";import"./Box-BJxowxBS.js";import"./styled-BfrhGEg9.js";import"./Tabs-Cd1y7UJW.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-BGQq61xN.js";function k(t){const a=f(),s=t.map(({path:r,children:m})=>({caseSensitive:!1,path:`${r}/*`,element:m})).sort((r,m)=>m.path.replace(/\/\*$/,"").localeCompare(r.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let n=a["*"]??"";n.startsWith("/")||(n=`/${n}`);const[i]=R(s,n)??[],p=i?t.findIndex(r=>`${r.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),n=b.useMemo(()=>a.map(i=>{const{path:p,title:r,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:r,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:n,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
