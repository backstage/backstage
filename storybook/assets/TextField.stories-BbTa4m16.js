import{a5 as F,j as e}from"./iframe-BUNFJ-LL.js";import{T as x}from"./TextField-CeiYCPBv.js";import{$ as h}from"./Form-B5ZwjjvG.js";import{O as b,d as f}from"./index-P0OStF1u.js";import{F as y}from"./Flex-C1W7J0NN.js";import{F as D}from"./FieldLabel-Df9zDs2R.js";import"./preload-helper-PPVm8Dsz.js";import"./Input-DXqxxoib.js";import"./useObjectRef-DN5RhYE4.js";import"./clsx-B-dksMZM.js";import"./useFocusable-BkXFYSM6.js";import"./useFormReset-xWfHrj8A.js";import"./useControlledState-CXUFjkK4.js";import"./useField-Bn17ivoW.js";import"./useLabel-C90qzgWO.js";import"./useLabels-CKQdrhHt.js";import"./utils-BEJ376Lm.js";import"./Hidden-DxYOoLzF.js";import"./useFocusRing-Wt4ACmUe.js";import"./TextField-eXrYq1Bp.js";import"./FieldError-CEk9mRU4.js";import"./Text-D_pOLfa2.js";import"./RSPContexts-B6Hb2-Lc.js";import"./Label-IiqfCh2P.js";import"./useStyles-5S17-Ykh.js";import"./FieldError-CCMSYPi5.js";import"./useSurface-B6sjmuOE.js";const s=F.meta({title:"Backstage UI/TextField",component:x,argTypes:{isRequired:{control:"boolean"},icon:{control:"object"}}}),r=s.story({args:{name:"url",placeholder:"Enter a URL",style:{maxWidth:"300px"}}}),n=s.story({args:{...r.input.args},render:i=>e.jsxs(y,{direction:"row",gap:"4",style:{width:"100%",maxWidth:"600px"},children:[e.jsx(x,{...i,size:"small",icon:e.jsx(b,{})}),e.jsx(x,{...i,size:"medium",icon:e.jsx(b,{})})]})}),o=s.story({args:{...r.input.args,defaultValue:"https://example.com"}}),t=s.story({args:{...r.input.args,label:"Label"}}),p=s.story({args:{...t.input.args,description:"Description"}}),u=s.story({args:{...t.input.args,isRequired:!0}}),c=s.story({args:{...r.input.args,isDisabled:!0}}),a=s.story({args:{...r.input.args},render:i=>e.jsx(x,{...i,placeholder:"Enter a URL",size:"small",icon:e.jsx(f,{})})}),d=a.extend({args:{isDisabled:!0}}),l=s.story({args:{...t.input.args},render:i=>e.jsx(h,{validationErrors:{url:"Invalid URL"},children:e.jsx(x,{...i})})}),m=s.story({args:{...t.input.args,validate:i=>i==="admin"?"Nice try!":null}}),g=s.story({render:()=>e.jsxs(e.Fragment,{children:[e.jsx(D,{htmlFor:"custom-field",id:"custom-field-label",label:"Custom Field"}),e.jsx(x,{id:"custom-field","aria-labelledby":"custom-field-label",name:"custom-field",defaultValue:"Custom Field"})]})});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => (
  <TextField
    name="url"
