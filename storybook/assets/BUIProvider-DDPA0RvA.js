import{ca as i,b6 as u,bR as t,B as o,cN as c,cQ as p}from"./iframe-BoHeIN98.js";import{i as m}from"./openLink-CzGsEk9E.js";import{u as l}from"./useResolvedHref-D2CCdNlh.js";function d(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(g,{children:r}):r}function g({children:n}){const e=p();return t.jsx(m,{navigate:e,useHref:l,children:n})}d.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
