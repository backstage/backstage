import{r as d,j as r,F as v,W as R}from"./iframe-BJyhMgZx.js";import{s as _,M as N}from"./api-Cdm69iM_.js";import{s as $}from"./translation-DakUQ2Gq.js";import{u as j,S as k}from"./SearchContext-C7gGdmvg.js";import{T as q}from"./TablePagination-DKkHYwzn.js";import{S as b}from"./Grid-Ce4w6y7_.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-Owt1XfFv.js";import"./useAsync-Bw-fkNAq.js";import"./useMountedState-Cu_WIlx5.js";import"./useAnalytics-D5KbbwDD.js";import"./KeyboardArrowRight-dg1ZX07j.js";import"./MenuItem-D3sl4950.js";import"./ListItem-C9MlxCoa.js";import"./ListContext-wap519Wf.js";import"./TableCell-As0uLIEz.js";import"./Select-C14uzBLV.js";import"./index-B9sM2jn7.js";import"./Popover-BMSZCUIK.js";import"./Modal-CpRiOHte.js";import"./Portal-Bs15JVl2.js";import"./List-BFZ4Qrp4.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-Dkq16rYo.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v($),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=j(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
