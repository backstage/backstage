import{a5 as S,j as e}from"./iframe-BOihsBca.js";import{F as t}from"./Flex-D6bo-iZf.js";import{B as w}from"./Box-BnC-gZVB.js";import{T as y}from"./Text-C-EByDqT.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./useStyles-Dh4ECtHz.js";import"./useSurface-CjYluiVK.js";const a=S.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),n=({width:r="48px",height:D="48px"})=>{const B=(()=>{const j=`
...
})`,...F.input.parameters?.docs?.source}}};const E=["Default","ColumnDirection","RowDirection","AlignStartInColumn","AlignStartInRow","AlignCenterInColumn","AlignCenterInRow","AlignEndInColumn","AlignEndInRow","ResponsiveAlign","ResponsiveGap","LargeGap","WithTextTruncate","Surfaces","SurfacesAutoIncrement"];export{u as AlignCenterInColumn,x as AlignCenterInRow,l as AlignEndInColumn,d as AlignEndInRow,c as AlignStartInColumn,p as AlignStartInRow,o as ColumnDirection,s as Default,h as LargeGap,m as ResponsiveAlign,g as ResponsiveGap,i as RowDirection,v as Surfaces,F as SurfacesAutoIncrement,f as WithTextTruncate,E as __namedExportsOrder};
