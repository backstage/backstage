import{j as e}from"./jsx-runtime-CvpxdxdE.js";import{r as b}from"./index-DSHF18-l.js";import{H as j}from"./Helmet-tbVgYmZi.js";import{L as g}from"./Link-DO9CKV3x.js";import{H as L}from"./HeaderTabs-C25wZRCD.js";import{C as v}from"./Content-l4fjZyc6.js";import{e as E,f as P,m as w,M as _,R as k,a as C}from"./index-CEhUYg2U.js";import{a as S}from"./componentData-CNQluCuE.js";import"./index-B0bGgVUV.js";import"./index-jB8bSz_h.js";import"./lodash-D8aMxhkM.js";import"./index-DBvFAGNd.js";import"./typeof-jYoadTod.js";import"./createSvgIcon-5qk-fEpi.js";import"./capitalize-CAo0_JGt.js";import"./defaultTheme-cHLKSkOs.js";import"./withStyles-CiJb2SGb.js";import"./hoist-non-react-statics.cjs-DlMN-SZi.js";import"./createChainedFunction-Da-WpsAN.js";import"./createSvgIcon-QzyO_PdA.js";import"./debounce-DtXjJkxj.js";import"./isMuiElement-fiJl_Gvd.js";import"./ownerWindow-BCxlYCSn.js";import"./useIsFocusVisible-Sgmp0f7s.js";import"./useControlled-i6Pam0ca.js";import"./unstable_useId-BAMTp7ON.js";import"./makeStyles-BIagdtUJ.js";import"./Typography-Bm-N-dvv.js";import"./useAnalytics-BqSe3k6a.js";import"./ApiRef-DDVPwL0h.js";import"./ConfigApi-1QFqvuIK.js";import"./Box-DLjDh1Pd.js";import"./typography-BJdsab0r.js";import"./Tabs-3ffuJmIB.js";import"./ButtonBase-obR2bX8B.js";import"./TransitionGroupContext-BUwkeBv7.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-ChDSp8cY.js";import"./KeyboardArrowRight-BHwAtHFQ.js";function $(t){var c;const o=E(),n=t.map(({path:i,children:r})=>({caseSensitive:!1,path:`${i}/*`,element:r})).sort((i,r)=>r.path.replace(/\/\*$/,"").localeCompare(i.path.replace(/\/\*$/,""))),d=P(n)??((c=t[0])==null?void 0:c.children);let s=o["*"]??"";s.startsWith("/")||(s=`/${s}`);const[p]=w(n,s)??[],m=p?t.findIndex(i=>`${i.path}/*`===p.route.path):0;return{index:m===-1?0:m,element:d,route:t[m]??t[0]}}function x(t){const{routes:o}=t,{index:a,route:n,element:d}=$(o),s=b.useMemo(()=>o.map(p=>{const{path:m,title:c,tabProps:i}=p;let r=m;return r=r.replace(/\/\*$/,""),r=r.replace(/^\//,""),{id:m,label:c,tabProps:{component:g,to:r,...i}}}),[o]);return e.jsxs(e.Fragment,{children:[e.jsx(L,{tabs:s,selectedIndex:a}),e.jsxs(v,{children:[e.jsx(j,{title:n==null?void 0:n.title}),d]})]})}x.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
