import{r as d,j as r,k as v,T as R}from"./iframe-DEXNC9RX.js";import{s as _,M as k}from"./api-CHBY8DA5.js";import{s as N}from"./translation-BqsLwdAz.js";import{u as $,S as j}from"./SearchContext-CXFPciIw.js";import{T as q}from"./TablePagination-D7Yz-31U.js";import{S as b}from"./Grid-DwntcsAr.js";import"./preload-helper-PPVm8Dsz.js";import"./lodash-Czox7iJy.js";import"./useAsync-BAn5CjI7.js";import"./useMountedState-DIp_Aeij.js";import"./useAnalytics-DzYvNwaC.js";import"./KeyboardArrowRight-DAsAE2yr.js";import"./MenuItem-5cijl-Ac.js";import"./ListItem-BsFeXcoa.js";import"./ListContext-CuQ6sOnh.js";import"./TableCell-DNxfzdg0.js";import"./Select-BneXbUnN.js";import"./index-B9sM2jn7.js";import"./Popover-Deo6ztQs.js";import"./Modal-qxnLeQlM.js";import"./Portal-O6zOHTQ9.js";import"./List-861P7w9f.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-20wdBt-x.js";const O=e=>Buffer.from(e.toString(),"utf-8").toString("base64"),D=e=>e?Number(Buffer.from(e,"base64").toString("utf-8")):0,C=e=>{const{t:s}=v(N),{total:i=-1,cursor:p,hasNextPage:m,onCursorChange:l,limit:h=25,limitLabel:f=s("searchPagination.limitLabel"),limitText:x=({from:g,to:c})=>i>0?s("searchPagination.limitText",{num:`${i}`}):`${g}-${c}`,limitOptions:S,onLimitChange:P,...y}=e,L=d.useMemo(()=>D(p),[p]),T=d.useCallback((g,c)=>{l?.(O(c))},[l]),w=d.useCallback(g=>{const c=g.target.value;P?.(parseInt(c,10))},[P]);return r.jsx(q,{...y,component:"div",count:i,page:L,nextIconButtonProps:{...m!==void 0&&{disabled:!m}},onPageChange:T,rowsPerPage:h,labelRowsPerPage:f,labelDisplayedRows:x,rowsPerPageOptions:S,onRowsPerPageChange:w})},u=e=>{const{pageLimit:s,setPageLimit:i,pageCursor:p,setPageCursor:m,fetchNextPage:l}=$(),h=d.useCallback(f=>{i(f),m(void 0)},[i,m]);return r.jsx(C,{...e,hasNextPage:!!l,limit:s,onLimitChange:h,cursor:p,onCursorChange:m})};C.__docgenInfo={description:`A component with controls for search results pagination.
...
@public`,methods:[],displayName:"SearchPagination"};const se={title:"Plugins/Search/SearchPagination",component:u,decorators:[e=>r.jsx(R,{apis:[[_,new k]],children:r.jsx(j,{children:r.jsx(b,{container:!0,direction:"row",children:r.jsx(b,{item:!0,xs:12,children:r.jsx(e,{})})})})})],tags:["!manifest"]},t=()=>r.jsx(u,{}),a=()=>r.jsx(u,{limitLabel:"Rows per page:"}),o=()=>r.jsx(u,{limitText:({from:e,to:s})=>`${e}-${s} of more than ${s}`}),n=()=>r.jsx(u,{limitOptions:[5,10,20]});t.__docgenInfo={description:"",methods:[],displayName:"Default"};a.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitLabel"};o.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitText"};n.__docgenInfo={description:"",methods:[],displayName:"CustomPageLimitOptions"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{code:`const Default = () => {
