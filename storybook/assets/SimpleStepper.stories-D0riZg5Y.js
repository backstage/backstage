import{r as l,j as e,S as k,U as T,O as N}from"./iframe-C0T-wj8W.js";import{M as E,a as H,S as F,b as P}from"./StepLabel-BkuAlUuI.js";import{B as R}from"./Box-zHlL_yoj.js";import{m as B}from"./makeStyles-DViRTVia.js";import{B as q}from"./Button-mcUBAQqA.js";import{T as L}from"./TextField-BRszISwK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B9sM2jn7.js";import"./Collapse-Jcz9uW_S.js";import"./styled-DP6UPB8s.js";import"./Select-DA_1oRmP.js";import"./Popover-CvJzuGky.js";import"./Modal-u1aPM6tr.js";import"./Portal-ChEPYBl8.js";import"./List-CHzHxHRI.js";import"./ListContext-C3ivO856.js";import"./formControlState-CIdYd_6k.js";import"./FormLabel-DN3onA73.js";import"./InputLabel-DqoSrof4.js";const w=()=>{},_=l.createContext({stepperLength:0,stepIndex:0,setStepIndex:w,stepHistory:[],setStepHistory:w,onStepChange:w});function x(t){const{children:r,elevated:i,onStepChange:a,activeStep:n=0}=t,[p,o]=l.useState(n),h=Array.from({length:n+1},(u,d)=>d),[y,g]=l.useState(h);l.useEffect(()=>{o(n)},[n]);const v=[];let b;return l.Children.forEach(r,u=>{l.isValidElement(u)&&(u.props.end?b=u:v.push(u))}),e.jsxs(e.Fragment,{children:[e.jsx(_.Provider,{value:{stepIndex:p,setStepIndex:o,stepHistory:y,setStepHistory:g,onStepChange:a,stepperLength:l.Children.count(r)},children:e.jsx(E,{activeStep:p,orientation:"vertical",elevation:i?2:0,children:v})}),p>=l.Children.count(r)-1&&b]})}x.__docgenInfo={description:"",methods:[],displayName:"SimpleStepper",props:{elevated:{required:!1,tsType:{name:"boolean"},description:""},onStepChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(prevIndex: number, nextIndex: number) => void",signature:{arguments:[{type:{name:"number"},name:"prevIndex"},{type:{name:"number"},name:"nextIndex"}],return:{name:"void"}}},description:""},activeStep:{required:!1,tsType:{name:"number"},description:""}}};const $=B(t=>({root:{marginTop:t.spacing(3),"& button":{marginRight:t.spacing(1)}}}),{name:"BackstageSimpleStepperFooter"}),O=({text:t,handleClick:r})=>{const{t:i}=k(T);return e.jsx(q,{onClick:r,children:t||i("simpleStepper.reset")})},D=({text:t,handleClick:r,disabled:i,last:a,stepIndex:n})=>{const{t:p}=k(T);return e.jsx(q,{variant:"contained",color:"primary",disabled:i,"data-testid":`nextButton-${n}`,onClick:r,children:t||p(a?"simpleStepper.finish":"simpleStepper.next")})},M=({text:t,handleClick:r,disabled:i,stepIndex:a})=>{const{t:n}=k(T);return e.jsx(q,{variant:"outlined",color:"primary",disabled:i,"data-testid":`skipButton-${a}`,onClick:r,children:t||n("simpleStepper.skip")})},V=({text:t,handleClick:r,disabled:i,stepIndex:a})=>{const{t:n}=k(T);return e.jsx(q,{onClick:r,"data-testid":`backButton-${a}`,disabled:i,children:t||n("simpleStepper.back")})},I=({actions:t={},children:r})=>{const i=$(),{stepperLength:a,stepIndex:n,setStepIndex:p,stepHistory:o,setStepHistory:h,onStepChange:y}=l.useContext(_),g=(d,C)=>{C&&C(),y&&y(n,d),p(d)},v=()=>{const d=t.nextStep?t.nextStep(n,a-1):n+1;g(d,t.onNext),h([...o,d])},b=()=>{o.pop(),g(o[o.length-1],t.onBack),h([...o])},u=()=>{g(0,t.onRestart),h([0])};return e.jsxs(R,{className:i.root,children:[[void 0,!0].includes(t.showBack)&&n!==0&&e.jsx(V,{text:t.backText,handleClick:b,disabled:n===0,stepIndex:n}),t.showSkip&&e.jsx(M,{text:t.skipText,handleClick:v,disabled:!!a&&n>=a||!!t.canSkip&&!t.canSkip(),stepIndex:n}),[void 0,!0].includes(t.showNext)&&e.jsx(D,{text:t.nextText,handleClick:v,disabled:!!a&&n>=a||!!t.canNext&&!t.canNext(),stepIndex:n}),t.showRestart&&n!==0&&e.jsx(O,{text:t.restartText,handleClick:u,stepIndex:n}),r]})};O.__docgenInfo={description:"",methods:[],displayName:"RestartBtn",props:{text:{required:!1,tsType:{name:"string"},description:""},handleClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},stepIndex:{required:!0,tsType:{name:"number"},description:""}}};I.__docgenInfo={description:"",methods:[],displayName:"SimpleStepperFooter",props:{actions:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  showNext?: boolean;
  canNext?: () => boolean;
  onNext?: () => void;
