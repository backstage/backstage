import{r as l,j as s,S as R,V as f}from"./iframe-COJz9F1o.js";import{u as x}from"./useAsync-BWf0vs4p.js";import{l as y}from"./lodash-CDGQ6Log.js";import{s as g}from"./api-B1MnOkFf.js";import{a as E}from"./Plugin-Dcj7W-OT.js";import{u as k}from"./useElementFilter-D1K5KrSC.js";import{H as I}from"./DefaultResultListItem-DzPtBygf.js";import{g as L}from"./componentData-C7H14uU8.js";import{u as C,A as j}from"./useAnalytics-K4Yw9kGl.js";import{L as q}from"./ListItem-BeM9N7OL.js";import{L as A}from"./List-DxjCJy_8.js";import{s as T}from"./translation-BzNMvpns.js";import{u as w}from"./SearchContext-CURPT33y.js";import{E as _}from"./EmptyState-B3IkdtEx.js";import{P as N}from"./Progress-fLrZYSfj.js";import{R as P}from"./ResponseErrorPanel-D4hirswD.js";const m="search.results.list.items.extensions.v1",b=(n,t)=>{for(const e of n)if(!(!l.isValidElement(e)||!L(e,m)?.(t)))return l.cloneElement(e,{rank:t.rank,highlight:t.highlight,result:t.document,...e.props});return null},p=n=>{const{rank:t,result:e,noTrack:r,children:a,alignItems:o="flex-start",...u}=n,i=C(),c=l.useCallback(()=>{r||e&&i.captureEvent("discover",e.title,{attributes:{to:e.location},value:t})},[t,e,r,i]);return s.jsx(q,{divider:!0,alignItems:o,onClickCapture:c,...u,children:a})},te=n=>{const{name:t,component:e,predicate:r=()=>!0}=n;return E({name:t,component:{lazy:()=>e().then(a=>(o=>s.jsx(p,{rank:o.rank,result:o.result,noTrack:o.noTrack,children:l.createElement(a,o)})))},data:{[m]:r}})},D=n=>{const t=k(n,e=>e.selectByComponentData({key:m}).getElements(),[n]);return l.useCallback((e,r)=>{const a=b(t,e);return s.jsx(l.Fragment,{children:a??s.jsx(p,{rank:e.rank,result:e.document,children:s.jsx(I,{rank:e.rank,highlight:e.highlight,result:e.document})})},r)},[t])},h=n=>{const{results:t,children:e,...r}=n,a=D(e);return s.jsx(A,{...r,children:t.map(a)})};p.__docgenInfo={description:`@internal
