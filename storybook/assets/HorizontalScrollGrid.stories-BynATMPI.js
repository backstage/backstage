import{r as u,j as s,W as x}from"./iframe-Cm1o1Xbd.js";import{C as w,a as v}from"./ChevronRight-j6_i3mSM.js";import{c as h}from"./index-Dmtd4Pzp.js";import{B as g}from"./Box-H3EEpFmb.js";import{S as L}from"./Grid-Bci0B9zS.js";import{m as j}from"./makeStyles-CgDsK_IC.js";import"./preload-helper-PPVm8Dsz.js";import"./styled-CDaxGVWn.js";const $=e=>{const t=e==="dark"?"16%":"97%";return`
    hsl(0, 0%, ${t}) 0%,
...
@public`,methods:[],displayName:"HorizontalScrollGrid",props:{scrollStep:{required:!1,tsType:{name:"number"},description:""},scrollSpeed:{required:!1,tsType:{name:"number"},description:""},minScrollDistance:{required:!1,tsType:{name:"number"},description:""}}};const E={height:0,padding:150,margin:20},R={width:800,height:400,margin:20},D=[.2,.3,.4,.5,.6,.7,.8,.9,1],W={title:"Layout/HorizontalScrollGrid",component:y,tags:["!manifest"]},d=()=>s.jsx("div",{style:R,children:s.jsx(y,{children:D.map(e=>{const t={backgroundColor:`rgba(0, 185, 151, ${e})`};return s.jsx("div",{style:{...t,...E}},e)})})});d.__docgenInfo={description:"",methods:[],displayName:"Default"};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => <div style={containerStyle}>
  ...
  </div>`,...d.parameters?.docs?.source}}};const F=["Default"];export{d as Default,F as __namedExportsOrder,W as default};
