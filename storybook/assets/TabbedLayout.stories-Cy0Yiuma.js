import{r as b,j as e,aX as f,aY as x,aZ as R,M as g,a4 as j,a5 as L}from"./iframe-BemVm3iW.js";import{H as v}from"./Helmet-Eh489MW1.js";import{L as E}from"./Link-cfxBzomB.js";import{H as P}from"./HeaderTabs-VsH_Sxx3.js";import{C as w}from"./Content-Buq_wrrc.js";import{a as _}from"./componentData-DVJ_rIR1.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B743ax-R.js";import"./lodash-C0pW7aP-.js";import"./useAnalytics-DC6bz4bN.js";import"./makeStyles-C7F85DJE.js";import"./useApp-Cm_EfMWP.js";import"./Box-7KDenMHz.js";import"./styled-C58he6hV.js";import"./Tabs-CgxhS7cT.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-kIco0Bfz.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
