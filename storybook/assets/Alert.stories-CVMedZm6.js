import{ax as I,r as R,u as z,j as e,B as T,p as Y}from"./iframe-Dl5_TB80.js";import{a as O}from"./Button-BREXngrn.js";import{u as U,x as E,y as V,z as L,s as $,T as k}from"./index-P6GXtDIS.js";import{F as a}from"./Flex-Ds4bg_IX.js";import{B as s}from"./Button-CHQUooLY.js";import{T as r}from"./Text-XofFIW7_.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-DGkaMaF3.js";import"./useObjectRef-C7LuogIC.js";import"./Label-CwMshdGF.js";import"./Hidden-1cRpW4wa.js";import"./useGlobalListeners-CtaBTdJV.js";import"./openLink-k3Gx7yeJ.js";import"./useLabel-Bd4C7Sd8.js";import"./useLabels-CIaXcdIT.js";import"./number-CUJHByHy.js";import"./I18nProvider-DdxrthYO.js";import"./useButton-C9NVRh9l.js";import"./usePress-B21q6wEs.js";import"./textSelection-B7ezpFpp.js";import"./useHover-9E6EvIXl.js";const G={"bui-Alert":"_bui-Alert_jhpr2_20","bui-AlertIcon":"_bui-AlertIcon_jhpr2_57","bui-AlertContentWrapper":"_bui-AlertContentWrapper_jhpr2_74","bui-AlertContent":"_bui-AlertContent_jhpr2_74","bui-AlertTitle":"_bui-AlertTitle_jhpr2_94","bui-AlertDescription":"_bui-AlertDescription_jhpr2_99","bui-AlertSpinner":"_bui-AlertSpinner_jhpr2_104","bui-spin":"_bui-spin_jhpr2_1","bui-AlertActions":"_bui-AlertActions_jhpr2_114"},H=I()({styles:G,classNames:{root:"bui-Alert",contentWrapper:"bui-AlertContentWrapper",content:"bui-AlertContent",title:"bui-AlertTitle",description:"bui-AlertDescription",icon:"bui-AlertIcon",spinner:"bui-AlertSpinner",actions:"bui-AlertActions"},propDefs:{status:{dataAttribute:!0,default:"info"},isPending:{dataAttribute:!0},loading:{dataAttribute:!0},icon:{},customActions:{},title:{},description:{},className:{},style:{}},utilityProps:["m","mb","ml","mr","mt","mx","my"]}),n=R.forwardRef((l,F)=>{const{ownProps:_,restProps:q,dataAttributes:D,utilityStyle:S}=z(H,{...l,isPending:l.isPending||l.loading?!0:l.isPending??l.loading}),{classes:i,status:W,icon:u,isPending:N,customActions:b,title:P,description:j,style:C}=_,B=(()=>{if(u===!1)return null;if(R.isValidElement(u))return u;if(u===!0)switch(W){case"success":return e.jsx($,{"aria-hidden":"true"});case"warning":return e.jsx(L,{"aria-hidden":"true"});case"danger":return e.jsx(V,{"aria-hidden":"true"});default:return e.jsx(E,{"aria-hidden":"true"})}return null})();return e.jsxs("div",{className:i.root,ref:F,style:{...C,...S},...D,...q,"data-has-description":j?"true":"false",children:[e.jsxs("div",{className:i.contentWrapper,children:[N?e.jsx("div",{className:i.icon,children:e.jsx(O,{"aria-label":"Loading",isIndeterminate:!0,className:i.spinner,children:e.jsx(U,{"aria-hidden":"true"})})}):B&&e.jsx("div",{className:i.icon,children:B}),e.jsxs("div",{className:i.content,children:[P&&e.jsx("div",{className:i.title,children:P}),j&&e.jsx("div",{className:i.description,children:j})]})]}),b&&e.jsx("div",{className:i.actions,children:b})]})});n.displayName="Alert";n.__docgenInfo={description:`A component for displaying alert messages with different status levels.
...
| string`,elements:[{name:"literal",value:"'0.5'"},{name:"literal",value:"'1'"},{name:"literal",value:"'1.5'"},{name:"literal",value:"'2'"},{name:"literal",value:"'3'"},{name:"literal",value:"'4'"},{name:"literal",value:"'5'"},{name:"literal",value:"'6'"},{name:"literal",value:"'7'"},{name:"literal",value:"'8'"},{name:"literal",value:"'9'"},{name:"literal",value:"'10'"},{name:"literal",value:"'11'"},{name:"literal",value:"'12'"},{name:"literal",value:"'13'"},{name:"literal",value:"'14'"},{name:"string"}]}],raw:"Record<Breakpoint, T>"}],raw:"Partial<Record<Breakpoint, T>>"}]},description:""},status:{required:!1,tsType:{name:"union",raw:"T | Partial<Record<Breakpoint, T>>",elements:[{name:"union",raw:"'info' | 'success' | 'warning' | 'danger'",elements:[{name:"literal",value:"'info'"},{name:"literal",value:"'success'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'danger'"}]},{name:"Partial",elements:[{name:"Record",elements:[{name:"union",raw:"'initial' | 'xs' | 'sm' | 'md' | 'lg' | 'xl'",elements:[{name:"literal",value:"'initial'"},{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"}]},{name:"union",raw:"'info' | 'success' | 'warning' | 'danger'",elements:[{name:"literal",value:"'info'"},{name:"literal",value:"'success'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'danger'"}]}],raw:"Record<Breakpoint, T>"}],raw:"Partial<Record<Breakpoint, T>>"}]},description:""},icon:{required:!1,tsType:{name:"union",raw:"boolean | ReactElement",elements:[{name:"boolean"},{name:"ReactElement"}]},description:""},isPending:{required:!1,tsType:{name:"boolean"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"@deprecated Use `isPending` instead."},customActions:{required:!1,tsType:{name:"ReactNode"},description:""},title:{required:!1,tsType:{name:"ReactNode"},description:""},description:{required:!1,tsType:{name:"ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""}},composes:["Omit"]};const t=Y.meta({title:"Backstage UI/Alert",component:n,argTypes:{status:{control:"select",options:["info","success","warning","danger"]},icon:{control:"boolean"},isPending:{control:"boolean"}}}),m=t.story({args:{title:"This is an alert message",icon:!0}}),c=t.story({args:{title:"This is an alert message"},parameters:{argTypes:{status:{control:!1}}},render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"This is an informational alert with helpful information."}),e.jsx(n,{status:"success",icon:!0,title:"Your changes have been saved successfully."}),e.jsx(n,{status:"warning",icon:!0,title:"This action may have unintended consequences."}),e.jsx(n,{status:"danger",icon:!0,title:"An error occurred while processing your request."})]})}),d=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"New Feature Available",description:"We've added support for custom table columns. Check the documentation to learn more."}),e.jsx(n,{status:"success",icon:!0,title:"Deployment Successful",description:"Your application has been deployed to production. All health checks passed."}),e.jsx(n,{status:"warning",icon:!0,title:"Pending Review",description:"Please review the following items before proceeding with the deployment."}),e.jsx(n,{status:"danger",icon:!0,title:"Authentication Failed",description:"Unable to verify your credentials. Please check your username and password and try again."})]})}),p=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!1,title:"This is an informational alert without an icon."}),e.jsx(n,{status:"success",icon:!1,title:"Your changes have been saved successfully."}),e.jsx(n,{status:"warning",icon:!1,title:"This action may have unintended consequences."}),e.jsx(n,{status:"danger",icon:!1,title:"An error occurred while processing your request."})]})}),v=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:e.jsx(k,{"aria-hidden":"true"}),title:"This alert uses a custom cloud icon instead of the default info icon."}),e.jsx(n,{status:"success",icon:e.jsx(k,{"aria-hidden":"true"}),title:"Custom icons work with any status variant."})]})}),o=t.story({render:l=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"This alert has a dismiss action on the right.",customActions:e.jsx(s,{size:"small",variant:"tertiary",children:"Dismiss"}),...l}),e.jsx(n,{status:"success",icon:!0,title:"Your changes have been saved. Would you like to continue?",customActions:e.jsxs(e.Fragment,{children:[e.jsx(s,{size:"small",variant:"tertiary",children:"Cancel"}),e.jsx(s,{size:"small",variant:"primary",children:"Continue"})]}),...l}),e.jsx(n,{status:"danger",icon:!0,title:"An error occurred while processing your request. Please try again.",customActions:e.jsx(s,{size:"small",variant:"primary",children:"Retry"}),...l})]})}),g=o.extend({args:{description:"This is a description of the alert."}}),h=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(r,{children:"Info"}),e.jsx(n,{status:"info",icon:!0,isPending:!0,title:"Processing your request..."}),e.jsx(r,{children:"Success"}),e.jsx(n,{status:"success",icon:!0,isPending:!0,title:"Saving changes..."}),e.jsx(r,{children:"Warning"}),e.jsx(n,{status:"warning",icon:!0,isPending:!0,title:"Checking for issues..."}),e.jsx(r,{children:"Danger"}),e.jsx(n,{status:"danger",icon:!0,isPending:!0,title:"Attempting recovery..."})]})}),x=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!0,isPending:!0,title:"Processing your request",description:"This may take a few moments. Please do not close this window."}),e.jsx(n,{status:"success",icon:!0,isPending:!0,title:"Deployment in Progress",description:"Your application is being deployed to production. You'll receive a notification when complete."})]})}),f=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"This is a longer alert message that demonstrates how the component handles multiple lines of text. The content will wrap naturally and maintain proper spacing with the icon and any actions. This is useful for providing detailed information to users when necessary."}),e.jsx(n,{status:"warning",icon:!0,title:"This alert combines long content with actions. The actions remain aligned to the right even when the content wraps to multiple lines. This ensures a consistent and predictable layout regardless of content length.",customActions:e.jsx(s,{size:"small",variant:"tertiary",children:"Dismiss"})})]})}),y=t.story({render:()=>e.jsxs(a,{direction:"column",gap:"4",children:[e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(r,{children:"Default"}),e.jsxs(a,{direction:"column",gap:"2",p:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"Alert on default bg"}),e.jsx(n,{status:"success",icon:!0,title:"Alert on default bg"})]})]}),e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(r,{children:"On Neutral 1"}),e.jsxs(a,{direction:"column",gap:"2",bg:"neutral",p:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"Alert on neutral-1"}),e.jsx(n,{status:"success",icon:!0,title:"Alert on neutral-1"})]})]}),e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(r,{children:"On Neutral 2"}),e.jsx(T,{bg:"neutral",children:e.jsxs(a,{direction:"column",gap:"2",bg:"neutral",p:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"Alert on neutral-2"}),e.jsx(n,{status:"success",icon:!0,title:"Alert on neutral-2"})]})})]}),e.jsxs(a,{direction:"column",gap:"4",children:[e.jsx(r,{children:"On Neutral 3"}),e.jsx(T,{bg:"neutral",children:e.jsx(T,{bg:"neutral",children:e.jsxs(a,{direction:"column",gap:"2",bg:"neutral",p:"4",children:[e.jsx(n,{status:"info",icon:!0,title:"Alert on neutral-3"}),e.jsx(n,{status:"success",icon:!0,title:"Alert on neutral-3"})]})})})]})]})}),w=t.story({args:{title:"This alert changes status responsively",icon:!0,status:{initial:"info",sm:"success",md:"warning",lg:"danger"}}}),A=t.story({render:()=>e.jsxs(T,{bg:"neutral",py:"4",children:[e.jsx(n,{status:"success",icon:!0,title:"Alert with custom margin",mb:"4",mx:"4"}),e.jsx(n,{status:"success",icon:!0,title:"Alert with custom margin",mx:"4"})]})});m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  ...
  render: () => <Flex direction="column" gap="4">
      ...
      <Text>Warning</Text>
      <Alert status="warning" icon={true} isPending title="Checking for issues..." />

      <Text>Danger</Text>
      <Alert status="danger" icon={true} isPending title="Attempting recovery..." />
    </Flex>
  ...
  render: () => <Flex direction="column" gap="4">
      <Alert status="info" icon={true} isPending title="Processing your request" description="This may take a few moments. Please do not close this window." />
      <Alert status="success" icon={true} isPending title="Deployment in Progress" description="Your application is being deployed to production. You'll receive a notification when complete." />
    </Flex>
...
})`,...A.input.parameters?.docs?.source}}};const he=["Default","StatusVariants","WithDescription","WithoutIcons","CustomIcon","WithActions","WithActionsAndDescriptions","PendingVariants","PendingWithDescription","LongContent","OnDifferentBackgrounds","Responsive","WithUtilityProps"];export{v as CustomIcon,m as Default,f as LongContent,y as OnDifferentBackgrounds,h as PendingVariants,x as PendingWithDescription,w as Responsive,c as StatusVariants,o as WithActions,g as WithActionsAndDescriptions,d as WithDescription,A as WithUtilityProps,p as WithoutIcons,he as __namedExportsOrder};
