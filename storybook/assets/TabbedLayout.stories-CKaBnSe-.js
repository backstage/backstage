import{r as b,j as e,b3 as f,b4 as x,b5 as R,M as g,a8 as j,a9 as L}from"./iframe-SQ-DrL5X.js";import{H as v}from"./Helmet-gcRDwGkM.js";import{L as E}from"./Link-Bar4EQzr.js";import{H as P}from"./HeaderTabs-ZGvy9INX.js";import{C as w}from"./Content-BGXt3-NA.js";import{a as _}from"./componentData-B92yaxEl.js";import"./preload-helper-PPVm8Dsz.js";import"./index-hXrAf_FH.js";import"./lodash-aVxBzF5u.js";import"./useAnalytics-CVS451d_.js";import"./makeStyles-CcvGO_cU.js";import"./useApp-BSyWMm0o.js";import"./Box-jO9atyci.js";import"./styled-1GO4OxeJ.js";import"./Tabs-tpLhBi8c.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-C-xVj3UG.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(w,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
