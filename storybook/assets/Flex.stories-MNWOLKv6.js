import{p as w,j as e,B as D}from"./iframe-DvAQ9TL9.js";import{F as t}from"./Flex-hLGEDBko.js";import{T as y}from"./Text-COi90-_w.js";import"./preload-helper-PPVm8Dsz.js";const a=w.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}},args:{children:null}}),r=({width:n="48px",height:j="48px"})=>{const b=(()=>{const f=`
      <svg width="6" height="6" viewBox="0 0 6 6" xmlns="http://www.w3.org/2000/svg">
        <g fill="#2563eb" fill-opacity="0.6" fill-rule="evenodd">
          <path d="M5 0h1L0 6V5zM6 5v1H5z"/>
        </g>
      </svg>
    `.trim();return`data:image/svg+xml,${encodeURIComponent(f)}`})();return e.jsx(D,{width:n,height:j,style:{background:"#eaf2fd",borderRadius:"4px",border:"1px solid #2563eb",backgroundImage:`url("${b}")`,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:"bold",color:"#2563eb"},children:null})},s=a.story({args:{children:e.jsxs(e.Fragment,{children:[e.jsx(r,{}),e.jsx(r,{}),e.jsx(r,{})]})}}),o=a.story({args:{...s.input.args,direction:"column"}}),i=a.story({args:{...s.input.args,direction:"row"}}),c=a.story({args:{align:"start",direction:"column"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),p=a.story({args:{align:"start",direction:"row"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),l=a.story({args:{align:"center",direction:"column"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),x=a.story({args:{align:"center",direction:"row"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),u=a.story({args:{align:"end",direction:"column"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),d=a.story({args:{align:"end",direction:"row"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),g=a.story({args:{align:{xs:"start",md:"center",lg:"end"}},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{height:"32px"}),e.jsx(r,{height:"24px"}),e.jsx(r,{height:"48px"})]})}),m=a.story({args:{gap:{xs:"4",md:"8",lg:"12"}},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{}),e.jsx(r,{}),e.jsx(r,{})]})}),h=a.story({args:{gap:"8"},render:n=>e.jsxs(t,{...n,children:[e.jsx(r,{}),e.jsx(r,{}),e.jsx(r,{})]})}),F=a.story({render:()=>e.jsxs(t,{direction:"row",gap:"8",children:[e.jsx(t,{children:e.jsx(y,{truncate:!0,children:"A man looks at a painting in a museum and says, “Brothers and sisters I have none, but that man's father is my father's son.” Who is in the painting?"})}),e.jsx(t,{children:e.jsx(y,{truncate:!0,children:"A man looks at a painting in a museum and says, “Brothers and sisters I have none, but that man's father is my father's son.” Who is in the painting?"})})]})}),v=a.story({args:{px:"6",py:"4"},render:n=>e.jsxs(t,{align:"center",style:{flexWrap:"wrap"},children:[e.jsx(t,{...n,children:"Default"}),e.jsx(t,{bg:"neutral",...n,children:"Neutral (level 1)"}),e.jsx(D,{bg:"neutral",children:e.jsx(t,{bg:"neutral",...n,children:"Neutral (level 2)"})}),e.jsx(D,{bg:"neutral",children:e.jsx(D,{bg:"neutral",children:e.jsx(t,{bg:"neutral",...n,children:"Neutral (level 3)"})})}),e.jsx(t,{bg:"danger",...n,children:"Danger"}),e.jsx(t,{bg:"warning",...n,children:"Warning"}),e.jsx(t,{bg:"success",...n,children:"Success"})]})}),B=a.story({args:{px:"6",py:"4",gap:"4"},render:n=>e.jsxs(t,{direction:"column",children:[e.jsx("div",{style:{maxWidth:"600px",marginBottom:"16px"},children:'Using bg="neutral" on Flex auto-increments from the parent context. The first Flex defaults to neutral-1 (no parent), then each nested Flex increments by one, capping at neutral-3.'}),e.jsxs(t,{...n,bg:"neutral",direction:"column",children:[e.jsx("div",{children:"Neutral 1 (no parent)"}),e.jsxs(t,{...n,bg:"neutral",direction:"column",children:[e.jsx("div",{children:"Neutral 2 (auto-incremented)"}),e.jsx(t,{...n,bg:"neutral",direction:"column",children:e.jsx("div",{children:"Neutral 3 (auto-incremented, capped)"})})]})]})]})});s.input.parameters={...s.input.parameters,docs:{...s.input.parameters?.docs,source:{code:`const Default = () => (
  <Flex>
    (
    <>
      <DecorativeBox />
...
`,...s.input.parameters?.docs?.source}}};o.input.parameters={...o.input.parameters,docs:{...o.input.parameters?.docs,source:{code:`const ColumnDirection = () => <Flex direction="column">{null}</Flex>;
`,...o.input.parameters?.docs?.source}}};i.input.parameters={...i.input.parameters,docs:{...i.input.parameters?.docs,source:{code:`const RowDirection = () => <Flex direction="row">{null}</Flex>;
...
`,...p.input.parameters?.docs?.source}}};l.input.parameters={...l.input.parameters,docs:{...l.input.parameters?.docs,source:{code:`const AlignCenterInColumn = () => (
...
`,...l.input.parameters?.docs?.source}}};x.input.parameters={...x.input.parameters,docs:{...x.input.parameters?.docs,source:{code:`const AlignCenterInRow = () => (
...
`,...x.input.parameters?.docs?.source}}};u.input.parameters={...u.input.parameters,docs:{...u.input.parameters?.docs,source:{code:`const AlignEndInColumn = () => (
...
`,...u.input.parameters?.docs?.source}}};d.input.parameters={...d.input.parameters,docs:{...d.input.parameters?.docs,source:{code:`const AlignEndInRow = () => (
...
`,...v.input.parameters?.docs?.source}}};B.input.parameters={...B.input.parameters,docs:{...B.input.parameters?.docs,source:{code:`const BgNeutral = () => (
  <Flex direction="column">
    ...
    <Flex px="6" py="4" gap="4" bg="neutral" direction="column">
...
})`,...B.input.parameters?.docs?.source}}};const R=["Default","ColumnDirection","RowDirection","AlignStartInColumn","AlignStartInRow","AlignCenterInColumn","AlignCenterInRow","AlignEndInColumn","AlignEndInRow","ResponsiveAlign","ResponsiveGap","LargeGap","WithTextTruncate","Backgrounds","BgNeutral"];export{l as AlignCenterInColumn,x as AlignCenterInRow,u as AlignEndInColumn,d as AlignEndInRow,c as AlignStartInColumn,p as AlignStartInRow,v as Backgrounds,B as BgNeutral,o as ColumnDirection,s as Default,h as LargeGap,g as ResponsiveAlign,m as ResponsiveGap,i as RowDirection,F as WithTextTruncate,R as __namedExportsOrder};
