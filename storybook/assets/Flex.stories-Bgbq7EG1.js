import{p as f,j as e,B as w}from"./iframe-DEPu6gb6.js";import{F as t}from"./Flex-CdazlK5H.js";import{T as D}from"./Text-W_c6r5az.js";import"./preload-helper-PPVm8Dsz.js";import"./useStyles-BApkmOKR.js";const a=f.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}}}),r=({width:n="48px",height:y="48px"})=>{const j=(()=>{const b=`
