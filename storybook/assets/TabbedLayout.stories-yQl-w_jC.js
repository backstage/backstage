import{r as b,j as e,a_ as f,a$ as x,b0 as R,M as g,a7 as j,a8 as L}from"./iframe-BbcE2xlx.js";import{H as v}from"./Helmet-CoOhHLg0.js";import{L as E}from"./Link-IFkxtfSo.js";import{H as P}from"./HeaderTabs-LxLLPAcM.js";import{C as _}from"./Content-Yu3HiZek.js";import{a as w}from"./componentData-DtKArN-5.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DfiyOdhX.js";import"./lodash--S21zL8B.js";import"./useAnalytics-BQ8kZAPF.js";import"./makeStyles-ByEaUd5i.js";import"./useApp-lAnrRgXP.js";import"./Box-DV7TtJ3X.js";import"./styled-CYn__la3.js";import"./Tabs-D91T6-7O.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-3fu4T-am.js";function k(t){const a=f(),s=t.map(({path:n,children:m})=>({caseSensitive:!1,path:`${n}/*`,element:m})).sort((n,m)=>m.path.replace(/\/\*$/,"").localeCompare(n.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let r=a["*"]??"";r.startsWith("/")||(r=`/${r}`);const[i]=R(s,r)??[],p=i?t.findIndex(n=>`${n.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),r=b.useMemo(()=>a.map(i=>{const{path:p,title:n,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:n,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{tabs:r,selectedIndex:o}),e.jsxs(_,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
