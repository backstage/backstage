import{c8 as o,aN as s,bQ as y}from"./iframe-BjdV6pPy.js";import{p as c}from"./ref-CtaBDC4y.js";const a=e=>{const t=Object.keys(s),n=e%t.length;return s[t[n]][0]},u=e=>{try{return c(e?.entityRef??"")}catch{return}},d=e=>{const t=a(0),n=u(e);if(!n)return t;const r=["component","template","api","group","user","resource","system","domain","location"].indexOf(n.kind.toLowerCase());return r===-1?t:a(r+1)},l=e=>(u(e)?.kind??"Other").toLowerCase(),m=o.createContext({getChipColor:d,getLabel:l}),p=({children:e,getChipColor:t=d,getLabel:n=l})=>{const i={getChipColor:t,getLabel:n};return y.jsx(m.Provider,{value:i,children:e})},v=()=>{const e=o.useContext(m);if(!e)throw new Error("useVisitDisplay must be used within a VisitDisplayProvider");return e};p.__docgenInfo={description:`Provider component for VisitDisplay customization
