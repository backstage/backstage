import{p as F,j as e}from"./iframe-CAn0lpb7.js";import{T as x}from"./TextField-6TqFXyQ7.js";import{$ as h}from"./Form-C8E0nRS8.js";import{O as b,d as f}from"./index-DaCp2aen.js";import{F as y}from"./Flex-BSfLeH_i.js";import{F as D}from"./FieldLabel-BAUVt9hU.js";import"./preload-helper-PPVm8Dsz.js";import"./Input-CfyAevp3.js";import"./useObjectRef-B_ULXnmC.js";import"./useFocusable-B-1CwqMl.js";import"./useFormReset-BdN_NTZ4.js";import"./useControlledState-CjhAUExh.js";import"./useField-B2AlhHWQ.js";import"./useLabel-CYsM0HII.js";import"./useLabels-BlsVAVzq.js";import"./utils-CErzHk2O.js";import"./Hidden-D0X4hvc8.js";import"./useFocusRing-BpOIXJlE.js";import"./TextField-whtdxgQx.js";import"./FieldError-C21K6-Fv.js";import"./Text-Bhv3dyj7.js";import"./RSPContexts-BLmUWqCZ.js";import"./Label-CCLyJ_Ef.js";import"./useStyles-RM57Yp59.js";import"./FieldError-uk0o0EZt.js";const s=F.meta({title:"Backstage UI/TextField",component:x,argTypes:{isRequired:{control:"boolean"},icon:{control:"object"}}}),r=s.story({args:{name:"url",placeholder:"Enter a URL",style:{maxWidth:"300px"}}}),n=s.story({args:{...r.input.args},render:i=>e.jsxs(y,{direction:"row",gap:"4",style:{width:"100%",maxWidth:"600px"},children:[e.jsx(x,{...i,size:"small",icon:e.jsx(b,{})}),e.jsx(x,{...i,size:"medium",icon:e.jsx(b,{})})]})}),o=s.story({args:{...r.input.args,defaultValue:"https://example.com"}}),t=s.story({args:{...r.input.args,label:"Label"}}),p=s.story({args:{...t.input.args,description:"Description"}}),u=s.story({args:{...t.input.args,isRequired:!0}}),c=s.story({args:{...r.input.args,isDisabled:!0}}),a=s.story({args:{...r.input.args},render:i=>e.jsx(x,{...i,placeholder:"Enter a URL",size:"small",icon:e.jsx(f,{})})}),d=a.extend({args:{isDisabled:!0}}),l=s.story({args:{...t.input.args},render:i=>e.jsx(h,{validationErrors:{url:"Invalid URL"},children:e.jsx(x,{...i})})}),m=s.story({args:{...t.input.args,validate:i=>i==="admin"?"Nice try!":null}}),g=s.story({render:()=>e.jsxs(e.Fragment,{children:[e.jsx(D,{htmlFor:"custom-field",id:"custom-field-label",label:"Custom Field"}),e.jsx(x,{id:"custom-field","aria-labelledby":"custom-field-label",name:"custom-field",defaultValue:"Custom Field"})]})});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{code:`const Default = () => (
  <TextField
    name="url"
...
})`,...g.input.parameters?.docs?.source}}};const J=["Default","Sizes","DefaultValue","WithLabel","WithDescription","Required","Disabled","WithIcon","DisabledWithIcon","ShowError","Validation","CustomField"];export{g as CustomField,r as Default,o as DefaultValue,c as Disabled,d as DisabledWithIcon,u as Required,l as ShowError,n as Sizes,m as Validation,p as WithDescription,a as WithIcon,t as WithLabel,J as __namedExportsOrder};
