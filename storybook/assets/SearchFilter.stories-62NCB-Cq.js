...
input value is provided as an input to allow values to be filtered. This
function is debounced and values cached.`},{key:"defaultValue",value:{name:"union",raw:"string[] | string | null",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"string"},{name:"null"}],required:!1}},{key:"valuesDebounceMs",value:{name:"number",required:!1},description:`Debounce time in milliseconds, used when values is an async callback.
Defaults to 250ms.`}]}},name:"props"}],return:{name:"ReactElement"}}},description:""},debug:{required:!1,tsType:{name:"boolean"},description:""}}};const Ke={title:"Plugins/Search/SearchFilter",component:l,decorators:[e=>n.jsx(J,{apis:[[K,new X]],children:n.jsx(ne,{children:n.jsx($,{container:!0,direction:"row",children:n.jsx($,{item:!0,xs:4,children:n.jsx(e,{})})})})})],tags:["!manifest"]},x=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Checkbox,{name:"Search Checkbox Filter",values:["value1","value2"]})}),T=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Select,{label:"Search Select Filter",name:"select_filter",values:["value1","value2"]})}),P=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Select,{label:"Asynchronous Values",name:"async_values",values:async()=>(await(await fetch("https://swapi.dev/api/planets")).json()).results.map(s=>s.name)})}),C=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{name:"autocomplete",label:"Single-Select Autocomplete Filter",values:["value1","value2"]})}),I=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{multiple:!0,name:"autocomplete",label:"Multi-Select Autocomplete Filter",values:["value1","value2"]})}),E=()=>n.jsx(F,{style:{padding:10},children:n.jsx(l.Autocomplete,{multiple:!0,name:"starwarsPerson",label:"Starwars Character",values:async e=>e===""?[]:(await(await fetch(`https://swapi.dev/api/people?search=${encodeURIComponent(e)}`)).json()).results.map(r=>r.name)})});x.__docgenInfo={description:"",methods:[],displayName:"CheckBoxFilter"};T.__docgenInfo={description:"",methods:[],displayName:"SelectFilter"};P.__docgenInfo={description:"",methods:[],displayName:"AsyncSelectFilter"};C.__docgenInfo={description:"",methods:[],displayName:"Autocomplete"};I.__docgenInfo={description:"",methods:[],displayName:"MultiSelectAutocomplete"};E.__docgenInfo={description:"",methods:[],displayName:"AsyncMultiSelectAutocomplete"};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`() => {
  return <Paper style={{
    padding: 10
  }}>
