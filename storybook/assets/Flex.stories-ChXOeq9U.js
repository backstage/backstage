import{p as w,j as e,B as D}from"./iframe-Zkjja1CZ.js";import{F as t}from"./Flex-DRI3u4rm.js";import{T as y}from"./Text-DyrHi5t_.js";import"./preload-helper-PPVm8Dsz.js";const a=w.meta({title:"Backstage UI/Flex",component:t,argTypes:{align:{control:"inline-radio",options:["start","center","end","baseline","stretch"]},justify:{control:"inline-radio",options:["start","center","end","between"]},direction:{control:"inline-radio",options:["row","column","row-reverse","column-reverse"]}},args:{children:null}}),r=({width:n="48px",height:j="48px"})=>{const b=(()=>{const f=`
