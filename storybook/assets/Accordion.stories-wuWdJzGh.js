import{c8 as c,c7 as Y,S as j,be as D,cE as _,bQ as e,i as f,c5 as Z}from"./iframe-DwtLqRd0.js";import{a as k,b as ee}from"./Button-CN2KE0n5.js";import{a as te,b as q,$ as K,d as ne,e as R}from"./utils-CTdfKX7K.js";import{$ as oe}from"./useEvent-Da_JgobS.js";import{b as I,g as re,f as ie,e as O,c as ae}from"./useObjectRef-C3WIJKuW.js";import{$ as z}from"./useControlledState-kobszWOc.js";import{a as H,m as G}from"./useFocusRing-Br9K8cEf.js";import{$ as se}from"./Heading-Ziqlmepr.js";import{r as ce}from"./index-BnPMaZ6y.js";import{F as m}from"./Flex-CST9e3I9.js";import{T as x}from"./Text-BfBp2i3A.js";import{B as A}from"./Button-CwlAKdK0.js";import"./preload-helper-PPVm8Dsz.js";import"./Label-CnMUtZHy.js";import"./Hidden-Bs1ekBhh.js";import"./useLabel-csUjoQn4.js";import"./useLabels-DBBGWQnZ.js";import"./number-Bm7tKJss.js";import"./I18nProvider-nGJGLiEq.js";import"./useButton-A_NfRVcv.js";import"./usePress-C5TgjZ1H.js";import"./textSelection-DEZhmmiP.js";import"./openLink-Chp0fPN0.js";import"./useHover-BPNWkg3J.js";function le(a,t,n){let{isDisabled:o}=a,s=I(),i=I(),l=re(),g=c.useRef(null),h=c.useCallback(()=>{g.current=requestAnimationFrame(()=>{n.current&&n.current.setAttribute("hidden","until-found")}),Y.flushSync(()=>{t.toggle()})},[n,t]);oe(n,"beforematch",h);let b=c.useRef(null);return ie(()=>{if(g.current&&cancelAnimationFrame(g.current),n.current&&!l){let r=n.current;b.current==null||typeof r.getAnimations!="function"?t.isExpanded?(r.removeAttribute("hidden"),r.style.setProperty("--disclosure-panel-width","auto"),r.style.setProperty("--disclosure-panel-height","auto")):(r.setAttribute("hidden","until-found"),r.style.setProperty("--disclosure-panel-width","0px"),r.style.setProperty("--disclosure-panel-height","0px")):t.isExpanded!==b.current&&(t.isExpanded?(r.removeAttribute("hidden"),r.style.setProperty("--disclosure-panel-width",r.scrollWidth+"px"),r.style.setProperty("--disclosure-panel-height",r.scrollHeight+"px"),Promise.all(r.getAnimations().map(T=>T.finished)).then(()=>{r.style.setProperty("--disclosure-panel-width","auto"),r.style.setProperty("--disclosure-panel-height","auto")}).catch(()=>{})):(r.style.setProperty("--disclosure-panel-width",r.scrollWidth+"px"),r.style.setProperty("--disclosure-panel-height",r.scrollHeight+"px"),window.getComputedStyle(r).height,r.style.setProperty("--disclosure-panel-width","0px"),r.style.setProperty("--disclosure-panel-height","0px"),Promise.all(r.getAnimations().map(T=>T.finished)).then(()=>r.setAttribute("hidden","until-found")).catch(()=>{}))),b.current=t.isExpanded}},[o,n,t.isExpanded,l]),c.useEffect(()=>()=>{g.current&&cancelAnimationFrame(g.current)},[]),{buttonProps:{id:s,"aria-expanded":t.isExpanded,"aria-controls":i,onPress:r=>{!o&&r.pointerType!=="keyboard"&&t.toggle()},isDisabled:o,onPressStart(r){r.pointerType==="keyboard"&&!o&&t.toggle()}},panelProps:{id:i,role:"group","aria-labelledby":s,"aria-hidden":!t.isExpanded,hidden:l?!t.isExpanded:void 0}}}function de(a){let{allowsMultipleExpanded:t=!1,isDisabled:n=!1}=a,[o,s]=z(c.useMemo(()=>a.expandedKeys?new Set(a.expandedKeys):void 0,[a.expandedKeys]),c.useMemo(()=>a.defaultExpandedKeys?new Set(a.defaultExpandedKeys):new Set,[a.defaultExpandedKeys]),a.onExpandedChange);return c.useEffect(()=>{if(!t&&o.size>1){let i=o.values().next().value;i!=null&&s(new Set([i]))}}),{allowsMultipleExpanded:t,isDisabled:n,expandedKeys:o,setExpandedKeys:s,toggleKey(i){let l;t?(l=new Set(o),l.has(i)?l.delete(i):l.add(i)):l=new Set(o.has(i)?[]:[i]),s(l)}}}function ue(a){let[t,n]=z(a.isExpanded,a.defaultExpanded||!1,a.onExpandedChange);const o=c.useCallback(()=>{n(!0)},[n]),s=c.useCallback(()=>{n(!1)},[n]),i=c.useCallback(()=>{n(!t)},[n,t]);return{isExpanded:t,setExpanded:n,expand:o,collapse:s,toggle:i}}const V=c.createContext(null),pe=c.forwardRef(function(t,n){let o=de(t),s=q({...t,defaultClassName:"react-aria-DisclosureGroup",values:{isDisabled:o.isDisabled,state:o}}),i=G(t,{global:!0});return j.createElement(R.div,{...i,...s,ref:n,"data-disabled":t.isDisabled||void 0},j.createElement(V.Provider,{value:o},s.children))}),xe=c.createContext(null),fe=c.createContext(null),Q=c.createContext(null),ge=c.forwardRef(function(t,n){[t,n]=te(t,n,xe);let o=c.useContext(V),{id:s,...i}=t,l=I();s||=l;let g=o?o.expandedKeys.has(s):t.isExpanded,h=ue({...t,isExpanded:g,onExpandedChange(X){o&&o.toggleKey(s),t.onExpandedChange?.(X)}}),b=j.useRef(null),r=t.isDisabled||o?.isDisabled||!1,{buttonProps:T,panelProps:U}=le({...t,isExpanded:g,isDisabled:r},h,b),{isFocusVisible:M,focusProps:J}=H({within:!0}),W=q({...t,id:void 0,defaultClassName:"react-aria-Disclosure",values:{isExpanded:h.isExpanded,isDisabled:r,isFocusVisibleWithin:M,state:h}}),L=G(i,{global:!0});return j.createElement(K,{values:[[k,{slots:{[ne]:{},trigger:T}}],[Q,{panelProps:U,panelRef:b}],[fe,h]]},j.createElement(R.div,{...O(L,W,J),ref:n,"data-expanded":h.isExpanded||void 0,"data-disabled":r||void 0,"data-focus-visible-within":M||void 0},W.children))}),he=c.forwardRef(function(t,n){let{role:o="group"}=t,{panelProps:s,panelRef:i}=c.useContext(Q),{isFocusVisible:l,focusProps:g}=H({within:!0}),h=q({...t,defaultClassName:"react-aria-DisclosurePanel",values:{isFocusVisibleWithin:l}}),b=G(t,{global:!0,labelable:!0});return j.createElement(R.div,{...O(b,h,s,g),ref:ae(n,i),role:o,"data-focus-visible-within":l||void 0},j.createElement(K,{values:[[k,null]]},t.children))}),S={"bui-Accordion":"_bui-Accordion_1fqks_20","bui-AccordionTrigger":"_bui-AccordionTrigger_1fqks_32","bui-AccordionTriggerButton":"_bui-AccordionTriggerButton_1fqks_40","bui-AccordionTriggerTitle":"_bui-AccordionTriggerTitle_1fqks_63","bui-AccordionTriggerSubtitle":"_bui-AccordionTriggerSubtitle_1fqks_69","bui-AccordionTriggerIcon":"_bui-AccordionTriggerIcon_1fqks_75","bui-AccordionPanel":"_bui-AccordionPanel_1fqks_86","bui-AccordionGroup":"_bui-AccordionGroup_1fqks_92"},me=D()({styles:S,classNames:{root:"bui-Accordion"},bg:"provider",propDefs:{bg:{dataAttribute:!0,default:"neutral"},children:{},className:{}}}),be=D()({styles:S,classNames:{root:"bui-AccordionTrigger",button:"bui-AccordionTriggerButton",title:"bui-AccordionTriggerTitle",subtitle:"bui-AccordionTriggerSubtitle",icon:"bui-AccordionTriggerIcon"},propDefs:{className:{},title:{},subtitle:{},children:{}}}),Ae=D()({styles:S,classNames:{root:"bui-AccordionPanel"},propDefs:{className:{}}}),ye=D()({styles:S,classNames:{root:"bui-AccordionGroup"},propDefs:{className:{},allowsMultiple:{default:!1}}}),d=c.forwardRef((a,t)=>{const{ownProps:n,restProps:o,dataAttributes:s}=_(me,a),{classes:i,childrenWithBgProvider:l}=n;return e.jsx(ge,{ref:t,className:i.root,...s,...o,children:l})});d.displayName="Accordion";const u=c.forwardRef((a,t)=>{const{ownProps:n,restProps:o,dataAttributes:s}=_(be,a),{classes:i,title:l,subtitle:g,children:h}=n;return e.jsx(se,{ref:t,className:i.root,...s,...o,children:e.jsxs(ee,{slot:"trigger",className:i.button,children:[h||e.jsxs(m,{gap:"2",align:"center",children:[e.jsx("span",{className:i.title,children:l}),g&&e.jsx("span",{className:i.subtitle,children:g})]}),e.jsx(ce,{className:i.icon,size:16})]})})});u.displayName="AccordionTrigger";const p=c.forwardRef((a,t)=>{const{ownProps:n,restProps:o,dataAttributes:s}=_(Ae,a),{classes:i}=n;return e.jsx(he,{ref:t,className:i.root,...s,...o})});p.displayName="AccordionPanel";const F=c.forwardRef((a,t)=>{const{ownProps:n,restProps:o,dataAttributes:s}=_(ye,a),{classes:i,allowsMultiple:l}=n;return e.jsx(pe,{ref:t,allowsMultipleExpanded:l,className:i.root,...s,...o})});F.displayName="AccordionGroup";d.__docgenInfo={description:`A collapsible section that reveals or hides its content when the trigger is activated.
