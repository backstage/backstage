    ...
    expect(getByTestId(TEST_IDS.info.info)).toMatchInlineSnapshot(`
      ...
      >
        ...
        >
          ...
          <a
            class="MuiTypography-root MuiLink-root MuiLink-underlineHover Link-externalLink-14 MuiTypography-colorPrimary"
          ...
          >
            Git releases
            <span
              class="MuiTypography-root Link-visuallyHidden-13 MuiTypography-body1"
            >
