...
const parameterSchema = createFromZod(z =>
  z
    .object({
...
export const templateEntityV1beta3Schema = createEntitySchema(z => ({
            ...
            .array(
              z.object({
                ...
                entityRef: z
                  .string()
                  .optional()
                  .describe('An entity reference to an entity in the catalog.'),
                title: z
                  .string()
                  .min(1)
                  .optional()
