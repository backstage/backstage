...
import { ListNotificationsLegacyOrderFieldParameter } from '../models/ListNotificationsLegacyOrderFieldParameter.model';
...
export type ListNotifications = {
  query: {
    offset?: number;
    limit?: number;
    orderField?: ListNotificationsLegacyOrderFieldParameter;
    topic?: string;
    search?: string;
    read?: 'true' | 'false';
    saved?: 'true' | 'false';
