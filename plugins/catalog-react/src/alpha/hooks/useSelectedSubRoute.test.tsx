...
import { useSelectedSubRoute } from './useSelectedSubRoute';
import { SubRoute } from '../types';

function TestSubRouteHook(props: { subRoutes: SubRoute[] }) {
...
describe('useSelectedSubRoute', () => {
  ...
  it('should match the index route when path is "/"', () => {
    const subRoutesWithIndex: SubRoute[] = [
      {
        group: 'default',
        path: '/',
        title: 'Overview',
  ...
  it('should support relative links within routes', () => {
    const routesWithRelativeLinks: SubRoute[] = [
      {
        group: 'default',
        path: '/entity',
        title: 'Entity',
    ...
    expect(screen.getByText('Go to child')).toHaveAttribute('href', './child');
  });

  it('should handle routes with nested path segments', () => {
    const nestedPathRoutes: SubRoute[] = [
      {
        group: 'default',
  ...
  it('should accept paths that already include an explicit wildcard', () => {
    const wildcardSubRoutes: SubRoute[] = [
      {
        group: 'default',
        path: '/',
        title: 'Overview',
