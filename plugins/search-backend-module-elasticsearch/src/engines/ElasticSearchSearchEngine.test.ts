...
jest.mock('./ElasticSearchEngineIndexer', () => ({
  ElasticSearchEngineIndexer: jest.fn().mockImplementation(() => indexerMock),
}));
...
describe('ElasticSearchSearchEngine', () => {
  ...
  describe('indexer', () => {
    it('should get indexer', async () => {
      ...
      expect(ElasticSearchEngineIndexer).toHaveBeenCalledWith(
