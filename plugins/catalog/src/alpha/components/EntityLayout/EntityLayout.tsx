...
import {
  DefaultEntityLayoutHeader,
  DefaultEntityLayoutHeaderProps,
} from './DefaultEntityLayoutHeader';
...
export interface EntityLayoutProps {
  UNSTABLE_contextMenuOptions?: DefaultEntityLayoutHeaderProps['UNSTABLE_contextMenuOptions'];
  UNSTABLE_extraContextMenuItems?: DefaultEntityLayoutHeaderProps['UNSTABLE_extraContextMenuItems'];
  children?: ReactNode;
  HeaderComponent?: <P extends DefaultEntityLayoutHeaderProps>(
    props: P,
  ) => JSX.Element;
...
export const EntityLayout = (props: EntityLayoutProps) => {
  const {
    ...
    children,
    HeaderComponent: Header = DefaultEntityLayoutHeader,
    NotFoundComponent,
