...
export interface EntityLayoutProps {
  UNSTABLE_contextMenuOptions?: BaseEntityHeaderProps['UNSTABLE_contextMenuOptions'];
  UNSTABLE_extraContextMenuItems?: BaseEntityHeaderProps['UNSTABLE_extraContextMenuItems'];
  children?: ReactNode;
  HeaderComponent?: <P extends BaseEntityHeaderProps>(props: P) => JSX.Element;
