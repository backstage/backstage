...
export type DefaultEntityLayoutHeaderProps = {
...
export function DefaultEntityLayoutHeader(
  props: DefaultEntityLayoutHeaderProps,
) {
  const {
    UNSTABLE_extraContextMenuItems,
    UNSTABLE_contextMenuOptions,
  ...
  const { headerTitle: title, headerType: type } = headerProps(
    kind,
    namespace,
    name,
    entity,
  ...
  return (
    <Header
      ...
      type={type}
      title={
        <EntityLayoutTitle entity={entity!} title={title} actions={actions} />
      }
      subtitle={
        parentEntity && (
