...
/** @public */
export const useColumnFactories = () => {
  ...
  return Object.freeze({
    createNameColumn(options?: {
      ...
      return {
        title: t('catalogTableColumns.name'),
    ...
    createSystemColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.system'),
    ...
    createOwnerColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.owner'),
    ...
    createSpecTargetsColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.targets'),
    ...
    createSpecTypeColumn(
      ...
      return {
        title: t('catalogTableColumns.type'),
    ...
    createSpecLifecycleColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.lifecycle'),
        field: 'entity.spec.lifecycle',
      };
    },
    createMetadataDescriptionColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.description'),
    ...
    createTagsColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.tags'),
    ...
    createTitleColumn(options?: {
      ...
      return {
        title: t('catalogTableColumns.title'),
    ...
    createLabelColumn(
      ...
      return {
        title: options?.title || t('catalogTableColumns.label'),
    ...
    createNamespaceColumn(): TableColumn<CatalogTableRow> {
      return {
        title: t('catalogTableColumns.namespace'),
