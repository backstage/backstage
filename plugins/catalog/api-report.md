...
//
// src/components/CatalogTable/CatalogTable.d.ts:9:5 - (ae-forgotten-export) The symbol "CatalogTableProps" needs to be exported by the entry point index.d.ts
// src/components/CatalogTable/CatalogTable.d.ts:10:5 - (ae-forgotten-export) The symbol "columnFactories" needs to be exported by the entry point index.d.ts
...
// src/plugin.d.ts:16:5 - (ae-forgotten-export) The symbol "ColumnBreakpoints" needs to be exported by the entry point index.d.ts
