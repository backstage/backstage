...
import { usePullRequestsByRepositories } from '../../hooks/usePullRequestsByRepositories';
import { PRCardFormating } from '../../utils/types';
import { DraftPrIcon } from '../icons/DraftPr';

const PullRequestsContent = ({ repositories }: { repositories: string[] }) => {
  const [infoCardFormat, setInfoCardFormat] = useState<PRCardFormating[]>([]);
  const { loading, pullRequests, refreshPullRequests } =
    usePullRequestsByRepositories(repositories);
