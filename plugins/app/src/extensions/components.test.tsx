...
describe('PageLayout', () => {
  ...
  describe('Breadcrumbs', () => {
    ...
    it('should register breadcrumbs for inner routes within a sub-page', async () => {
      ...
      // The inner `<Routes>` needs a React Router context, and the framework
      // supplies none — so the sub-page declares one for itself. Being scoped
      // to the sub-page mount, the inner routes are written relative to the
      // tab rather than to the page.
