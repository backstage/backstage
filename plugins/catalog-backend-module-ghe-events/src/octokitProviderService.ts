...
export interface OctokitProvider {
  getOctokit: (url: string) => Promise<Octokit>;
}

class OctokitProviderImpl implements OctokitProvider {
...
export const octokitProviderServiceRef = createServiceRef<OctokitProvider>({
  id: 'octokitProvider',
  scope: 'root',
