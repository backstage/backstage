...
/**
 * Implements authorization controls on top of all actions.
 */
export class AuthorizedLocationService implements LocationService {
  constructor(
    private readonly delegate: LocationService,
  ...
  async createLocation(
    ...
    return this.delegate.createLocation(spec, dryRun);
  }
  ...
  async listLocations(options?: {
    ...
    return this.delegate.listLocations();
  }
  ...
  async getLocation(
    ...
    return this.delegate.getLocation(id);
  }
  ...
  async deleteLocation(
    ...
    return this.delegate.deleteLocation(id);
  }
}
