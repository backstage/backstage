...
// @alpha
export const kubernetesClusterPermissions: ResourcePermission<'kubernetes-resource'>[];

// @alpha
export const kubernetesClusterReadPermission: ResourcePermission<'kubernetes-resource'>;

// @alpha
export const kubernetesCustomResourcesReadPermission: ResourcePermission<'kubernetes-resource'>;
...
// @alpha
export const kubernetesWorkloadResourcesReadPermission: ResourcePermission<'kubernetes-resource'>;
