...
export class DatabaseHandler {
  ...
  async followPlaylist(playlistId: string, user: IdentityApiUserIdentity) {
    await this.database('followers')
  ...
  async unfollowPlaylist(playlistId: string, user: IdentityApiUserIdentity) {
    await this.database('followers')
