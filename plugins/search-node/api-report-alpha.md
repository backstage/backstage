## API Report File for "@backstage/plugin-search-node"
...
import { RegisterCollatorParameters } from '@backstage/plugin-search-node';
import { RegisterDecoratorParameters } from '@backstage/plugin-search-node';
