...
export const LightBoxAddon = () => {
  ...
  useEffect(() => {
    ...
    const setup = async () => {
      ...
      // lightbox.css overrides photoswipe's own styles, so apply after them.
      await import('photoswipe/style.css');
      await import('./lightbox.css');
      ...
      lightbox = new Lightbox({
        ...
        wheelToZoom: true,
        arrowPrevSVG:
          '<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeLarge" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"></path></svg>',
        arrowNextSVG:
          '<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeLarge" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"></path></svg>',
        closeSVG:
          '<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeLarge pswp__icn" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg>',
        zoomSVG: `<svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeLarge pswp__icn" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
