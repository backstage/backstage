...
describe('DefaultEntitiesCatalog', () => {
  ...
  describe('paginatedEntities', () => {
    describe.each(['cursor', 'offset'] as const)(
      'pagination using %s',
      pagination => {
        it.each(databases.eachSupportedId())(
          ...
          async databaseId => {
            ...
            expect(response1.entities).toEqual([
              entityFrom('A'),
              entityFrom('B'),
            ]);
            ...
            expect(response2.entities).toEqual([
              entityFrom('C'),
              entityFrom('D'),
            ]);
            ...
            expect(response4.entities).toEqual([
              entityFrom('C'),
              entityFrom('D'),
            ]);
            ...
            expect(response5.entities).toEqual([
              entityFrom('A'),
              entityFrom('B'),
            ]);
            ...
            expect(response6.entities).toEqual([
              entityFrom('C'),
              entityFrom('D'),
            ]);
            ...
            expect(response7.entities).toEqual([
              entityFrom('E'),
              entityFrom('F'),
            ]);
