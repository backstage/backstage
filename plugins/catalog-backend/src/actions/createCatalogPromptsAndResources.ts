...
export const createCatalogPromptsAndResources = ({
  actionsRegistry,
  catalog,
}: {
  ...
  actionsRegistry.registerPrompt({
    ...
    description: 'Learn about catalog contents and how to search for entities',
    template: `
...
You can also browse by kind, owner, domain, or other metadata fields.
  ...
  actionsRegistry.registerPrompt({
    ...
    description: 'Learn about entity metadata, annotations, and relationships',
    template: `
...
- \`github.com/project-slug\`: GitHub repository
  ...
  // Register a resource that allows browsing catalog entities
