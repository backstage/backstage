...
// @public (undocumented)
export const EntityGithubDeploymentsCard: ({ last, lastStatuses, columns, }: {
...
// @public (undocumented)
export function GithubDeploymentsTable({ deployments, isLoading, reload, columns, }: GithubDeploymentsTableProps): JSX.Element;
...
// @public (undocumented)
const GithubStateIndicator: ({ state }: {
    state: string;
}) => JSX.Element;
