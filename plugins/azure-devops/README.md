...
If your repo in Azure DevOps is mono repo and want to use the mono repo services in Backstage components, then use the below annotation to get respective service/repo's `README.md` & `Build Pipeline`
