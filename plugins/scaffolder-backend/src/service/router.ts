...
export async function createRouter(
  ...
  await actionRegistry.refreshDistributedActions();
  ...
  router
    ...
    .get('/v2/actions', async (req, res) => {
      ...
      try {
        const actionsList = (await actionRegistry.list()).map(action => {
          return {
            id: action.id,
    ...
    .post('/v2/tasks', async (req, res) => {
      ...
      try {
        ...
        // Make sure we have all the distributed actions in the registry before we start a task
        await actionRegistry.refreshDistributedActions();
  ...
  router
    ...
    .post('/v2/dry-run', async (req, res) => {
      ...
      try {
        ...
        // Make sure we have all the distributed actions in the registry before we start a dry-run
        await actionRegistry.refreshDistributedActions();
