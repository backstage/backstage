...
const taskConditionalExports = createConditionExports({
  pluginId: 'scaffolder',
...
export const createScaffolderTaskConditionalDecision =
  taskConditionalExports.createConditionalDecision;
 ...
 * @alpha
 */
export const scaffolderTaskConditions = taskConditionalExports.conditions;
