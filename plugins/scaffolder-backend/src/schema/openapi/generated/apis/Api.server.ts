...
import { ValidationErrorResponse } from '../models/ValidationErrorResponse.model';
...
export type DryRun = {
  body: DryRunRequest;
  response: DryRun200Response | ValidationErrorResponse;
};
/**
 * @public
 */
...
export type Retry = {
  ...
  body: RetryRequest;
  response: Scaffold201Response | ValidationErrorResponse;
};
/**
 * @public
 */
