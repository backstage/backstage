...
- 36b693d: Exclude internal task data from task responses.
- 41b8261: Restrict task retries to terminal states.
- 9f11b22: Fixed matching of action input values in scaffolder permission policies.
