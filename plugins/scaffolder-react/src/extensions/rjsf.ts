...
/**
 * This file is some copied types from RJSF to help us ship breaking changes in a non-breaking fashion from
 * later versions of react-jsonschema-form. It might be possible to remove this file in the future when we've thought
 * a little more about field extensions, and maybe creating a seperate API for them instead of relying on RJSF types.
 */
