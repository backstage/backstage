...
```ts
import type { AuthConfig } from '@backstage/plugin-kubernetes-common';
import { CatalogApi } from '@backstage/catalog-client';
import { Config } from '@backstage/config';
import { CustomResource } from '@backstage/plugin-kubernetes-common';
import type { CustomResourceMatcher } from '@backstage/plugin-kubernetes-common';
import type { CustomResourcesKubernetesRequestBody } from '@backstage/plugin-kubernetes-common';
...
// Warning: (ae-missing-release-tag) "CustomResourcesByEntityRequest" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
