...
import { kubernetesPermissionResourceRef } from '@backstage/plugin-kubernetes-node/alpha';
/**
...
export const isEntityOwner = createPermissionRule({
  ...
  description:
    'Allow only owners to view Kubernetes resources accociated to the entity',
...
export const rules = { isEntityOwner };
