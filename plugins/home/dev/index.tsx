...
const defaultGridConfig: NonNullable<CustomHomepageGridProps['config']> = [
  {
...
const homePage = CustomHomepageBlueprint.make({
  params: {
    title: 'Home',
    grid: {
...
const homePageToolkitWidget = CustomHomepageWidgetBlueprint.make({
  name: 'home-toolkit',
  params: {
...
const homePageStarredEntitiesWidget = CustomHomepageWidgetBlueprint.make({
...
const homePageRandomJokeWidget = CustomHomepageWidgetBlueprint.make({
