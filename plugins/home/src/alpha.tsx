...
export {
  ...
  type CustomHomepageBlueprintParams,
  type CustomHomepageTemplateProps,
  type CustomHomepageGridProps,
} from './alpha/CustomHomepageBlueprint';
export { titleExtensionDataRef } from '@backstage/plugin-home-react/alpha';
export {
