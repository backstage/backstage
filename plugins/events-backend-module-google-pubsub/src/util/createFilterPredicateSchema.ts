...
/** @internal */
export function createFilterPredicateSchema(z: typeof zImpl) {
  ...
  let valuePredicateSchema: ZodType<FilterPredicateValue>;
  ...
  ]) as ZodType<FilterPredicateValue>;
