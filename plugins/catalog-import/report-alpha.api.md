...
export const catalogImportTranslationRef: TranslationRef<
  'catalog-import',
  {
    ...
    readonly 'importInfoCard.githubIntegration.descriptionPrefix': 'The wizard discovers all ';
    readonly 'importInfoCard.githubIntegration.descriptionSuffix': ' files in the repository, previews the entities, and adds them to the {{appTitle}} catalog.';
    readonly 'importInfoCard.githubIntegration.prDescriptionPrefix': 'If no entities are found, the wizard will prepare a Pull Request that adds an example ';
    readonly 'importInfoCard.githubIntegration.prDescriptionSuffix': ' and prepares the {{appTitle}} catalog to load all entities as soon as the Pull Request is merged.';
    ...
    readonly 'importStepper.noLocation.createPr.codeownersLabelPrefix': 'Use ';
    readonly 'importStepper.noLocation.createPr.codeownersLabelSuffix': ' file as Entity Owner';
    ...
    readonly 'stepPrepareCreatePullRequest.descriptionPrefix': 'You entered a link to a {{integrationType}} repository but a ';
    readonly 'stepPrepareCreatePullRequest.descriptionSuffix': ' could not be found. Use this form to open a Pull Request that creates one.';
