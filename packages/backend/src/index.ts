...
import catalogImport from './plugins/import';
...
async function main() {
  ...
  const catalogImportEnv = useHotMemoize(module, () => createEnv('import'));
  ...
  apiRouter.use('/catalog-import', await catalogImport(catalogImportEnv));
