...
describe('dynamicFrontendFeaturesLoader', () => {
  ...
  it('should initialize module federation with default shared imports', async () => {
    server.use(
      rest.get(
        `${baseUrl}/.backstage/dynamic-features/remotes`,
    ...
    expect(spyInit.mock.calls[0][0].options).toMatchObject({
      shared: Object.fromEntries(
        defaultSharedImports.map(shared => [
          shared.name,
          [
            {
              ...
              shareConfig: {
                ...
                eager:
                  shared.eagerInHost === undefined ? true : shared.eagerInHost,
              },
