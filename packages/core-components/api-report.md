...
export type ErrorBoundaryProps = {
  FallbackComponent?: React_2.ComponentType<ErrorBoundaryFallbackProps>;
...
// src/layout/ErrorBoundary/ErrorBoundary.d.ts:14:5 - (ae-forgotten-export) The symbol "ErrorBoundaryFallbackProps" needs to be exported by the entry point index.d.ts
// src/layout/ErrorBoundary/ErrorBoundary.d.ts:19:5 - (ae-forgotten-export) The symbol "SlackChannel" needs to be exported by the entry point index.d.ts
```
