...
/** Returns variant classes for the sheet side. */
function getSideClasses(side: SheetSide): string {
...
/**
 * Sheet content panel — a side drawer built on Radix Dialog.
 * Replaces MUI Drawer for sidebar navigation and side panels.
 * Supports left/right/top/bottom sides via the `side` prop.
 *
 * @public
 */
