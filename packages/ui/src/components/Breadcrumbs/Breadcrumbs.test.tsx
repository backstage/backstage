...
describe('Breadcrumbs', () => {
  it('should render a nav landmark with all breadcrumb items', () => {
    render(
      <Breadcrumbs>
  ...
  it('should support a custom aria-label to differentiate multiple instances', () => {
    render(
      <>
        <Breadcrumbs aria-label="Main navigation">
          <Breadcrumb href="/home">Home</Breadcrumb>
          <Breadcrumb href="/docs">Docs</Breadcrumb>
        </Breadcrumbs>
        <Breadcrumbs aria-label="Footer navigation">
  ...
  it('should render the current item with a custom text element when as is provided', () => {
    render(
      <Breadcrumbs>
        <Breadcrumb href="/home">Home</Breadcrumb>
  ...
  it('should apply currentAs only to the last item', () => {
    render(
      <Breadcrumbs currentAs="h1">
  ...
  it('should apply currentAs to the last item when collapsed', () => {
    render(
      <Breadcrumbs currentAs="h1">
        <Breadcrumb href="/a">First</Breadcrumb>
        <Breadcrumb href="/b">Second</Breadcrumb>
        <Breadcrumb href="/c">Third</Breadcrumb>
        <Breadcrumb>Fourth</Breadcrumb>
        <Breadcrumb>Page Title</Breadcrumb>
      </Breadcrumbs>,
      { wrapper: Wrapper },
    );
    ...
    expect(screen.getByText('Page Title').tagName).toBe('H1');
    expect(screen.getByText('Fourth').tagName).toBe('SPAN');
  });
