...
TanStack Router, and `/nfs-routing-demo-v7` on React Router v7. Tabs without an
override inherit their page router, while selected tabs with an explicit
override replace it. The demo panels cover inherited routing, nested routes,
and cross-library page and sub-page combinations.
...
default. At runtime the active sub-page override takes priority over the page
override, followed by the default React Router v6 adapter. See
