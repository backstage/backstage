      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-sm px-8">
        ...
        <div className="flex flex-col gap-3 w-full">
          <button
            ...
            disabled={signingIn}
            className="flex items-center justify-center gap-2.5 w-full h-12 px-6 rounded-lg bg-foreground text-background text-sm font-medium transition-all duration-150 hover:opacity-90 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={signingIn}
            className="flex items-center justify-center gap-2 w-full h-12 px-6 rounded-lg border border-input bg-background text-sm font-medium text-muted-foreground transition-all duration-150 hover:bg-accent hover:text-accent-foreground active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Continue as Guest
          </button>
        </div>
        ...
        <p className="text-xs text-muted-foreground/60 text-center">
          Sign in with GitHub to track your identity. Guest access is read-only.
        </p>
      </div>
    </div>
  );
