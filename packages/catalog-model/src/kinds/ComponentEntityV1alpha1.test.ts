...
describe('ComponentV1alpha1Validator', () => {
  ...
  it('happy path: accepts valid data', async () => {
    ...
    expect(componentEntitySchema.safeParse(entity).success).toBe(true);
  });
  ...
  it('ignores unknown apiVersion', async () => {
    ...
    expect(componentEntitySchema.safeParse(entity).success).toBe(false);
  });
  ...
  it('rejects missing type', async () => {
    ...
    expect(() => componentEntitySchema.parse(entity)).toThrow(/type/);
  });
  ...
  it('rejects missing lifecycle', async () => {
    ...
    expect(() => componentEntitySchema.parse(entity)).toThrow(/lifecycle/);
  });
  ...
  it('rejects missing owner', async () => {
    ...
    expect(() => componentEntitySchema.parse(entity)).toThrow(/owner/);
  });
  ...
  it('rejects undefined consumesApis', async () => {
    ...
    await expect(validator.check(entity)).rejects.toThrow(/consumesApis/);
    expect(() => componentEntitySchema.parse(entity)).toThrow(/consumesApis/);
  });
  ...
  it('rejects wrong system', async () => {
    ...
    expect(() => componentEntitySchema.parse(entity)).toThrow(/system/);
  });
