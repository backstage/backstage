...
//
// src/tasks/TaskScheduler.d.ts:18:5 - (ae-undocumented) Missing documentation for "fromConfig".
// src/tasks/TaskScheduler.d.ts:34:5 - (ae-undocumented) Missing documentation for "forPlugin".
```
