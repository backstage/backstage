...
import { RouterApi } from '../../definitions';
...
export class ReactRouter6RouterApi implements RouterApi {
  ...
  // === Components ===
  // Note: Route and Routes are exposed as-is from react-router because
  // react-router's Routes component inspects children types and rejects wrappers.
  // Users should access these via useApi(routerApiRef) or import directly.
