...
<Table.Root>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        Used for primary foreground text and icons on main background surfaces.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for secondary text and supporting elements on main background surfaces.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for disabled or inactive text and elements on main background surfaces.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for foreground content displayed on solid or high-contrast background
        colors.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      ...
      <Table.Cell>
        Used for error states, critical messages, and destructive actions.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        Used to indicate success states and positive feedback.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for informational messages and neutral status indicators.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for text and icons displayed on danger (error) background colors.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for text and icons displayed on warning background colors.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for text and icons displayed on success background colors.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for text and icons displayed on informational background colors.
      </Table.Cell>
    </Table.Row>
  </Table.Body>
</Table.Root>
...
<Table.Root>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        Used for subtle borders and low-contrast separators.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for default borders on `--bui-bg-neutral-1` surfaces.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for borders on `--bui-bg-danger` surfaces typically in error or critical
        states.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      ...
      <Table.Cell>
        Used for borders on `--bui-bg-warning` surfaces for cautionary or warning
        states.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      ...
      <Table.Cell>
        Used for borders on `--bui-bg-success` surfaces indicating successful states.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        Used for borders on `--bui-bg-info` surfaces for informational content.
      </Table.Cell>
    </Table.Row>
  </Table.Body>
</Table.Root>
