...
| [Actions](./module-actions.md)           | `@backstage/cli-module-actions`      | `actions list`, `actions execute`, `actions sources add/list/remove`, `catalog list/get/validate/register/unregister`, `api list/get-spec`, `search`, `docs search`, `template list/execute/dry-run` |
