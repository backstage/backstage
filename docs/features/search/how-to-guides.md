...
- By resolving a single `YourIndexableDocument` object, your decorator can be
  ...
  ```ts
  class YourDecorator extends DecoratorBase {
...
[obj-mode]:
  https://nodejs.org/docs/latest-v14.x/api/stream.html#stream_object_mode
[read-stream]:
  https://nodejs.org/docs/latest-v14.x/api/stream.html#stream_readable_streams
[async-gen]:
