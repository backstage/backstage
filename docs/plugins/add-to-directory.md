...
If there are any errors they will be listed and you will need to correct them. We run this came check as part of the CI.
...
- For any icon that you use make sure you have the proper rights to use it. If you don't have an icon then feel free to use `iconUrl: '/img/logo-gradient-on-dark.svg'`
