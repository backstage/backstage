...
1. A typed `express` router that provides strong guardrails during development for input and output values. Support for query, parameters, and request body, as well as experimental support for headers and cookies.
