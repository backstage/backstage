...
Furthermore, there is a separate community project [backstage/charts](https://github.com/backstage/charts) dedicated to developing Helm Charts for Backstage. It provides a helpful guide to set up & deploy your first instance using a Helm Chart.
