  ...
  providers:
    gitlab:
      yourProviderId:
        ...
        validateLocationsExist: true # Whether to validate locations that exist before emitting them. This option avoids generating locations for catalog info files that do not exist in the source repository. Defaults to true. This option cannot be used in conjunction with wildcards in the entityFilename.
