...
- You should have [installed a standalone app](./index.md).
...
3. Fill out the template.
   ...
   The standalone Backstage application includes one template. For this example, enter the repository URL to the entity file, `https://github.com/backstage/backstage/blob/master/catalog-info.yaml.` This is used in our [demo site](https://demo.backstage.io) catalog.
